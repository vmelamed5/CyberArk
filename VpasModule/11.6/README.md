...
- Step2: Import VPasModule Required Version 11.6 into Powershell
...
- Step6: Invalidate Cyberark Login Token via VLogoff
  - Example:
    ```
    Import-Module VPasModule -RequiredVersion 11.6
...
DESCRIPTION:
	USE THIS FUNCTION TO ACTIVATE A ROTATIONAL PLATFORM (MAKE GROUP PLATFORM ACTIVE)
SYNTAX:
...
DESCRIPTION:
	USE THIS FUNCTION TO DEACTIVATE A ROTATIONAL PLATFORM (MAKE GROUP PLATFORM INACTIVE)
SYNTAX:
