...
- Step1: Install VPasModule from github or from Powershell Gallery https://www.powershellgallery.com/packages/VpasModule/14.2.1
- Step2: Import VPasModule Required Version 14.2.1 into Powershell
...
RETURNS:
	JSON Object (EPVGroups) if successful
	$false if failed
...
SYNTAX:
	Get-VPASAllPSMSessions [[-token] <Hashtable>] [<CommonParameters>]
PARAMETERS:
	-token <Hashtable>
		HashTable of data containing various pieces of login information (PVWA, LoginToken, HeaderType, etc).
		If -token is not passed, function will use last known hashtable generated by New-VPASToken
...
RETURNS:
	JSON Object (AllUsagePlatforms) if successful
	$false if failed
...
RETURNS:
	JSON Object (AllConnectorPools) if successful
	$false if failed
...
RETURNS:
	JSON Object (AllConnectors) if successful
	$false if failed
...
RETURNS:
	JSON Object (ComponentLogList) if successful
	$false if failed
...
RETURNS:
	JSON Object (ConnectorComponentDetails) if successful
	$false if failed
...
RETURNS:
	JSON Object (ConnectorPoolDetails) if successful
	$false if failed
...
RETURNS:
	JSON Object (AllPolicies) if successful
	$false if failed
...
RETURNS:
	JSON Object (AllStrongAccounts) if successful
	$false if failed
...
RETURNS:
	JSON Object (AllSettings) if successful
	$false if failed
...
SYNTAX:
	Get-VPASSafes [-searchQuery] <String> [[-limit] <String>] [[-offset] <String>] [[-IncludeAccounts]] [[-token] <Hashtable>] [<CommonParameters>]
PARAMETERS:
	-searchQuery <String>
		Search string to find target resource via username, address, safe, platform, etc.
		Comma separated for multiple fields, or to search all pass a blank value like so: " "
...
SYNTAX:
	Invoke-VPASMetricsAccounts [-TargetMetric] <String> [-MetricFormat] <String> [[-OutputDirectory] <String>] [[-HTMLChart] <String>] [[-DayRange] <String>] [[-AmtOfSets] <String>] [[-HideRawData]] [[-token] <Hashtable>] [<CommonParameters>]
PARAMETERS:
	-TargetMetric <String>
...
SYNTAX:
	Invoke-VPASMetricsCPM [-TargetMetric] <String> [-MetricFormat] <String> [[-OutputDirectory] <String>] [[-HTMLChart] <String>] [[-HideRawData]] [[-token] <Hashtable>] [<CommonParameters>]
PARAMETERS:
	-TargetMetric <String>
		Specify which report will be run
...
SYNTAX:
	Invoke-VPASMetricsPlatforms [-TargetMetric] <String> [-MetricFormat] <String> [[-OutputDirectory] <String>] [[-HTMLChart] <String>] [[-HideRawData]] [[-token] <Hashtable>] [<CommonParameters>]
PARAMETERS:
	-TargetMetric <String>
		Specify which report will be run
...
SYNTAX:
	Invoke-VPASMetricsProviders [-TargetMetric] <String> [-MetricFormat] <String> [[-OutputDirectory] <String>] [[-HTMLChart] <String>] [[-HideRawData]] [[-token] <Hashtable>] [<CommonParameters>]
PARAMETERS:
	-TargetMetric <String>
		Specify which report will be run
...
SYNTAX:
	Invoke-VPASMetricsPSM [-TargetMetric] <String> [-MetricFormat] <String> [[-OutputDirectory] <String>] [-DayRange] <String> [[-AmtOfSets] <String>] [[-HTMLChart] <String>] [[-AmtOfUsers] <String>] [[-HideRawData]] [[-token] <Hashtable>] [<CommonParameters>]
PARAMETERS:
	-TargetMetric <String>
		Specify which report will be run
