...
function Deny-VPASIncomingRequest{
    ...
    Param(
        ...
        [Parameter(Mandatory=$true,ValueFromPipelineByPropertyName=$true,HelpMessage="Enter a reason for denying the incoming request (for example: Not needed to perform job function)",Position=7)]
        [String]$denyReason,
