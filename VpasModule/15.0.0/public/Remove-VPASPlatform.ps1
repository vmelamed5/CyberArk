...
.LINK
   https://vpasmodule.com/commands.html#Remove-VPASPlatform
.NOTES
   Category: PAM
   Tag: Platforms
   Since: v11.5.0
...
.EXAMPLE
   $InputParameters = @{
        DeletePlatformID = "DeletePlatformID"
		WhatIf = $true|$false
		HideOutput = $true|$false
   }
   $DeletePlatformStatus = Remove-VPASPlatform -InputParameters $InputParameters
.OUTPUTS
   $true if successful
   ---
   $false if failed
    ...
    Process{
        try{
            if($PSCmdlet.ParameterSetName -eq "InputParameters"){
                $KeyHash = @{
                    set1 = @{
                        AcceptableKeys = @("DeletePlatformID","WhatIf","HideWhatIfOutput")
                        MandatoryKeys = @("DeletePlatformID")
                    }
                }
        ...
        try{
            ...
            if($platID -eq -1){
                ...
                if($WhatIf){
                    ...
                    foreach($WhatIfPlat in $WhatIfInfo.value){
                        $WhatIfPlatPlatformID = $WhatIfPlat.general.id

                        if($WhatIfPlatPlatformID -eq $DeletePlatformID){
                            $WhatIfPlatPrivilegedSessionManagement = $WhatIfPlat.sessionManagement.PSMServerID
                            $WhatIfPlatID = $WhatIfPlat.general.id
                            $WhatIfPlatSystemType = $WhatIfPlat.general.systemType
                            $WhatIfPlatCredentialsManagementPolicy = $WhatIfPlat.credentialsManagement
                            $WhatIfPlatPrivilegedAccessWorkflows = $WhatIfPlat.PrivilegedAccessWorkflows
                            $WhatIfPlatName = $WhatIfPlat.general.name
                            $WhatIfPlatActive = $WhatIfPlat.general.active

                            $WhatIfCounter = 0
                            $WhatIfAccountsAffected = @()
                            $AffectedAccounts = Get-VPASAccountDetails -platform $WhatIfPlatPlatformID -token $token -HideWarning
                    ...
                    if(!$HideWhatIfOutput){
                        ...
                        Write-VPASOutput -str "CredentialsManagement       : $WhatIfPlatCredentialsManagementPolicy" -type S
                    ...
                    $WhatIfHash = @{
                        WhatIf = @{
                            ...
                            CredentialsManagement = $WhatIfPlatCredentialsManagementPolicy
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQULiMh0f1+dua6Vh1G9pvCReTd
# t/+ggiTgMIIFbzCCBFegAwIBAgIQSPyTtGBVlI02p8mKidaUFjANBgkqhkiG9w0B
...
# CisGAQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFDTRd2CeNUX3CvjL//cbSVlutL+3
# MA0GCSqGSIb3DQEBAQUABIICAGwzgQGuBYH/s4z91arccQcU74rW/Vx4Fip5owi7
# UPw+Py3K5ZWdzEoPHKYLtXWDn0JGvjLunS6ZYuNr2aUk0+xgi6kBzv/0cACc95Xn
# TFJUFqLqThDeE6VinPAdzu3zdScK9iHlYwmrJLaGOOA3jR4cF9DJAcGGujNF4CJA
# 6sLrco5wTb0mIrr1a2wevgsxD7MQOyOhns1oV/+dmPqqtpwMGHbsfTLPLXSc/GTv
# T3rwM3nvfED93qwxqe7X1ZQhH+XgHpOGHor5YwuFFN+fAGCiLEPlI+sQv8fqqz/v
