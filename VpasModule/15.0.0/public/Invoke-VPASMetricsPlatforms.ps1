<#
.Synopsis
   Run various platform metrics
   CREATED BY: Vadim Melamed, EMAIL: vpasmodule@gmail.com
.DESCRIPTION
   Use this function to generate various Platform related metrics and KPIs
.LINK
   https://vpasmodule.com/commands.html#Invoke-VPASMetricsPlatforms
.NOTES
   Category: PAM
   Tag: Metrics
   Since: v14.2.0
...
.EXAMPLE
   $GenerateReport = Invoke-VPASMetricsPlatforms -TargetMetric {TARGET METRIC VALUE} -MetricFormat {METRIC FORMAT VALUE} -OutputDirectory {OUTPUT DIRECTORY VALUE}
.EXAMPLE
   $InputParameters = @{
                    ...
                    if(!$skipval){
                        ...
                        if($targetPlatformID -eq "BLANK_PLATFORM"){
                            ...
                            elseif($OutputHash.Automatic.$targetPlatformID){
                                ...
                                $AllPlatformDetails = Get-VPASPlatformDetails -platformID $targetPlatformID -token $token
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUQvB2pQWwiCY6e4XdKO64q4JF
# NcKggiTgMIIFbzCCBFegAwIBAgIQSPyTtGBVlI02p8mKidaUFjANBgkqhkiG9w0B
...
# CisGAQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFFUCv3I6c6KMxPQFG4jI3GE5WRyW
# MA0GCSqGSIb3DQEBAQUABIICAAmUNmUxdY5qyd1rs9DSWX4yYstDe8/THZKZA8JX
# 9oClPSSHGaV9Rgr+FmoCaqH8BlOKUEmliqTAyIQRs7//HaXsZYe1felIVk++C/Z2
# nK811ITc3aOijrqo/0Kd/PpXsJAQLhskzJEG3rFW33EJ/k7+qdtwlKb9kZfks0Ob
# DpaDy2cA8bTp9nvZqGX2Vi/jALI2fW61dVE5i0XOGxDToTvpjjHz1RMAZAR3glFZ
# QDChFY4f9kGhW9VzSBd7IDwmb7uyud7W+eFs8xI7nW/Cy4F3u3009qz+04rawZAJ
# vZbKFaIULT8aDUYscs2oFWZAWlm5W3Feong6IDZTInE3OXxPDza6R1zg/741zdSU
# n0Hnr68a7yXmC9L5rpOk8jqZrjJQXL21w5sZlDEP3cmBDUDigTxtxD+5XVZJ/EfB
# wCumtXEtTk6q0svGplqawRPAceFVF+FjmrIgGe/cLLy40MgVhK1pOQkGhHrowugJ
# tJR5Jrxv4XvF4RCq/Dqj89iAPBursLPBzI+qtjX9Sfv8jO9TCWBF/tCBM3ui5YDz
# WeHBevef5Wl3NQwYRjLHUVqVxNnZJvE7/r71NRmu9F6BVHVLlW/4A5geM6n12TMO
# 6Qe8ug47F7UTkg/6kewwyrOj6z0gdnoHxs1qgALDtXA9zp9j1rEPvPrA5xjLzSnH
# yvyMoYIDIzCCAx8GCSqGSIb3DQEJBjGCAxAwggMMAgEBMGowVTELMAkGA1UEBhMC
...
# 9w0BCQUxDxcNMjYwMjA0MDQ1MjAzWjA/BgkqhkiG9w0BCQQxMgQwPzH/DpT66rvJ
# +bSOSM2ML/JwNmV/FHrZ1HcvJ7G6yCjPpIU5Zsi3laROBwqyKfslMA0GCSqGSIb3
# DQEBAQUABIICAMq3bsGqy+zNtnUHCRdDMGtXIdpUW5KwAMv2+HUZm6LiPrbdiF3g
# 2BFH5qo7qIkl0i4qSrYYCOFngdGdr4QeWNM/Vpcx1ZPjDaFHfxrG44d/oxQYGUP9
# Gy/alRvN24wRKXQHi7r3eZJs1ijHj+0ntENuy4Zb1FyY88zk75Lx8g2nkUbhi3/E
# TVbASKOhux9tYUQCni16MJZWgr/jOfh0vuCuazWyf77UZcIq06YBebJI2NT/xxIV
# M9CBP/FRln+7bWhzLkxjRzyLWjslrefOcNBV0fWWh8cEx+5gFp5vfhjOFQhubOZR
# 55IvXXjN8utOIOE4W/MC6yOXRn/PrvmeZ1mk3i7ahMx4cYGRfj3yUECj7JJxzxGX
# p2rrCfwd+f5knyVIdRToNHRcTT4L7un6ItgtwE2um6pF7PmpFdQRWCbPtUWl+Duk
# 7lz5KSJ8rY4u5AJId3SnRRVflyl5CZOxN2u7VvMNzYdBK5TgVabtxzN+sFYGfRbc
# JDmks9c/Lt2bmuvVVGYnGsV0NvInaElHJGAytLs2MWcDH//yltFEeTAPbUC80zGq
# x9vpixrRkyShhdUUAl+CYMw5fyPZmtPVXRPn7ryV9BgBPNKCY9+Dlfgv7kij0fZJ
# uDmxkw1SUbTN47wK0qQ+8iSH4MXXOLGzPuUo99ekJF2W8EYIdoWQ0mcV
