...
.DESCRIPTION
   Use this function to enable a custom color theme
.LINK
   https://vpasmodule.com/commands.html#Enable-VPASCustomTheme
.NOTES
   Category: PAM
   Tag: Color Themes
   Since: v14.4.1
...
.EXAMPLE
   ...
   $EnableThemeStatus = Enable-VPASCustomTheme -InputParameters $InputParameters
.OUTPUTS
   $true if successful
   ---
   $false if failed
#>
function Enable-VPASCustomTheme{
    [OutputType([bool])]
    ...
    Process{
        ...
        try{
            ...
            Write-Verbose "SUCCESSFULLY ENABLED CUSTOM THEME: $ThemeName"
            return $true
        }catch{
            $log = Write-VPASTextRecorder -inputval $_ -token $token -LogType ERROR
            $log = Write-VPASTextRecorder -inputval "REST API COMMAND RETURNED: FALSE" -token $token -LogType MISC
            Write-Verbose "UNABLE TO ENABLE CUSTOM THEME"
            Write-VPASOutput -str $_ -type E
            return $false
        }
    }
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQU6IS8QowtLehuqyCy0MSKX13y
# LgOggiTgMIIFbzCCBFegAwIBAgIQSPyTtGBVlI02p8mKidaUFjANBgkqhkiG9w0B
...
# CisGAQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFJ3swLowA519vQ8mAXaYNE/joWQR
# MA0GCSqGSIb3DQEBAQUABIICAKWjtlbcFwWhTpUC3b7M3WdcVCHuEzslGWB8rbHW
# jv5W1tKEbzbbasvAvPkjqfLqfcMmEINf0y3PpAjb07VXZ3Wodpgf3HsKo5bqyQj+
# +blfBBhmXVDYUd6Nd0+GTsHXJJIiF6ffLV6dEOC0dz5+CWlNaa+AFs61h40KHCQt
# X1Lkd+4iDZluLWNrzaqbw9UisvGCqtL4SmjWKrbzC7E5RLtv81Pvio74rWIAeVeJ
# jpRE60LQ5OdGINwPR4LNOjp3q24hAcnHvtERVG/5RbgRTPPLlBZp5Ww3TrSbGRuT
# /Rxn6UCN3ju4j7U29XVDfNdHFVoY5u/eulyuU7ApsEUlax4zuuCQNshIHbyPjEwP
# G3LfeBazgrZyA4BMpjifii6S4uVOPTjDOHBUMgLUi/MUkkMsWMaQb4GhR/VxcrWc
# AGkV6MOZouQ1Oor240mL2uuMnniMK6xUHh6LsRnTaDqq1TLTtto/frd6m0quQgws
# wK33dyoS7/BychSAQpXV2yJUkChY+50yljxmmbmCUd0JXQdRAOq8M+RV1TEIF74v
# cuIKrcxexebHydEzwHVnfFe/yLhimfkduV8FNEPU9P0B9vU06E5Dqvqc36VA2Y3O
# gQ8NNXGWT4APsQ9KcDvWMli4J9wB8N7JeBdAHwlG5JkXsk97KkdFDcCRaXlkzebh
# dG8loYIDIzCCAx8GCSqGSIb3DQEJBjGCAxAwggMMAgEBMGowVTELMAkGA1UEBhMC
...
# 9w0BCQUxDxcNMjYwMjA0MDQ0NDIzWjA/BgkqhkiG9w0BCQQxMgQwByKgPZ4GOH9G
# /kTQIQSttrSxn5yN+OMHRbT16/xtKQySWogXoPlZUIH30tgp9F1gMA0GCSqGSIb3
# DQEBAQUABIICAELe+cHbtM5RQtE8OVSCc00c3WsWijO24toEfGQ5fDG/Tq3r3Z2k
# bOSTZE2ccfOHYZ4Z2at1ksMlbcqrMotNGmIEZtAU/ERBZd8tZbFlUSBm7xASgtPy
# lmlIL93RzVo1yxatj46o0YTBY16WM0ArtJ+NL7d4U39+cPpXcsp7nSbwVHsr9FQN
# sGFGq7XgZdquPAH7lVxQ7b7YT/GpvpSwC7OpH6acJGpaVko+avrfHgyx9OVIuMVD
# DmwHKHONCx27xsHVzBBaqa43JiT9597mHddkl15JMdgA5FdKmV98Z1OrHBi3QafQ
# vXDSNkeV3fyr7WbJImU1Ucl98u8mH67gjjybp19xcxjnm7Tg4YZXmx6ZYiKVt1D+
# D1YrQma6OZ0xqm3/rzG2sdCx5lxd0bHBnJRdiI8j3SIOYIPSpoL8AHtsa82ghmzL
# RsquLX/NV00mqGEpqN56jS5+5E5eDytKHA/cbbHYKCazDhk9lqSmn2jdO2CLUHtm
# CexO0A22shm1JY4dKf7eK1b/PIMVBp2/ZdBUo6uSsxuA43IgRwNQo2eEsOQBs5G2
# fcU96jSEFJgMqQnPTylu4o3K5L4qE0OM4Vqxs1Apntcj+Q3dnj5OVTan2ATR5Rba
# pPV/ys/02P/iXh4IvcmxHMaiTJbknug1lHwd5JuoCTL+gEN6M5YSYQEF
