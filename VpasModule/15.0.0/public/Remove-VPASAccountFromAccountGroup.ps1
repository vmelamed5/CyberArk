...
.DESCRIPTION
   Use this function to delete an account from an account group
.LINK
   https://vpasmodule.com/commands.html#Remove-VPASAccountFromAccountGroup
.NOTES
   Category: PAM
   Tag: Account Groups
   Since: v10.10
...
.EXAMPLE
   $DeleteAccountFromAccountGroupStatus = Remove-VPASAccountFromAccountGroup -GroupName {GROUPNAME VALUE} -safe {SAFE VALUE} -AcctID {ACCTID VALUE}
.EXAMPLE
   $InputParameters = @{
        GroupID = "22_12"
        safe = "TargetSafeName"
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUrJyribYi+2UsJwWyh6svILn1
# vCqggiTgMIIFbzCCBFegAwIBAgIQSPyTtGBVlI02p8mKidaUFjANBgkqhkiG9w0B
...
# CisGAQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFGdOtYxWJTa1jNoRkKqU5wi/hGeS
# MA0GCSqGSIb3DQEBAQUABIICAE1auwlMA/mPHchhEg0KtwWtJ8279V1mKLZhq1kB
# NNkAeT/W2bpVbaX5VeF5vqk1peFSxvoHz/mExaylwiA0YqoCDdmZxG5+4Yq021d6
# XrmR1lN4A5sSjylPiqjFnKqOKpb7B8QTSznQbCpcp3jvFRGab9FIGETDabijA1sI
# lRm+T1MCxbCU0l1BbvdLjefK8ZUAVC3Xi5sfwq3XLPhx5ZVJAr5/wreKRVagBesL
# tYATJcZqiJZJJxXlFN/PaA0QTsEJ22mKd+e9wEHhl529MfzMaV0/9bvjm5gvOSnR
# KkWhL6dAOPJ6tIn8oGuadgPlmRbge42jXxINEPFER1Zdk7alutYBUb8+lSAHjBm8
# eZcHQg/rHWFGTlJuBnnFHOYK+Cgg45ADWcq92ZHskbtp2yBjNYvDZvVNhIHPQ9Bo
# FrQt7kX0uznfy71ppw/BLY89hpAK7fpy2c5m6HxUVvS3GshLUJTnYJdrn2pLiwLG
# FIMFQYdhe7APthXp2SCblrKSwEuLxTYezIz/Q1LlXLozon6SGZbAPjLbZE+WzJBH
# hK5b4e1HNUIBjTvVyPxopVjWSYYCfdf9kYxOZS1l98Lpb6fBVNqgZWzJSVrOpq6S
# YuxKd70n+8d5Rkje1OTPWOpP7M+GkAlGao0BtC7CQgWMMoonv2R8kuM/G7p5PKad
# uOnhoYIDIzCCAx8GCSqGSIb3DQEJBjGCAxAwggMMAgEBMGowVTELMAkGA1UEBhMC
...
# 9w0BCQUxDxcNMjYwMjA0MDQ1MjQyWjA/BgkqhkiG9w0BCQQxMgQwnBAflvNooXbJ
# byhpZbWcxTZDC8TB4UctYPIx37vnvglW4gZy8PgtlxIRkjf8dtXpMA0GCSqGSIb3
# DQEBAQUABIICAAfiZi/L4q9gw2jT3DD+B36b/nk+FdrErjAFNseZNguEVS0BnDM2
# 2FqkcIOD5Ero0uyd+fVJ+omn7xbCtqG3D/d0/1zJcbX8MFhpbJTYyqjShzSCQ3ga
# NVkEXKa0tFD35IF0OwHd2KH7ANsTWFgZLZnrg6DKvz0uYTk/EE/2UqqzEhBLQ1Ep
# kMJsfdHp89IHriOiciJj7ioCO9XEQqC9TD6IiG9z8Yc9Qfpv7ahGBzlL0r9KI0Mm
# gUKBi3lFzlQxW9A7YMMSgaGMjLudmJ1K9of0fBC9f/bLhO6XhPNj74zwnu7CFf7J
# DddBhnCkvC1GAV31AB/SjjPLtxq2/zM7iU/Q36H3z2hI7uc1ZvGnSoKkeLGANo0L
# ZGiiJ4W3lZkd3uhGYKr32Ln/ecA5azgRPRoOQHGrSOGmlLiRZAnYkLHbgJ0Tgjkv
# 88kD6wm5JA5PfMmragUJxetlsvOk+9rgwPtQeM2u5gQJ9rxfSfjaxDWBHlZJVM4V
# 9V+wd/k60fVcyZt3DahGPcSp2zUl7vNRcRe/NOnHMNeYxx5xPK2wpiwfRLiNh2Ws
# ZqPqSetlPvSTtSX1tcCt76y7M76FwHFrwmuKU9p2upR5DTeI67AjDfzVWtwDuho5
# uk74/SVNgPmtU47Jh5B1pRQOvAfzlABhwyunkc90gdOEHYHU4oWrgq8m
