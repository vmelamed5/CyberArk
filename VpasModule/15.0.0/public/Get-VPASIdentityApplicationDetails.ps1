<#
.Synopsis
   Get application details from Identity
   CREATED BY: Vadim Melamed, EMAIL: vpasmodule@gmail.com
.DESCRIPTION
   Use this function to retrieve details for an application from Identity
.LINK
   https://vpasmodule.com/commands.html#Get-VPASIdentityApplicationDetails
.NOTES
   Category: Identity
...
.EXAMPLE
   $ApplicationDetailsArray = Get-VPASIdentityApplicationDetails -ApplicationName {APPLICATIONNAME VALUE}
.EXAMPLE
   $ApplicationDetailsArray = Get-VPASIdentityApplicationDetails -ApplicationID {APPLICATIONID VALUE}
.EXAMPLE
   $InputParameters = @{
   ...
   $ApplicationDetailsArray = Get-VPASIdentityApplicationDetails -InputParameters $InputParameters
.EXAMPLE
   $InputParameters = @{
        ApplicationID = "jkahd786_sdfg_ghjf_4567_jdhfkj289743"
        ExportToCSV = $true|$false
        CSVDirectory = "C:\Temp"
   }
   $ApplicationDetailsArray = Get-VPASIdentityApplicationDetails -InputParameters $InputParameters
.OUTPUTS
   If successful:
   {
        ...
        "OnPrem":  true,
        "OrgPath":  "",
        "ID":  "e242c931-0816-4664-99b4-3a35663845a2",
        "ShadowAppLink":  null,
        "IsSwsEnabled":  null,
        ...
        "AuthChallengeDefinitionId":  "8f2b6ee5-a3a2-4fa9-a854-544550dbf5dd",
   ...
   $false if failed
#>
function Get-VPASIdentityApplicationDetails{
    [OutputType('System.Object',[bool])]
    [CmdletBinding(DefaultParameterSetName='Set1')]
    Param(

        [Parameter(Mandatory=$true,ParameterSetName='Set1',ValueFromPipelineByPropertyName=$true,HelpMessage="Application name of the target application (for example: Venafi)")]
        [String]$ApplicationName,

        [Parameter(Mandatory=$true,ParameterSetName='Set2',ValueFromPipelineByPropertyName=$true,HelpMessage="Unique AppID of the target application (for example: 1234-abcde-5678-lmnop-0987hjkj98)")]
    ...
    Process{
        try{
            if($PSCmdlet.ParameterSetName -eq "InputParameters"){
                $KeyHash = @{
                    set1 = @{
                        AcceptableKeys = @("ApplicationName","ExportToCSV","CSVDirectory")
                        MandatoryKeys = @("ApplicationName")
                    }
					set2 = @{
                        AcceptableKeys = @("ApplicationID","ExportToCSV","CSVDirectory")
        ...
        try{
            ...
            foreach($row in $result.Result.Results.Row){
                if($row.Name -eq $ApplicationName -or $row.ID -eq $ApplicationID){
                    if($ExportToCSV){
	                    $runexport = Write-VPASExportCSV -Data $row -CommandName $CommandName -CSVDirectory $CSVDirectory
                    }
                    $log = Write-VPASTextRecorder -inputval $row -token $token -LogType RETURN
                    Write-Verbose "FOUND TARGET APPLICATION...RETURNING APPLICATION DETAILS"
                    return $row
                }
            }
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUavDCQKbV3hhwOAY5LJyZ2OcU
# xxuggiTgMIIFbzCCBFegAwIBAgIQSPyTtGBVlI02p8mKidaUFjANBgkqhkiG9w0B
...
# CisGAQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFKax9QV2EijxYQ9QahddEUx1r0Dm
# MA0GCSqGSIb3DQEBAQUABIICACycYpvxRuYDeenZ3SvMJYVzs0EPpVyVjb+qUv/4
# e4DCmuTOmTFtcYlVh7GOqusAWi7/Fss5LNxgGAa9YUZ6deYI2cdp+kwcXK6FKefk
# Wfc7CcBHlOa60jvoilyP17+OPRtXFNnmmzjOAgaDHDFjSk6OWUqWCsUaSwU0D4FN
# tDv+3Avxm0Yyuus2VPyE8RxqmpR2E5Rit31nOP7Q9S43a2j9q9NtKRAbxcQhG/ds
