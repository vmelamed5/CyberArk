...
.DESCRIPTION
   Use this function to create account in bulk via CSV file
.LINK
   https://vpasmodule.com/commands.html#Add-VPASBulkAccounts
.NOTES
   Category: PAM
   Tag: Bulk Actions
   Since: v12.2.1
                        ...
                        if($response){
                            ...
                            if($CPMFlag){
                                try{
                                    ...
                                    if($SRS){
                                        Write-VPASOutput -str "PAUSING SCRIPT FOR 20 SECONDS FOR SRS TO PICK UP THE NEW ACCOUNT OBJECT" -type M
                                        Start-Sleep -Seconds 20
                                    }
                                    if($CPMTrigger -eq "verify"){
                                        $response = Invoke-VPASAccountPasswordAction -action Verify -AcctID $NewAcctID -Verbose
                                    }
                                    elseif($CPMTrigger -eq "change"){
                                        $response = Invoke-VPASAccountPasswordAction -action Change -AcctID $NewAcctID -Verbose
                                    }
                                    elseif($CPMTrigger -eq "reconcile"){
                                        $response = Invoke-VPASAccountPasswordAction -action Reconcile -AcctID $NewAcctID -Verbose
                                    }
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQU29yqmEoEg2+4OLd3hhNCYb0S
...
# CisGAQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFHQoRDLKd8BEQq7D5RSS4p5q8ZvU
# MA0GCSqGSIb3DQEBAQUABIICAETXnEK74RW63HSw9hndfoIOn9iwobf0WkIcHh/U
# aGOwQbie/SgIHjRu7SaEU6I0vgJDM5YNLoe+laPpsKZ/KJtnjCy9Ru3hP1badac8
# joksmVrii1RSVtN/vD1U+YWCrfKcu67La2CX5VXuhZIpqev/3GwLm0fIm7/nPMn+
# nwSTR8DC9b16NmO/hjBXcw+jtvGfjqS7/dBcuVR3idVDh9P0yDCevkZeljQH7iiO
# 9LQ8OQoDNwb/d+lyGuZSqAxSPg0fcePgutCVnzzE/Ps3c6qM7cqX+Hp1/VeCj8Xt
# d8JVh1YtNDBI6sNKcUvaNYfQbBmrORNUrWQhUZdGzZvolgi1csYg0By8YqPC1/BE
# yLDqjcE1S6ynuEmUPTeSNDtuPhzk1M6YWJw2z30iAxjcCax/Eh8g6v3WckftB1ud
# 9EnsHbiUm9KtVmmPGlVPYGxOK39DYqY8OcQRsH2ObYq1+IbtTm3REip2Wfz5DG5Q
# ZatfpwYrR1HZDucY/VZ0FvqdfoY8VRVIGvBjMae21e8FJZwGkrJ4mvsxcGBWGQ1b
# YStklcA87OSDP++1gE7i2ME2BDJu9tI4nInFAnovmluhav425NW8feAzVrdbYOUW
# Pr0y6f9QBOMYYJCGChqJrDf6Py1ZT2lf6W/m+3qeQUd1ZmBz/v81og2rmiPthiAz
# 8p0+oYIDIzCCAx8GCSqGSIb3DQEJBjGCAxAwggMMAgEBMGowVTELMAkGA1UEBhMC
...
# 9w0BCQUxDxcNMjYwMjA0MDQ0MzA1WjA/BgkqhkiG9w0BCQQxMgQwzNAxREAvaNJk
# h9X/2ds2JJI8WjJEB2CZqhSdx3FJbCuzQAYuhxzVt1lHVX8NllKcMA0GCSqGSIb3
# DQEBAQUABIICAFSplnWX4Geabsc7kpFAXlkhmgGvsse9GKnzPj5fEWXpCdtlyv+Q
# dpHY5UMWMOR14h27j0G57XNzCLVRD3YnxT2E1tbOVuKxz/h5y+8ARoO6IsxAStHa
# wPWUrUxjg+hF+myVZ+n1VAWoErOU4L9SSzyZIMygILqTeYPxNOhKwSkDYieHxp8v
# lkX6/1Hi7FavCB1qamSkzmgceBzouLftoXQjDXEaipX+sM5k9pE0dtU68WePc7ZI
# dQxzFW8LQgKYYkCZGhxpR/QRtuwIIuY2ScWUkRsBmz4dp5oy+TXngJd7XvjBZtqV
# s/UeJS5Kh8s3Sj1U2ln3VdVWOKL690e6BS3wiaLy6pC7/M6Eq0L9CCz3eSSZ7Sxw
# VMwHs9W69Euf0wGZozZDoKIJxBukFFAyH1Xw4Lz6AptGRq5SqmkWJ3bRxrb2RIS8
# yjfhhDBGRRYy5QSnkNFLDoIyqksRteQY3c8uDZhdtlfFJdLPlONFWc71b7sjMJAC
# rpYXtGPO/sRYh6dBNCtA3avA5xWXy1CN98gE8OhN5cM18oZ+oqEU0cksv03Mls1d
# Qq/IMvsPdnX1OQUJAyQvVcGV/bH9tkJBYRU9BI7dyC5pq1ivKp2UtdL0t4c0/ulv
# pmbbx9m/R8JNrXWdiAoHnkR7bZsTjr7uTtSw1QLxXGQWShnwrp+mYmuh
