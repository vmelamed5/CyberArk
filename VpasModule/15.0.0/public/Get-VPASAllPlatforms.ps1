...
.DESCRIPTION
   Use this function to retrieve details for all platforms
.LINK
   https://vpasmodule.com/commands.html#Get-VPASAllPlatforms
.NOTES
   Category: PAM
   Tag: Platforms
   Since: v14.0.3
    ...
    Process{
        ...
        try{
            ...
            try{
                ...
                Write-Verbose "RETURNING ALL PLATFORM DETAILS"
                if($ExportToCSV){
	                $runexport = Write-VPASExportCSV -Data $response -CommandName "Get-VPASAllTargetPlatforms" -CSVDirectory $CSVDirectory
                }
                return $response
            }
        }catch{
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUY3Wc9G0Kb6OzFlApk6dvVrfz
# e+qggiTgMIIFbzCCBFegAwIBAgIQSPyTtGBVlI02p8mKidaUFjANBgkqhkiG9w0B
...
# CisGAQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFPFWfvXcqlVIt5shpZCKIPjLJsJn
# MA0GCSqGSIb3DQEBAQUABIICALru2+xJAtUAuUMnit3aBYoQk8ZFKgWPecrMWfNc
# 17L+VKHmCPfWKHXm4pJIZcZ+cdeOh+if0OY0Zs282bCso+UilCbv/gsEmskgF+jy
# Kli3jKfeF52EYIlKajK4r253IOCXbbROiSSvqqXIsjz/vt+CNqSoaXsUynATusNl
# 7OwQjBN+akaXjfmn6dTFyHBweF7arJ/iGVnuthtneiAsPCrg3CWLiaLr/ACTY/Qx
# fRCwY9iaS6iK5tz5s5MrqOtIE5+vsAOrGhXyKV48TmlvVkgsMyjeSiC+7Va39CQO
# Vj2ryEtgQ8Wtx7P6zCN0Xffc2LQUm2VAVSXCny9bdE8WzGdwrHDi0pdn6/4yXLgo
# ccu0NFP+tw1HP1OBxWceSm01p4v99OkkCPPw5R3I1/qmNG3m1Au2pgq9S2X2yOGy
# H572qNUm1mklzWlMdGEaFfDn31cVXN9dSbF3uGh5nbuxmtvuPfwli7hkFn/TW/mj
# b8rO4S+e0OXNy31ZYvJdt5aBYH2yiEHYbGNgx8j38bJ5jzH+XIvmPqCB5sXcL7/8
# QFD3kb02gd0CXcsTZTVolE4Rb5/sTvjY0BnC0h8N1i0/UtBx+44RLw/2EBzmgymV
# If+TNIFKgqsqVIJtnwCST7Xk74ZZNfk6y72xZMrk1fzE6qKobvGZn6m3UX471uH+
# AdhzoYIDIzCCAx8GCSqGSIb3DQEJBjGCAxAwggMMAgEBMGowVTELMAkGA1UEBhMC
...
# 9w0BCQUxDxcNMjYwMjA0MDQ0NjE3WjA/BgkqhkiG9w0BCQQxMgQwf7JLamcPIPIZ
# OCQD2YhvsI4vHTGz7mT4i0BQ0EA+sTtQnfhLc5vIJQ6BdGKPUZJ4MA0GCSqGSIb3
# DQEBAQUABIICAJQ005iOA57EeFaIcEE1h93PiXQYIrGiLbIc/eFm6HwrNIusfXaj
# 9NGr97LCS4h4ktCcFGPxF1XWQxtRqNvW3t3CgVKu6L9M40Yh4mV5QTifjYOI8zcX
# v5lzh7FxOVDCn+g2WvSdQgQV/IjCGs1t8lq/EXlf7mGF8lZUVcxLZSaZF8ijjlQc
# 4XzyEiL7hYYYTdsZQ23e7gtGasHJL97jWgrr3fbGIaCZSWW7fb7rYF1Ctae9BT5O
# Ec1RaDvkCy37yu8UPerXqWgh3ANB8o9ruOiGzY1IRd3ZqEs5WJTzGZKObx/tTyMn
# KM5SRzbNq7qdu9dfCrqABjJT33KGlnZp+VCxkjFYkO/dSGwASkWeB33vWyxP04Bs
# k4/12fllMbpt91NdWANBOWocSKEQA5s19scMytuSGwBh8CDIEaDdRF2g/PQOY2Xb
# d+PXcjmiAgqKUieNM+E6k/XUg1KiB474RYbYnif8J1/U2IrXBdLpFeoCW9tN//Z0
# XSjn8M5MSuDZznOppluoelW77NAe7yQRTOXKFLNCZZ5xsY15ny9d220A3x0IskYm
# 1A7CZBj+Q/U5BCtyWo+QylOzs4+yIQeXiSelqwRZk+25TUcK7gYy8biIJcyB9Ywx
# f00NcnyNtMET4aXre5GRu6JtCnjVAUeugNtpXyFddGH6YACCLMtqxznd
