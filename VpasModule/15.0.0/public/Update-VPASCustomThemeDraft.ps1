<#
.Synopsis
   Update custom theme draft state
   CREATED BY: Vadim Melamed, EMAIL: vpasmodule@gmail.com
.DESCRIPTION
   Use this function to update a custom theme draft state to active
.LINK
   https://vpasmodule.com/commands.html#Update-VPASCustomThemeDraft
.NOTES
   Category: PAM
   Tag: Color Themes
   Since: v14.4.1
...
.EXAMPLE
   $UpdateThemeDraftStatus = Update-VPASCustomThemeDraft -ThemeName {THEME NAME VALUE}
.EXAMPLE
   $InputParameters = @{
        ThemeName = "Default Light Copy"
   }
   $UpdateThemeDraftStatus = Update-VPASCustomThemeDraft -InputParameters $InputParameters
.OUTPUTS
   $true if successful
   ---
   $false if failed
#>
function Update-VPASCustomThemeDraft{
    [OutputType([bool])]
    ...
    Process{
        ...
        try{
            ...
            if($NoSSL){
                ...
                $uri = "http://$PVWA/PasswordVault/API/Themes/$ThemeName/draft/"
            }
            else{
                Write-Verbose "SSL ENABLED BY DEFAULT, USING HTTPS"
                $uri = "https://$PVWA/PasswordVault/API/Themes/$ThemeName/draft/"
            }
            ...
            Write-Verbose "SUCCESSFULLY UPDATED CUSTOM THEME DRAFT STATE"
            return $true
        }catch{
            $log = Write-VPASTextRecorder -inputval $_ -token $token -LogType ERROR
            $log = Write-VPASTextRecorder -inputval "REST API COMMAND RETURNED: FALSE" -token $token -LogType MISC
            Write-Verbose "UNABLE TO UPDATE CUSTOM THEME DRAFT STATE"
            Write-VPASOutput -str $_ -type E
            return $false
        }
    }
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUlzNjjdkpOhiEfRHcKRQkG7Li
# 4BSggiTgMIIFbzCCBFegAwIBAgIQSPyTtGBVlI02p8mKidaUFjANBgkqhkiG9w0B
...
# CisGAQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFG4+i0io7XFizaKmUXyMd+azbpMc
# MA0GCSqGSIb3DQEBAQUABIICAGhCr0lEDa1yBAqO86bYM/fQjLZ+hyh+9r6+PIei
# oJjM+IkGsOqPakMJFnA5F2e3hECD907LaH6/HqtLIEzoY5WSyN7NMtNbi960kT/b
# fmkIBQwpfc3MwPQKfKKtzNrCBujNAwjRJnnv24b0LXdrV0D3eiirxlNoImmYUEox
# yA+qlIcUj1pVd/wr6JiuZ43l/Rm/c75r8vH1V+M9UGByj5yrrHF+3yNUOXNyCey+
# 6MRqeiUqpLg/TRspkU18q9yKtm+nEFvofJ0QeBYuwUeGAIrdLszngYTRyCMMnUng
# zpwRFccAdwP5KI9BFWY+zcYkMe41e8MRfZqQfQj5d15vgPbImzl2xitYjQDE+GDO
# sTD/b5yT1NpRiQWnUh3lP1kOhx+ULtOFfDWQAv+HkowmqqcmrLOHPERNxQhBTjrx
# UtT6ooDR+KyMpoF28qLTXUUm39thBvo340vt+F7ThF0ERPF8/pahYsU5mVgd9H87
# XDGFByOElpijxPc9MrUUb+ao6M3dD213p93EyuI6/2oR+6UfXmv8AdEWUdC9XsVL
# yiBDi4VDmaPIDX2XnxJ7SfoZO9Jr/7Mz/bUTYVNpdAA5lq12qeb6Kn74me7bwarG
# L/2U8m3wljdDdIoYgXUwQ1FTMlobTlZTS5DYKcF+DkijCGFkRiDfd/e0NXGPYL9Y
# Hki1oYIDIzCCAx8GCSqGSIb3DQEJBjGCAxAwggMMAgEBMGowVTELMAkGA1UEBhMC
...
# 9w0BCQUxDxcNMjYwMjA0MDQ1NTA5WjA/BgkqhkiG9w0BCQQxMgQwhDb3CxtvdAuc
# GNC9uWkt9wvX+LREQ9dGMpHW5B55ljq9O5IjtQkGEU1zqbU4RxL0MA0GCSqGSIb3
# DQEBAQUABIICAFRqbuExlcs3SsAi7miu5jGMyrkmWeuLKnmCam7PgKB7agPPTsOo
# BEnAykeB8NX5hsehydMdkn5mPpILqy1BujwxKBHGb1PI/5S/rRyHD+vhBYgN1roM
# IOy/D6hyMPHG3IhU9EqINE7UgNw1LGSNcvRJ5XAGRyqdRk1JEmOPe4kPYoncpx+I
# ko3RfZNAFdC+WRn/FHCD6m/rQT8jHOG4Z6RZ04uQIp/Qvzx78FkeJKdPcEmEmnhk
# zz+kuhEdgCSit7W65wPycaYPeak3wtSrdhyIDWk8bJXX3jdWnvDMFR5CySfDxkpP
# MD5ZycxOoNA1DmuDMj0aTiVSh4DfbG6eUMh3K908NmTNcW/+0Lj4qru3hmV+2S3h
# TURWmkhhgbcYVYXwlReIgCFb2JcCNCBSmY9BDt0UxWTVFiOquDY1H2udRafeGhPB
# 1gujlOG0MwAit0wguRtRHGNzgz0Mzeymt+081Cq0HPNEcnNcO6sgOwdkTZNWa2r1
# T2O19ZEip2hdJfYjoGPwoZhT1ne0t26ozbXqFbFhRc8YYK7sqt8T8qETAxsgmNP5
# E9jp67rWtwFxRd8Tt5BNUafzyR8TcBrArsaTd8fy//64CC2Cl9kYVVymzFqHNQlZ
# oAXMSqD0QnxQp3r2ItdczcQL5L9NaNqZ+aeveeIecERosCTBJRqu6cNy
