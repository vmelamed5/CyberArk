...
.DESCRIPTION
   Use this function to update the assigned network for an account
.LINK
   https://vpasmodule.com/commands.html#Update-VPASAccountNetwork
.NOTES
   Category: PAM
   Tag: Accounts
   Since: v15.0.0
...
.PARAMETER NetworkID
   Unique ID that maps to a single account network
.PARAMETER InputParameters
   HashTable of values containing the parameters required to make the API call
.EXAMPLE
   $UpdateAccountNetworkStatus = Update-VPASAccountNetwork -safe {SAFE VALUE} -username {USERNAME VALUE} -platform {PLATFORM VALUE} -address {ADDRESS VALUE} -NetworkID {NETWORKID VALUE}
.EXAMPLE
   $UpdateAccountNetworkStatus = Update-VPASAccountNetwork -AcctID {ACCTID VALUE} -NetworkID {NETWORKID VALUE}
.EXAMPLE
   $InputParameters = @{
        safe = "TargetSafe"
        ...
        NetworkID = "1234567890-9876-5432-abcd-abcdefghijkl"
   }
   $UpdateAccountNetworkStatus = Update-VPASAccountNetwork -InputParameters $InputParameters
.EXAMPLE
   $InputParameters = @{
        AcctID = "22_123"
        NetworkID = "1234567890-9876-5432-abcd-abcdefghijkl"
...
.OUTPUTS
   ...
   $false if failed
#>
function Update-VPASAccountNetwork{
    [OutputType([bool])]
    ...
    Param(
        ...
        [Parameter(Mandatory=$true,ParameterSetName='Set1',ValueFromPipelineByPropertyName=$true,HelpMessage="Enter NetworkID (for example: 1234567890-9876-5432-abcd-abcdefghijkl)")]
        [Parameter(Mandatory=$true,ParameterSetName='Set2',ValueFromPipelineByPropertyName=$true,HelpMessage="Enter NetworkID (for example: 1234567890-9876-5432-abcd-abcdefghijkl)")]
        [String]$NetworkID,
    ...
    Process{
        try{
            if($PSCmdlet.ParameterSetName -eq "InputParameters"){
                $KeyHash = @{
                    set1 = @{
                        AcceptableKeys = @("safe","platform","username","address","NetworkID")
                        MandatoryKeys = @("NetworkID")
                    }
					set2 = @{
                        AcceptableKeys = @("AcctID","NetworkID")
                        MandatoryKeys = @("AcctID","NetworkID")
                    }
                }
            ...
            Write-Verbose "FAILED TO UPDATE ACCOUNT NETWORK"
        ...
        try{
            ...
            elseif($AcctID -eq -2){
                ...
                Write-Verbose "SUCCESSFULLY UPDATED ACCOUNT NETWORK: $NetworkID"
                return $true
            }
        }catch{
            $log = Write-VPASTextRecorder -inputval $_ -token $token -LogType ERROR
            $log = Write-VPASTextRecorder -inputval "REST API COMMAND RETURNED: FALSE" -token $token -LogType MISC
            Write-Verbose "UNABLE TO UPDATE ACCOUNT NETWORK: $NetworkID"
            Write-VPASOutput -str $_ -type E
            return $false
        }
    }
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUXKLSGsXn720kZ+ncJMxZvbl8
# ueiggiTgMIIFbzCCBFegAwIBAgIQSPyTtGBVlI02p8mKidaUFjANBgkqhkiG9w0B
...
# CisGAQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFJlUXrKjr3sCM3XnAXLxbeqMYvLD
# MA0GCSqGSIb3DQEBAQUABIICAHRrLomfNO/1dSDcONy3xLA+6bNqRqMOUMd/YecU
# lsxAzeOn9UGTTVYYIdQt1JAjdC6u+8rF4BOKDQ969AW8HQffiCP5Hb67NgJKjhvT
# GAhPGqnYIFuiEuaWFpsu6fczmHfzuPEOOUDmxTDPOZNK6e2inVg4o/NMJTbHZajO
# bwmlEFLXXurAGMBpVqJKXfKfVWDmblniIJeJqNS/4x/mmx5SXcFhYYy0lISWxA2j
