<#
.Synopsis
   Get applications from Identity
   CREATED BY: Vadim Melamed, EMAIL: vpasmodule@gmail.com
.DESCRIPTION
   Use this function to retrieve applications from Identity via search query
.LINK
   https://vpasmodule.com/commands.html#Get-VPASIdentityApplications
.NOTES
   Category: Identity
...
.EXAMPLE
   $ApplicationDetailsArray = Get-VPASIdentityApplications -SearchQuery {SEARCHQUERY VALUE}
.EXAMPLE
   $InputParameters = @{
   ...
   $ApplicationDetailsArray = Get-VPASIdentityApplications -InputParameters $InputParameters
.OUTPUTS
   If successful:
   {
        "value": [
            {
                "ProvSettingsIsEnterpriseScimUser":  null,
                "Featured":  null,
                "ProvSettingPreview":  null,
                "Name":  "CyberArk Secure Web Sessions Portal",
                "Category":  "Security",
                "OrgId":  null,
                "MobileAppType":  null,
                "DirectoryId":  null,
                "ProvSettingsValidateEmailAttribute":  null,
                "DisplayName":  "CyberArk Secure Web Sessions Portal",
                "AppTypeDisplayName":  "Web - SAML",
                "OnPrem":  false,
                "OrgPath":  "",
                "ID":  "1234567-df6d-9876-zyxw-abcdefghi",
                "ShadowAppLink":  null,
                "IsSwsEnabled":  null,
                "ChildLinkedApps":  null,
                "MunkiMetadata":  null,
                "AdminTag":  "_I18N_AppCategory_Security",
                "UserNameStrategy":  "ADAttribute",
                "Description":  "CyberArk Secure Web Sessions Portal.",
                "SkipSwsForAwsCli":  null,
                ...
                "LastUsedPodUrl":  null,
                "IsBuiltInApp":  null,
                "WebAppLoginType":  null,
                "AppType":  "Web",
                "AuthChallengeDefinitionFlowId":  null,
                "ServiceName":  "SWS_Portal_Bridge",
                "LastUsedCentrifyUrl":  null,
                "PortalApp":  false,
                "ParentApp":  null,
                "DeepLinkUrl":  null,
                "Icon":  "/vfslow/lib/application/icons/CyberArk.png",
                "WebAppTypeDisplayName":  "SAML",
                "PolicyScript":  null,
                "WorkflowEnabled":  null,
                "BypassLoginMFA":  null,
                "CertBasedAuthEnabled":  null,
                "IsTestApp":  null,
                "WebAppType":  "Saml",
                "ProvSettingEnabled":  null,
                "_TableName":  "application",
                "TemplateName":  "CyberArkSwsAccessSAML",
                "Notes":  null,
                "IsIdentityAsIdpEnabled":  null,
                "AuthChallengeDefinitionId":  "abcdefghi-987654-zyxwtuv-1ab2-123456789",
   ...
   $false if failed
#>
function Get-VPASIdentityApplications{
    ...
    Process{
        ...
        try{
            ...
            foreach($row in $result.Result.Results.Row){
                if($row.Name -match $SearchQuery -or $row.DisplayName -match $SearchQuery -or $row.Description -match $SearchQuery){
                    $output += $row
                    $counter += 1
                }
            }
            ...
            foreach($rec in $output){
                $recProvSettingsIsEnterpriseScimUser = $rec.ProvSettingsIsEnterpriseScimUser
                $recFeatured = $rec.Featured
                $recProvSettingPreview = $rec.ProvSettingPreview
                $recName = $rec.Name
                $recCategory = $rec.Category
                $recOrgId = $rec.OrgId
                $recMobileAppType = $rec.MobileAppType
                $recDirectoryId = $rec.DirectoryId
                $recProvSettingsValidateEmailAttribute = $rec.ProvSettingsValidateEmailAttribute
                $recDisplayName = $rec.DisplayName
                $recAppTypeDisplayName = $rec.AppTypeDisplayName
                $recOnPrem = $rec.OnPrem
                $recOrgPath = $rec.OrgPath
                $recID = $rec.ID
                $recShadowAppLink = $rec.ShadowAppLink
                $recIsSwsEnabled = $rec.IsSwsEnabled
                $recChildLinkedApps = $rec.ChildLinkedApps
                $recMunkiMetadata = $rec.MunkiMetadata
                $recAdminTag = $rec.AdminTag
                $recUserNameStrategy = $rec.UserNameStrategy
                $recDescription = $rec.Description
                $recSkipSwsForAwsCli = $rec.SkipSwsForAwsCli
                $recParentAppTemplateName = $rec.ParentAppTemplateName
                $recProvConfigured = $rec.ProvConfigured
                $recVersion = $rec.Version
                $recIsGatewayed = $rec.IsGatewayed
                $recCatalogVisibility = $rec.CatalogVisibility
                $recGeneric = $rec.Generic
                $recCorpIdentifier = $rec.CorpIdentifier
                $recMobileAppSource = $rec.MobileAppSource
                $recBrand = $rec.Brand
                $recLastUsedPodUrl = $rec.LastUsedPodUrl
                $recIsBuiltInApp = $rec.IsBuiltInApp
                $recWebAppLoginType = $rec.WebAppLoginType
                $recAppType = $rec.AppType
                $recAuthChallengeDefinitionFlowId = $rec.AuthChallengeDefinitionFlowId
                $recServiceName = $rec.ServiceName
                $recLastUsedCentrifyUrl = $rec.LastUsedCentrifyUrl
                $recPortalApp = $rec.PortalApp
                $recParentApp = $rec.ParentApp
                $recDeepLinkUrl = $rec.DeepLinkUrl
                $recIcon = $rec.icon
                $recWebAppTypeDisplayName = $rec.WebAppTypeDisplayName
                $recPolicyScript = $rec.PolicyScript
                $recWorkflowEnabled = $rec.WorkflowEnabled
                $recBypassLoginMFA = $rec.BypassLoginMFA
                $recCertBasedAuthEnabled = $rec.CertBasedAuthEnabled
                $recIsTestApp = $rec.IsTestApp
                $recWebAppType = $rec.WebAppType
                $recProvSettingEnabled = $rec.ProvSettingEnabled
                $rec_TableName = $rec._TableName
                $recTemplateName = $rec.TemplateName
                $recNotes = $rec.Notes
                $recIsIdentityAsIdpEnabled = $rec.IsIdentityAsIdpEnabled
                $recAuthChallengeDefinitionId = $rec.AuthChallengeDefinitionId
                $recIsMarketplaceApp = $rec.IsMarketplaceApp
                $recWebUPAppType = $rec.WebUPAppType
                $recHandler = $rec.Handler
                $recState = $rec.State
                $recNotSelfService = $rec.NotSelfService
                $recIsScaEnabled = $rec.IsScaEnabled
                $recDerivedCredsSupported = $rec.DerivedCredsSupported
                $recVersionName = $rec.VersionName
                $recPopular = $rec.Popular
                $recProvCapable = $rec.ProvCapable

                $minihash = @{
                    ProvSettingsIsEnterpriseScimUser = $recProvSettingsIsEnterpriseScimUser
                    Featured = $recFeatured
                    ProvSettingPreview = $recProvSettingPreview
                    Name = $recName
                    Category = $recCategory
                    OrgId = $recOrgId
                    MobileAppType = $recMobileAppType
                    DirectoryId = $recDirectoryId
                    ProvSettingsValidateEmailAttribute = $recProvSettingsValidateEmailAttribute
                    DisplayName = $recDisplayName
                    AppTypeDisplayName = $recAppTypeDisplayName
                    OnPrem = $recOnPrem
                    OrgPath = $recOrgPath
                    ID = $recID
                    ShadowAppLink = $recShadowAppLink
                    IsSwsEnabled = $recIsSwsEnabled
                    ChildLinkedApps = $recChildLinkedApps
                    MunkiMetadata = $recMunkiMetadata
                    AdminTag = $recAdminTag
                    UserNameStrategy = $recUserNameStrategy
                    Description = $recDescription
                    SkipSwsForAwsCli = $recSkipSwsForAwsCli
                    ParentAppTemplateName = $recParentAppTemplateName
                    ProvConfigured = $recProvConfigured
                    Version = $recVersion
                    IsGatewayed = $recIsGatewayed
                    CatalogVisibility = $recCatalogVisibility
                    Generic = $recGeneric
                    CorpIdentifier = $recCorpIdentifier
                    MobileAppSource = $recMobileAppSource
                    Brand = $recBrand
                    LastUsedPodUrl = $recLastUsedPodUrl
                    IsBuiltInApp = $recIsBuiltInApp
                    WebAppLoginType = $recWebAppLoginType
                    AppType = $recAppType
                    AuthChallengeDefinitionFlowId = $recAuthChallengeDefinitionFlowId
                    ServiceName = $recServiceName
                    LastUsedCentrifyUrl = $recLastUsedCentrifyUrl
                    PortalApp = $recPortalApp
                    ParentApp = $recParentApp
                    DeepLinkUrl = $recDeepLinkUrl
                    Icon = $recicon
                    WebAppTypeDisplayName = $recWebAppTypeDisplayName
                    PolicyScript = $recPolicyScript
                    WorkflowEnabled = $recWorkflowEnabled
                    BypassLoginMFA = $recBypassLoginMFA
                    CertBasedAuthEnabled = $recCertBasedAuthEnabled
                    IsTestApp = $recIsTestApp
                    WebAppType = $recWebAppType
                    ProvSettingEnabled = $recProvSettingEnabled
                    _TableName = $rec_TableName
                    TemplateName = $recTemplateName
                    Notes = $recNotes
                    IsIdentityAsIdpEnabled = $recIsIdentityAsIdpEnabled
                    AuthChallengeDefinitionId = $recAuthChallengeDefinitionId
                    IsMarketplaceApp = $recIsMarketplaceApp
                    WebUPAppType = $recWebUPAppType
                    Handler = $recHandler
                    State = $recState
                    NotSelfService = $recNotSelfService
                    IsScaEnabled = $recIsScaEnabled
                    DerivedCredsSupported = $recDerivedCredsSupported
                    VersionName = $recVersionName
                    Popular = $recPopular
                    ProvCapable = $recProvCapable
                }
                $outputlog += $minihash
            }
            $completeOutput = @{
            ...
            if($counter -gt 1){
                ...
                Write-Verbose "MULTIPLE APPLICATIONS ENTRIES WERE RETURNED, ADD MORE TO NAME TO NARROW RESULTS"
                return $output
            }
            elseif($counter -eq 0){
                $log = Write-VPASTextRecorder -inputval "NO APPLICATIONS FOUND" -token $token -LogType MISC
                $log = Write-VPASTextRecorder -inputval "REST API COMMAND RETURNED: FALSE" -token $token -LogType MISC
                ...
                $log = Write-VPASTextRecorder -inputval $completeOutput -token $token -LogType RETURNARRAY
                write-verbose "FOUND UNIQUE APPLICATION"
                Write-Verbose "RETURNING UNIQUE APPLICATION"
                return $output
            }
        }catch{
            $log = Write-VPASTextRecorder -inputval $_ -token $token -LogType ERROR
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQU1B4EFDyIUVXsL1jRcG9cPdfk
# hZmggiTgMIIFbzCCBFegAwIBAgIQSPyTtGBVlI02p8mKidaUFjANBgkqhkiG9w0B
...
# CisGAQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEF