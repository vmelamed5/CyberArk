<#
.Synopsis
   Clone an application in Identity
   CREATED BY: Vadim Melamed, EMAIL: vpasmodule@gmail.com
.DESCRIPTION
   Use this function to create a new application by duplicating an existing application in Identity
.LINK
...
.EXAMPLE
   ...
   $TestApplicationStatus = Copy-VPASIdentityApplication -InputParameters $InputParameters
.EXAMPLE
   $InputParameters = @{
...
.OUTPUTS
   ...
   $false if failed
#>
function Copy-VPASIdentityApplication{
    [OutputType([bool])]
    ...
    Process{
        try{
            ...
            Write-Verbose "FAILED TO CLONE APPLICATION IN IDENTITY"
        ...
        try{
            ...
            if($NoSSL){
                ...
                $uri = "http://$IdentityURL/SaasManage/CloneAnApplication"
            }
            else{
                Write-Verbose "SSL ENABLED BY DEFAULT, USING HTTPS"
                $uri = "https://$IdentityURL/SaasManage/CloneAnApplication"
            }
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUAHQCkZAVAI6Qx8Pa4lU2N1jL
# d5OggiTgMIIFbzCCBFegAwIBAgIQSPyTtGBVlI02p8mKidaUFjANBgkqhkiG9w0B
...
# CisGAQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFNNZPrmEEpboWEmZy5kPHvPFfMJm
# MA0GCSqGSIb3DQEBAQUABIICAEm/e+eEYEf370yM+F72FxPQv4LUUa57wtnadEQV
# L4fX+KufzNhUu5MdAyw262Bgw9hYNb6jJfu01yuMNAA42EoqzqY6tJLCvRJuyT4v
# Aw3OS4kLbb9Vpghn1arcQXQexdrjV+p4sgvFYGPpeZU3BLBewH0wXFhsZaqKHOTn
# uRS3GdmBnLqEI1ladfBKC1XMM/MR87UiSRf6NLJdA8/pRK2MHizUdZMk+PYZ8zON
# qJcSgu4x1V6wphwjnwQCaMtW/JfTaUAR/Cr3HuC6gsUyhgME9RRStbMqikjpk5eP
# jY5lRVrDa6lfpZ4d2454b6MKmvD70FhDmyhq+NONUUSAPFV8vqLgVqgHCkHQGokm
# 6kIelccGhNUQU0ijvR5ma32grsSKvXeDnvorF2x2cbLdsjI6aIIBQTKUaQCOLKUg
# uX9UFL6m6DHnajrvh8ZTQG7b2+yn/41/tDal7F6J4+bkMDCDjnG+pwP6hqSqteKl
# kBkW1kNeAyqd3goCWsLZHyJwLgCYK+5b5MBFzZEZkhHeSSMViZ/Y/cgEvQsfQhZI
# vX+xmMfcVReV7P4AXTAuOvMrzF+mLU6ZDihcEq9/c/M8xutcqoyh0J2JskhJx3OK
# X5TXgntcDrubmzsI2XI3YXc+TY06dp+2ZrGlK2ZRhz863dpaqTsx3UGe3JIhGyTU
# z4d8oYIDIzCCAx8GCSqGSIb3DQEJBjGCAxAwggMMAgEBMGowVTELMAkGA1UEBhMC
...
# 9w0BCQUxDxcNMjYwMjA0MDQ0MzUzWjA/BgkqhkiG9w0BCQQxMgQwQGzjNXdlC4m3
# RDHBEgNHVqEuoUUdJtBoIT3s87e9ZjDiaUEEhtPDH/7L8gvnW7igMA0GCSqGSIb3
# DQEBAQUABIICALxhJBYqmu3EfrjqO8WhylDVT6yBjxdKXy4/ANM6zGBK95xBt/JB
# w9Zo05ySNqwXJ40KSskKE9UdQHW8lGUfiv8E8JeB9voBlViTGcEH4PQr6aKazVP6
# ZLTG/V4m5S+QKzsLed+Mq3wkmI5APo3N/ZJZyeq19RLe1uYaKqsNmWcZGYhmk+wv
# X17gtPR6ufHZ0HVeO05EBb3au91FmTj6WuIiinFIPI8wSb+h1YBXC7cGfqP5j1FO
# ldpKvk/aoDJdljdYOoKM2+UprrWKVyzl9wHFp5GDoZFWtGBIfRXGJRxLIlf8klsI
# A9R1ra2GqSPA6t5+QlFcQJ+k+12i/3SfUxUWuHFKzGKiZIEq6yrcwZukOe2oOjvI
# ZkJCiQ590w34Uhmwt4LgxmQVnDlGcXSFYJl92fgg/wiEG5bwTiWlWGQUWccoRLPM
# XkFeiEa7hMTt7hdiGv4YECnSS0fYsYw9Jp98XICzMrmLbGst6Gqzbp2YWQOJQ5RX
# iVUoPW+GmVMRxsdeo7W+FzQRu7EI+p1GvNfEB37EkUklCij0bKWZPEUFxpW25KVj
# prSdWgX5moy/MD4eLzXNUL36M/yRlPzEc3S8yKH7o9njBLPbiA5RG5cMlM2Bho/B
# HjAlmHxqhX6zt+wfpoYCpsgAiULjD7AqtFuFxRFE6IiB0DNeRYcjHt8G
