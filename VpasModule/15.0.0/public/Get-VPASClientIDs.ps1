...
.DESCRIPTION
   Use this function to retrieve a list of CyberArk client IDs
.LINK
   https://vpasmodule.com/commands.html#Get-VPASClientIDs
.NOTES
   Category: PAM
   Tag: Vault
   Since: v15.0.0
...
.EXAMPLE
   $ClientIDs = Get-VPASClientIDs
.EXAMPLE
   $InputParameters = @{
        ExportToCSV = $true|$false
        CSVDirectory = "C:\Temp"
   }
   $ClientIDs = Get-VPASClientIDs -InputParameters $InputParameters
.OUTPUTS
   If successful:
   {
        "clientIds":  [
...
function Get-VPASClientIDs{
    ...
    Process{
        try{
            ...
            Write-Verbose "FAILED TO RETRIEVE CLIENT IDS"
        ...
        try{
            ...
            if($NoSSL){
                ...
                $uri = "http://$PVWA/PasswordVault/API/License/Clients"
            }
            else{
                Write-Verbose "SSL ENABLED BY DEFAULT, USING HTTPS"
                $uri = "https://$PVWA/PasswordVault/API/License/Clients"
            }
            ...
            if($ExportToCSV){
	            $runexport = Write-VPASExportCSV -Data $response.clientIds -CommandName $CommandName -CSVDirectory $CSVDirectory
            }
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUvmCP7LN3qj+oNzYrv6fTRpIp
# MVOggiTgMIIFbzCCBFegAwIBAgIQSPyTtGBVlI02p8mKidaUFjANBgkqhkiG9w0B
...
# CisGAQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFBIMA4shDRthvt8txAByGxqdtSp5
# MA0GCSqGSIb3DQEBAQUABIICAClhSdpj9oNqyMLxdw9TzRHP15IyVsAA/Wt4dWKb
# qC6qERClTLGjIbgEiD2FwglbCFHnJnmA3Lw3pKUuzsbnxkPaX+EVC3WMmc3o6+V6
# GDfE+vJYiphR+P0qS1JdA1sYIoKhg1MpTgZf1hAzj8A2zGDQ7ZjPWWvla78oH4Jh
# zy2eVyqF+afGGn4Lk7I8XDqEQkQSmllEdLjtLIB2mukCn7kYx3eNoX5+PFP50FA8
# EhFvdb2/2YJp8RVRgF7q8HmNIPXeKMWtQZU66z3djBUUcPjiYW51GS9dc0SbrWEn
# u4aeQD4ZGpIp+8sd5BewXVpC64ro/7w5pzyvFCj/E1ELiS+VlDw8LvJO6CBLW14S
# 4iWy5ImDUD57z9FT8SAb3lPy2C3FuLTZtLDtM3QpJbZrQ3mSRwTDYdmmp1RNIuEq
# ge1pJesOSm3VC1VDXmhzSsJj3X1TzOhLtVsH222UTvVZZF30G0UdadQWEf/J7AXc
# JAM0uJUE/E51JM/ED+ewrmksumljltAGml0Tr9G9IXl9zbsc6MaKV+kehZRJbDOW
# Mcpqy9jSywtO7ol4ddK35cBL29KnYBcye9cdyeu3L50/R0BT5qVIEWaUMtS3o5tH
# OeCP/XYxASOhBtjJSZt7rSkbrtDwoK6Nxrl9H6T3ztNPSajnYqd+ft8gTYSJkSqX
# anxQoYIDIzCCAx8GCSqGSIb3DQEJBjGCAxAwggMMAgEBMGowVTELMAkGA1UEBhMC
...
# 9w0BCQUxDxcNMjYwMjA0MDQ0NjU5WjA/BgkqhkiG9w0BCQQxMgQwCtlUXV9mNVVO
# NcFqxjrdTdeUW4R5qvfYEeq3V9CGqsDspvf0PTBU3STGP11B/qwUMA0GCSqGSIb3
# DQEBAQUABIICAJdorYnKWERaaJbYWzPmSVtvhDT5RfomcCwbSv2VEcnNu4rQEfZ2
# ryFhiF50PfFMjN3pOEE4SGKuVeGluLtWf+cV3zjWo6U1P04zDFvkaJv+wdTv6SLq
# Yt+muNGqr01h2qUv06fwWnK3sZEfJcHIlcafLJP+zIPT9jl81mEDv+qiE8gGH0z2
# BSNUpnZpusDrU7pFq+GrZ98oJUqsCIhIKwmC2AoN03V/upXZy/3OAdkpAezuKoRR
# tbhgXRW8zqT9m2hs1uG4U3ykfwV0P26y4thCtLRPfzIC9K5kCenUzIEkkFpkswJf
# TSNCpZnQZLD/rDiwD+I9ZVD0dczfpYe6cOjxWo5rwItsMepmggHMEzXv/uZevaKn
# gSIIKrGwW+BU8Ur8KHG14O12MSx4pm5zbgIIP6HVHPYN2rMDXjypuuabZPQpf497
# x0wyRXaMxSna1QQxoNFpb2O4NYWXAh5D3i7UZUMkgtU5aLMYvBE6TbT+J59u8B4/
# Jz4YZNTjkt+8EADT0zjSImGzK5IxW+wahKcfhGYKgIfcecfFbTpZdIQ/4AQI75fx
# AvyeHzeQEIhuN9csX5E/Ahm/52z19fY6+J1lU29hErNPVH7Dr7BFt00T9CuuoHjI
# NFKLfMqqpyjbFwpXoNam7kKY5xLbrdLVnr73AmBQznvDlpSC0GvNUuld
