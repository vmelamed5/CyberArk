...
.DESCRIPTION
   Use this function to retrieve details for a discovered account from the pending account list
.LINK
   https://vpasmodule.com/commands.html#Get-VPASDiscoveredAccountDetails
.NOTES
   Category: PAM
...
.EXAMPLE
   $DiscoveredAccountDetailsJSON = Get-VPASDiscoveredAccountDetails -SearchQuery {SEARCHQUERY VALUE}
.EXAMPLE
   $DiscoveredAccountDetailsJSON = Get-VPASDiscoveredAccountDetails -DiscoveredAccountID {DISCOVERED ACCOUNT ID VALUE}
.EXAMPLE
   $InputParameters = @{
   ...
   $DiscoveredAccountDetailsJSON = Get-VPASDiscoveredAccountDetails -InputParameters $InputParameters
.EXAMPLE
   $InputParameters = @{
        DiscoveredAccountID = "12345-abcde-67890-fghijk"
        ExportToCSV = $true|$false
        CSVDirectory = "C:\Temp"
   }
   $DiscoveredAccountDetailsJSON = Get-VPASDiscoveredAccountDetails -InputParameters $InputParameters
.OUTPUTS
   If successful:
   {
        ...
        "isPrivileged":  true,
        "customProperties":  {
                                 "ou":  "CN=vmanda,OU=Users,DC=vman,DC=com",
                                 "sid":  "S-1-5-21-123456789-987654321-1234567-500",
                                 "domain":  "vman.com",
                                 "groups":  [
                                                "Administrators"
                                            ],
                                 "enabled":  "True",
                                 "osFamily":  "Windows",
                                 "lastLogon":  "Jan 14, 2026 10:54:39 PM",
                                 "lockedOut":  "False",
                                 "osVersion":  "Windows Server 2019 Standard",
                                 "description":  "Cyberark API playing around",
                                 "passwordAge":  "3",
                                 "currentState":  "Enabled",
                                 "expirationDate":  "Dec 31, 1969 04:00:00 PM",
                                 "passwordLastSet":  "Jan 11, 2026 12:09:01 PM",
                                 "passwordNeverExpires":  "False",
                                 "passTheHashVulnerable":  "No"
                             },
        "creationTime":  "2024-10-02T20:49:46",
        "updateTime":  "2026-01-11T20:14:54",
        "numberOfDependencies":  0,
        "lastActivityStatus":  "WARNING",
        "tags":  [
                     "TestingTags",
                     "MultipleTags",
                     "Hello"
                 ],
        "networkId":  "1234567-abcdefgh-1234-abcd",
        "scanDefinitionId":  "123456-9876-zyxw-abcd",
        "scanProperties":  {
                               "tags":  [
   ...
   $false if failed
#>
function Get-VPASDiscoveredAccountDetails{
        ...
        try{
            if($PSCmdlet.ParameterSetName -eq "InputParameters"){
                $KeyHash = @{
                    ...
                    set2 = @{
                        AcceptableKeys = @("DiscoveredAccountID","ExportToCSV","CSVDirectory")
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUelrlX8ouM9fWN+gyxlumegZv
# sMOggiTgMIIFbzCCBFegAwIBAgIQSPyTtGBVlI02p8mKidaUFjANBgkqhkiG9w0B
...
# CisGAQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFFlxhSYgJDFAsAX795QWiPUWEPJC
# MA0GCSqGSIb3DQEBAQUABIICAIzE2c3U0UYNvUt59Gff3kBmF2OGgq76uBwNij9z
# s4nykzn56XWOHDl7Q4DqvOnrFngnaXTOFd8eVBrvOQMnXw4Rql1sYF6gcikVmjAJ
# w9bWptPq4PQf1bAiHwFQNgf1A/6TPP8YZqTCMaSMkSP63nejB2b7tMWohM6m0acC
