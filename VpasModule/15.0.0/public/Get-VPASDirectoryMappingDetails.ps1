...
.DESCRIPTION
   Use this function to retrieve details for a directory mapping
.LINK
   https://vpasmodule.com/commands.html#Get-VPASDirectoryMappingDetails
.NOTES
   Category: PAM
   Tag: Directories
   Since: v12.6.0
...
.EXAMPLE
   $DirectoryMappingJSON = Get-VPASDirectoryMappingDetails -DomainName {DOMAIN NAME VALUE} -DirectoryMappingName {DIRECTORY MAPPING NAME VALUE}
.EXAMPLE
   $DirectoryMappingJSON = Get-VPASDirectoryMappingDetails -DomainName {DOMAIN NAME VALUE} -DirectoryMethodId {DIRECTORY MAPPING ID VALUE}
.EXAMPLE
   $InputParameters = @{
        DomainName = "vman.com"
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUgb3m5TDJrh0Ywm7tR6ZXvVdr
# SKSggiTgMIIFbzCCBFegAwIBAgIQSPyTtGBVlI02p8mKidaUFjANBgkqhkiG9w0B
...
# CisGAQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFKeKqlNDDYe/42MqugzFqhB6r9Dz
# MA0GCSqGSIb3DQEBAQUABIICAByxcNxIyHv/h1+ldIyUiMsux1vSAl6HHAOB1PTt
# lK7cEx9sa/PKabWEmh2I0XS5VC7/pukJzxVKwcklIPnuKQmWzT2CLtCRbP65qSDR
# NVkadw9QmtWR1bLw0EfTVR4/uJhcMXdjmer6YhCVluOKBSH+srw5n7VzdWEjImQ/
# /YQmiqp4gVf8WRHfiPNAtlGizp5vgkqQncIYrHt/wI20gCiP9Z/p6zzx1XHjblSV
# flyDxLjSvkzPd8N7qJ+DncLFmPFKaQ2obJKLo79DddMZLnw6C9gtg9E10D3rFesE
# jgttfNd7G8gHsE1WYlrJwtqKLqV/NL4tObRJy4yydPPL5tuqVn1aaEIiZjA7RBTT
# k5UMttor+uqyU03rvavSkTPJ2v5BQd8gj13UiKK/qLOL2qDBlQmHlaktnvS441pY
# AoCH9ACKr4FHKh9lDmaR0DM+sM6WNYHRbWYxcQN4LW1Ybvqm7RFaElqCuEI44Sdg
# qEwNXP1fs7id1uXkFDCj3y06H/ZlzceVLU1QIzCs3EdIzkDvaqSNrgKpfJPonelP
# ldV/hi6l6eHHQjKXnGvVZhbkdNgso/syVXKu5c+Ee9v5ihDeZn9VQ8UC/h+w2LA6
# wMwtX+9hmiQ2ARZv+ng5l9THIlXEMBh57O1C1mFbmKEU03aUjIW2+A5xKXjQo4rb
# j94moYIDIzCCAx8GCSqGSIb3DQEJBjGCAxAwggMMAgEBMGowVTELMAkGA1UEBhMC
...
# 9w0BCQUxDxcNMjYwMjA0MDQ0NzUxWjA/BgkqhkiG9w0BCQQxMgQwaNxB8Vzf+mPp
# qTYkT4nQ++JaCyVwN9zAk3/k+WQPcrtnhx5zZweSirOlDMHIYG3nMA0GCSqGSIb3
# DQEBAQUABIICANH78Up/3HSFzZvdXV9Jd6Pk7PTvP/1TdHFqs99y9+pTg8RYVMmr
# rI4pCQsp+1075/WnIsEv0lI2X+zWNXZ/BNS7obEg4LezPrIM2DppD+nkj2qGCZjX
# dkDi6YyuG/Pzfhm8QVQa6Vma/hn10H2dKqQeC1czweKBWd1jqRw8ilRHSI6oMJ6p
# BZG8P19Mew5fCMHIw0NBfMNTKvRmvwyC2o9D5wAsJju52IMytM4Rq8Lz0aeSzpKA
# OE3x+Nxq8DSxTMWVJosvkkMJk+TvHc9cWAiZlZzPa7+oyiSvzkgJeWDftBwZ3GP8
# 2K8vQFuWqvhIa+j82IMoj9VSNb61nC/CkhKacauwR7YkupNmqzrGWMLE0GUWDAI6
# bXx9T93E7AenzbCIFHE+Ll9udQt1id/U8nlzS+gHVp1z3qSVo8NKKAOj1f9BTaNQ
# M+76mQFN2Owb2wE2DkJ0+gGpHxxVId7g5vP4GyBvY9MTeHKkHtBd8maYr8eTdP7G
# F1z08WvCd9pHHFpFnjT4RN2yn13Ev4VUpUZFZI704lt+qSANPc2FEFWj4FntqaU8
# 7fTkWUZ3+eVUrZXnTuTQNN3N2wFs4LmtaBBmiO19EDoygLIhYc5qyHAbFBdApZ3N
# fcHVLj1PPSTsdD5fe8+iGe4hWOpLGYpvAOEIA8NWw318NXflDswRz4KQ
