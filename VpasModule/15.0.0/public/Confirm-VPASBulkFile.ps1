...
.DESCRIPTION
   Use this function to validate a CSV file for bulk operations
.LINK
   https://vpasmodule.com/commands.html#Confirm-VPASBulkFile
.NOTES
   Category: PAM
   Tag: Bulk Actions
   Since: v12.2.1
    ...
    Process{
        try{
            if($PSCmdlet.ParameterSetName -eq "InputParameters"){
                $KeyHash = @{
                    set1 = @{
                        AcceptableKeys = @("BulkOperation","CSVFile","ISPSS","SRS","HideOutput")
        ...
        if(!$HideOutput){
            Write-VPASOutput -str "VALIDATE BULK CSV FILES UTILITY" -type G
            Write-VPASOutput -str "*Please note, this only checks syntax of a CSV file, it does NOT go into Cyberark to edit any values and does NOT validate SafeNames, PlatformIDs, SafeMembers, etc." -type C
        }
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUqQbyMCs//TuGQldlZGLi5JDK
# owaggiTgMIIFbzCCBFegAwIBAgIQSPyTtGBVlI02p8mKidaUFjANBgkqhkiG9w0B
...
# CisGAQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFGNxqyrJBSWpK8gfJSfry31qUEkN
# MA0GCSqGSIb3DQEBAQUABIICAK7mhbf+n8R8PVCF721Fj9FQkY4RsN11TFXBzcRz
# bpUh9N9ROJDOQnOrC/fegOA42gUbNhu9uQ/2x7nXYpDm6LZE83jiKblmlQ9uPRVk
# RAIo55P6O2f2aRUyOPjFH0F/yg1E81Bm2d92p4k+BpzTjQw8AC8r1KWV5ZjSb45b
# nHMN2HSEnJlWh/QZeyPGb61vmf1ttPZHwNmRnKnir5CbCJOHyCzHEOm+6iXRs5PT
# 1zu0Z7CqMQIwkuygOscd9rXu/xrqLkq9wud+MiBNkp2qBhGWApToxopVmb6jlpPb
# Q1avD2RK7zWEg4naitcVS9QT1wNHQn9BIKYkxOGkcMhBn7QbqMNe1aa5lnBgQurg
# CrafFKVM5AXTSDZVZtUwf7ZaCvm68AmlQYgH5/PHVP3l+j4KOAppyDfs4dAF71wp
# 5BTRueAmhDZsIxrAUtW2uG7XAtKOq1nSL3CWAg/Ep2vl2EkZ1a1lbAM6KmOEF2YC
# bATWBxu0N9Uu4Uv0vZwLklQvukE/inMSscnjRpxtnuh3cr2b80RNQRlacwISXUaO
# iCdr1EdG2DW5SFH6N3GHLsFDb4klygEboKMPwNc4MNkayuGFVBN10MDCLxEC+UoC
# UH4IslSL0jxP2syVL9F91ZbxYk49pCjYUwv9dnkq3lwibDyemy9kubewbYkIkRUC
# NNr4oYIDIzCCAx8GCSqGSIb3DQEJBjGCAxAwggMMAgEBMGowVTELMAkGA1UEBhMC
...
# 9w0BCQUxDxcNMjYwMjA0MDQ0MzQ3WjA/BgkqhkiG9w0BCQQxMgQwTqVXDQFCnJ8a
# QzcPLQtbi6QzXnaaVk6dMaGHHUWtlpLV613Ms6OJF6Hb6aWn29UDMA0GCSqGSIb3
# DQEBAQUABIICAJ7Tt+AE3TGkmhou6CfmgpxEBHUZEAa/xhM49hlTyuWxCkxuDLDk
# GtNWui2KIdS1IbtRJSa/GZ057G7qL5Fdxl9VnMqm0qG2UnsXS3qsWu6GKs7EoQPr
# ++P+gdSb+4T5UoNZ/jhBhDyDAHt8yyxp6H7vsPEVu6wwZuDMYgZlkzPL9ArpLOpB
# eeVHj+IhAP0L+aJRgD1qT9G7PmGpe5vctmEUr9ka+OVgZhNxDx0kSO7PK8YljyJ4
# Jv398nfJ2JOpeqAGh8IO/EBUcRwZFVOaijOpkpOE17SmphsVsX+ch8NYxiJu3lfV
# 7fe7alxHGAKLey6e3vQv3mO0ka+PaakmewuRVLn3aTBYJVT8hA3auRTBGVdv8pgr
# DSpmFjVOJ6+9OrcdX+9YzUwk4pPK98ZYLR71VVI030G/obBvkHctuVPa2M4BVNnl
# p1kB0WtkMv+SzSTriXWJ01nP5NWABJPkJQZL3rqJ9rDWl14Azep2QzkL1gGqGCIl
# As6k1Zevi7+kM02KPTLZOfAXfc4EAIlKAOQmRwTYrBrUZllmLZycKukKUu+2RBUK
# 1lVcBEXJ3s/FUDBt9amzcO3OmuOA2E13wwpY0rJa0v4+PZOvRXmJbcJ2Ew0NLQKK
# S+iJQvnIFU5CJ54LDWmOctyM2xF/Q003+RmBStltuYH12jPdDjIbyZLx
