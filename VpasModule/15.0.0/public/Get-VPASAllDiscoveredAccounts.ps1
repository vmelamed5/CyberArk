...
.DESCRIPTION
   Use this function to retrieve all discovered accounts in the pending account list
.LINK
   https://vpasmodule.com/commands.html#Get-VPASAllDiscoveredAccounts
.NOTES
   Category: PAM
    ...
    Process{
        ...
        try{
            if(!$ISPSS -and ($PVWA -notmatch ".privilegecloud.cyberark.")){
                ...
                if($NoSSL){
                    Write-Verbose "NO SSL ENABLED, USING HTTP INSTEAD OF HTTPS"
                    $uri = "http://$PVWA/api/discovered-accounts/?limit=50&extendedDetails=$true"
                }
                else{
                    Write-Verbose "SSL ENABLED BY DEFAULT, USING HTTPS"
                    $uri = "https://$PVWA/api/discovered-accounts/?limit=50&extendedDetails=$true"
                }
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQU3GWign2ylWKB4y21bSBzX77J
# Va+ggiTgMIIFbzCCBFegAwIBAgIQSPyTtGBVlI02p8mKidaUFjANBgkqhkiG9w0B
...
# CisGAQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFLbhU5PtQ/AO2Kwc6bMJBC1xv4QM
# MA0GCSqGSIb3DQEBAQUABIICAJPE2JASPV3ac3/2z9an9SuYf4FmOqh7MLiNNthL
# QEDCTvC4D9SGyyzv6iTimztpes4YaJtk/j9P09KNgLNcej3e2k9RKjXK+c8hLf8j
# RWFlZZHlkuizyJB99Fg79Oi97WYSVWjdJtTGNNzPKlftivZ5KE1rRHxRS6cqwkUt
# i2KxivsI975+j0WS1bf1Oo++0rJ5cw4mr74LBo2z232rTZ09n5H3Fx8ey2uNNn6J
# YbhAVaD1dQKxJQkvzAO4hXTsn20UYJ0HsBHDn4n4Nu7DIymO18GqsuflXAc/GELm
# 7xbPz1lpn41G6DLTKvQDsDWx1RgXh8GBb06sRtDH2HZps9N93YbgnP8Go4yPwdL2
# 9djeeJgtr3vwIMqsR8zf1981KLsYP31s0DP723/MlBWlPObU6Y8vP2akBBviX6Ba
# jIJCMx1E72Ipbw49udRwQ/9tHPJYUZJXh506T3FMdpWNZFiMD6rfO+n0ClZttzaO
# 75kxFHpH4f6G5G3sGoI2Pl2CQ2yB/NNYrCyJycRKu9T/987FUSsXDYV7oeTCQOv6
# yUJY7OTD7EwN9x+aCNKAR5XXC9mmLiY4HaV/1ZrNrIcyoMR/aRakmt3K8WhoQvqy
# NcKGbqRM/qilMo+c+JirQ/L7Mx48x61BV+jhTszPJXTT2LioIFLP3K5zEar79tax
# iNKToYIDIzCCAx8GCSqGSIb3DQEJBjGCAxAwggMMAgEBMGowVTELMAkGA1UEBhMC
...
# 9w0BCQUxDxcNMjYwMjA0MDQ0NTQ0WjA/BgkqhkiG9w0BCQQxMgQwyKAjuzQiXRcZ
# 2IO+NvQcg7W2lQRLn7FfKaNuIzwmhcTOU0CQkUPhHQcapXcrRoFFMA0GCSqGSIb3
# DQEBAQUABIICAEUcocVdB4U3j7orkf24lx13xcz9b5gPMCa4YdhSxA7EhtLhlR3D
# xNuY/YPlmmMeBRahHZha41d7jvuEmpMWiHjH3h7i8MnYio2bcy4EtU2f9q1JRp31
# IW2NAWgaITR6I2XA4XXb+bJyC8vmodnorHa8kdhhk0JPt+JcVxIU7nNt0gNBkVpQ
# 9bqXOGcxywpYUFpkaEDNsU8sTrauOISLvYkuQJOjkIqDbIMc0P1RvAPq6OpvsvDE
# C76wJid7Hi6TWLtNRPk+c8IbD9sPtm2hYEdHlD60PdIe/LkSM8c17HJ9cFKbTYiG
# CK9xs6TKqIWRpZ4aIhSEjEu7FXGDcXzdiHGIHzdbQKNUGeif8kpcwT2w2I+8d5nw
# DE4QTOeHdwQIW66Y8OIa2DyJaV4rTroShlrx1Ax3QmtN+3CN6GJnu5aFOf+1Iz2Y
# S6LgdFy168p5fyaqHBt8xOZQ0mrFH4AGdo4x+fucnfy0DZ7x8BchAt815PdMZP1x
# UE03Eh9zh6bvNHYa0nJ5dP5aBUpkS5QkgfQd3yPp1Op42DYq2lU2IA6X2vknp9kq
# iU8F1YgrKtYEaN0gOqN4HSahT8o18p+k5dWJt9QjrfncaJcLgCouispg2N7vujIe
# sIIXOTMx1nzC0h4DKlpn/6e/zYqXw0bs6yMAa038Ns5WXeCZ5wSFPCpu
