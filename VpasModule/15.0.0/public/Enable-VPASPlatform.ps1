...
.DESCRIPTION
   Use this function to activate a disabled platform
.LINK
   https://vpasmodule.com/commands.html#Enable-VPASPlatform
.NOTES
   Category: PAM
   Tag: Platforms
   Since: v11.5.0
...
.EXAMPLE
   $InputParameters = @{
        ActivatePlatformID = "TargetPlatformID"
   }
   $ActivatePlatformStatus = Enable-VPASPlatform -InputParameters $InputParameters
.OUTPUTS
   $true if successful
   ---
   $false if failed
...
function Enable-VPASPlatform{
    ...
    Param(
        ...
        [Parameter(Mandatory=$true,ParameterSetName='Set1',ValueFromPipelineByPropertyName=$true,HelpMessage="PlatformID of target platform to be enabled (for example: WinSeverLocal)")]
    ...
    Process{
        try{
            if($PSCmdlet.ParameterSetName -eq "InputParameters"){
                $KeyHash = @{
                    set1 = @{
                        AcceptableKeys = @("ActivatePlatformID")
                        MandatoryKeys = @("ActivatePlatformID")
                    }
                }
            ...
            Write-Verbose "FAILED TO ENABLE PLATFORM"
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUd/p3yIPWI39yRUGgptHwwRZs
# t8CggiTgMIIFbzCCBFegAwIBAgIQSPyTtGBVlI02p8mKidaUFjANBgkqhkiG9w0B
...
# CisGAQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFFlts9S7Hhrc68vt87azHrp7/T7b
# MA0GCSqGSIb3DQEBAQUABIICAAdNyMruOeVNRM9LIRi49cioFcwy4oebLZoSyx63
# TAoCWGMwt8y0Ozxtpp6U9kBSSsk/pB7OW8sCRUq/SmsIjfjbyrbHNCmPC733xdOi
# DE+APJmubbXyJONklIL6ePxh5dOlTfWXMwHyJaJXjq6eKnJeD1QW+kTbaFc3Mvyp
# SmILT+whQ69zwGYdJflL5KJMdUVZd3XiyCIA2cN10ZH7AdoI2TodoSxP4F06G7be
# DUmTvXZtEhPPW2EiX0LwZDOMb9q/8/jdb/xIPnmh69JCoDq59a+v7fVCDczUFiTQ
# cUKac3bn5ZhCnh9dPc55h1hECu+gDlrMvFGnpU3SCd5flPQErs2FkoW1u4rKP0bu
# 60KHYh9Cjzty2yyYBP+NMDuIND5Y+25KxDHMCZmGEwDnin40llH6kA8cSPhG9mMm
# UWzD+BJH/jGCJTVknBAe4ubfwth07yz1WXEj7Rbu7s6TTQEn7U7wBeCAAt/047Q4
# WAeogdHD4JfrjDce6Cv5Z4ELMk3tLjSIPpYDtF7sliIUSzGCOGLJsWULTThoR6LH
# wdZ9yij+vfKG6N9fnTipwRVPD8hfWSAjnhn+1rik+ClUjeOgcmq0lf+jJN6miRar
# 1N8K+5WtYio6fEYeLXDwIChv+MBSRxjKKZOBqWnG9Cld4HaOOk1ykygiJwTmut1g
# NkJmoYIDIzCCAx8GCSqGSIb3DQEJBjGCAxAwggMMAgEBMGowVTELMAkGA1UEBhMC
...
# 9w0BCQUxDxcNMjYwMjA0MDQ0NDMyWjA/BgkqhkiG9w0BCQQxMgQwuxkah1g8A8z4
# ataICu+xRUe8gLP5P16eSCufaV0benJrUTXAKe+LRbO516f/LCXiMA0GCSqGSIb3
# DQEBAQUABIICAMUadPt1ubnFmhgf2/BXI7RklB8ohoYNcXYxzW0oGLf6sKk2Ouq0
# 5Zd/Z2LCURwLgQoH4BZmVnz2/tN0468NPSZ3CpdMbMLlQu3xYeTtAeusWBySc2KW
# tqe6Miyhpa2DmzsoPBPWgPgtb3Y/khkj+mXoQxy7K2cgUMKBQVdC6v0TUQzgsX5U
# ZiZLGEvFWGVBVVQzlS7PeIA+IeEiIlqM4X7VBGuG2zCqxgsZbsxCfO7LtSAgM/CI
# AddTzBOTxnxwY0JwNDA+AbJXlWMZHDWD6usgptcbCERQZ00dLEXUtG2R1TPwxD9H
# yM7GBd865VrG+duXyMUbh0FqU347FNmXc6yO78qXR80IdcMxwxmISAMF0A57wVao
# 6bFBYiMLeTR7/xFZki1MPKnfFww4MDCnFJ/qdmH2t2AHlt5hGbiH5PpcjNlldJHX
# CsyvqKI5gRV8v+0vlUiglbLuL8uvdzMGKTqaiWA2oxSTywQ+OlRHA9GkX0OB11Vz
# 2h2+KYk5ONxAoFFfF7VZOByg0SLQbLvHrmkMjx7g0QkgwwLLUviek7snRvmu72ha
# StL/Ao87BdTQOXZ9beyuNRQHcAt5IdjW6qEHrBI64gChvEDIWF10JOoR/lG0EOOW
# j/LT3D6jFKBqU5tdwiFxY5bijZgGBaO1XPDCzAqvGKrR/jzOP/+TGwLe
