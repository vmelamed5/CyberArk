...
.DESCRIPTION
   Use this function to delete a strong account from SIA
.LINK
   https://vpasmodule.com/commands.html#Remove-VPASSIAStrongAccount
.NOTES
   Category: SIA
   Tag: Strong Accounts
   Since: v14.2.1
...
.EXAMPLE
   $DeleteStrongAccount = Remove-VPASSIAStrongAccount -StrongAccountID {STRONG ACCOUNT ID VALUE}
.EXAMPLE
   $DeleteStrongAccount = Remove-VPASSIAStrongAccount -StrongAccountName {STRONG ACCOUNT NAME VALUE}
.EXAMPLE
   $InputParameters = @{
   ...
   $DeleteStrongAccount = Remove-VPASSIAStrongAccount -InputParameters $InputParameters
.EXAMPLE
   $InputParameters = @{
...
.OUTPUTS
   ...
   $false if failed
#>
function Remove-VPASSIAStrongAccount{
        ...
        try{
            ...
            if($StrongAccountID -eq -1){
                ...
                if($WhatIf){
                    ...
                    $WhatIfInfo = Get-VPASSIAStrongAccountDetails -StrongAccountID $StrongAccountID -token $token
                    ...
                    Write-Verbose "SUCCESSFULLY DELETED SIA STRONG ACCOUNT: $StrongAccountID"
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUcpeSZoNAPLdSQo+p5YTglKy1
# UHOggiTgMIIFbzCCBFegAwIBAgIQSPyTtGBVlI02p8mKidaUFjANBgkqhkiG9w0B
...
# CisGAQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFFl31GHzrFdFpW+NLf8mGJNTpodQ
# MA0GCSqGSIb3DQEBAQUABIICALFi7lqWUpVkkTKFlZA69ZjkBmXtb3LTdouwWpgj
# r294mvPGOiT/deXJS3qIxVMKc2/cCfX64Q9ocNbqJBQTzL907tGXyJ8dRtbAvel8
# JYSHx9wN18Ztrz1d9hxZ0xLBN4AZU6rvK7Yp/7+o94MCmovvGcOglDBFbAG2XBZe
# nkYnJ/Q1U4J3Ea3TQd1JUpp0Z9oD9fArJc+Z6gvue57MHdxBudvRw/OjC7TZ/WP8
# Zd/sHLZEdDTTfUXoL2RcYkra0QADZNX8tlNOfq50a8CSmJiLsOPHQzYc5aYMKfxY
# zfrrOhYknZWK3UyLGFGRV2ryopQpGyK09fD42k26LpXwwoZQ0RTyQzNHXAjv9LJB
# lyIKyQH48SXqGv+6mvDPdVxoi1gZBoWW+/HAwzibN9f0duexleE86A+uexrX44Zb
# e5T1byzL0bFtIV9QqCZi6UW179Uc3tW7T987FdMb6EYJ4zP5tBKYCeXFYadSmjFV
# lrucYSSDe7TAf8B4pT+JCJM9iUEWcE3MQhGLm8eTJJb0zhh/ZG1KpjiPQT1Yj0Wu
# 7/wQ/MHwuHI2zZr8/qggTGCEybY2OBnndN2tVDxLy+WkznKWoJHGsETsmhEWkfFQ
# ML4TF5K5zSBzYEn2C2vOtS28+ksKnSaulPVNDCDK5cuSqTxCfL1jcVn2lQWOnpwm
# ydWZoYIDIzCCAx8GCSqGSIb3DQEJBjGCAxAwggMMAgEBMGowVTELMAkGA1UEBhMC
...
# 9w0BCQUxDxcNMjYwMjA0MDQ1NDAzWjA/BgkqhkiG9w0BCQQxMgQwugNvLk+RAlP9
# +oOSdqp+rTwlY82fz4heSDZwdXHpNOSOfwsshlgFIksho1qHlLP1MA0GCSqGSIb3
# DQEBAQUABIICAGX+5NWKt+vJOBngF5EglAJalsYh3/09XUlYOQJ72D1SDYvJmqQR
# VOyHf1IX3Ez97ThNhrOMue70sMql34iDqwJiLA4nPrD2BISCKraR0Uu5sv+M64tc
# TTbyI1p5lCUKI5MtxNy1+OBZRI/vtGQ4EablIf8OgenlF7/FxNrnhWYY5f64228S
# 4KZygU9vvUERI0GU5ZNZ4FwGDcxBO8ynSoSCobAHXlNDG53Z6m/ShrXUqrE/2Aj/
# UDDV1KU0/vwOCN9nxti194K0+7avZ+8ZEQO3eqWt/BsnjoQ8S+vdgJh0MY1xBKMM
# s2kN/dRjNsJ00EHwtsw/v4l0Jyex6zclKSjDPqY+fs9VrWptpAKsp4jcM72yIAr8
# JYlz9LVslEGCXRQMpp4PjkppBMt7jzzjE6qjCIb1ckOCSDEKz1pBoFVV+tE3Hf34
# fNEx3mR14FmU7N3VMjC1VlSHdgD06G1kV7U+8L1h5t7dJifz63AQsbaL/5AF+S30
# DYGnbMR/Lqsl7tp3pd0+cpzkem/G5SW6pGSm09efzkhTojZ1eyBP8ncr2/70Kujh
# SUhhrUetS8ts185BQyyLeo0PresWIz/Te3BuCu90X2avCZJ+q+6mqaWQZQD39PBR
# qk0bYrQNFGHhUn9L4/6yii4H2V1Ge9//q2OaQZVE5bSL5d4g+xJR8tWf
