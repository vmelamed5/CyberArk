<#
.Synopsis
   Import stored platform
   CREATED BY: Vadim Melamed, EMAIL: vpasmodule@gmail.com
.DESCRIPTION
   Use this function to import a stored platform with updated values to clear any platform conflicts from existing platforms
.LINK
   https://vpasmodule.com/commands.html#Import-VPASStoredPlatform
.NOTES
   Category: PAM
...
.PARAMETER PlatformName
   Unique name that will be assigned to the new imported stored platform
.PARAMETER PlatformID
   Unique ID that will be assigned to the new imported stored platform
.PARAMETER Description
   Brief explanantion of the target imported stored platform
.PARAMETER InputParameters
   HashTable of values containing the parameters required to make the API call
.EXAMPLE
   $ImportPlatformStatus = Import-VPASStoredPlatform -PlatformName {PLATFORM NAME VALUE} -PlatformID {PLATFORMID VALUE} -Description {DESCRIPTION VALUE}
.EXAMPLE
   $InputParameters = @{
   ...
   $ImportPlatformStatus = Import-VPASStoredPlatform -InputParameters $InputParameters
.OUTPUTS
   {
      "PlatformId": "WinLocalVman"
      "PlatformName": "WinLocalVman"
   }
   ---
   $false if failed
#>
function Import-VPASStoredPlatform{
    [OutputType([bool],'System.Object')]
    [CmdletBinding(DefaultParameterSetName='Set1')]
    Param(

        [Parameter(Mandatory=$true,ParameterSetName='Set1',ValueFromPipelineByPropertyName=$true,HelpMessage="Enter target PlatformID to overwrite (for example: WinServerLocal)")]
        [String]$PlatformName,
    ...
    Process{
        try{
            if($PSCmdlet.ParameterSetName -eq "InputParameters"){
                $KeyHash = @{
                    set1 = @{
                        AcceptableKeys = @("PlatformName","PlatformID","Description")
            ...
            Write-Verbose "FAILED TO IMPORT STORED PLATFORM"
        ...
        try{
            ...
            Write-Verbose "SUCCESSFULLY IMPORTED STORED PLATFORM $PlatformName"
            Write-Verbose "RETURNING PLATFORM NAME AND ID"
            return $response
        }catch{
            $log = Write-VPASTextRecorder -inputval $_ -token $token -LogType ERROR
            $log = Write-VPASTextRecorder -inputval "REST API COMMAND RETURNED: FALSE" -token $token -LogType MISC
            Write-Verbose "UNABLE TO IMPORT STORED PLATED $PlatformName"
            Write-VPASOutput -str $_ -type E
            return $false
        }
    }
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUgjBNeNahS838DqQMX9MsmRkf
# Q7WggiTgMIIFbzCCBFegAwIBAgIQSPyTtGBVlI02p8mKidaUFjANBgkqhkiG9w0B
...
# CisGAQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFAiyIpuWfA44UVJ2efhh2dLNnu7+
# MA0GCSqGSIb3DQEBAQUABIICAAQsLLf2RuGM5oyx8SnSAcvQNXLLHhdTzHnZ/6PW
# 4IonbfVh8zwSrNkZCAaXBh+/21LNMCwy0dvWH95t9MgJnXsr2pjVNQAoNKDzvDc6
# zaZnhxS/vG4z+1XW5xmkGFbml6xy9Bo7G+c+9U3pL6vFHriwezm/NitOI0P3exyB
# 51k9jGAqunAT87bjJBw/El1dRUX99hKhMb7k4Sgv8G01S6uxrMKK7DXFmChJKTeR
# zyU5RRTYFoLJA4cFw2B2UN2WQmlga+Frx/eL5jbrL9vBwp9+++/xDgCqZHS2xD3k
# wBM4VupxKM7DptGYBWmcwVgFDrHnFkT6N9S0/xRDFy0nIP1PbhoxUVbMeU4BQH7N
# tDDjy7e9OugkCfE+oBuEv4miKic+SlYVp/XgQpOJW5M0l85AJpAvtrBwLntcT6w9
# g47S6llCniT//qqWv8au3fJDYA1S399IWlJTAOklebxa6o2jtxfnuwO7a0luD+nt
# 7lJJOU4gTj94vDa8px9Lu0T4wmUgdIseby6yjgt/YhBOX/pRG2QRincXh/9EuCqp
# sdK+0flZrsur6PPj0PWJER0PUUzsOVN7xXDAVLMZDE9QX8+cxg6P5G7cOifGC6UB
# JhZawYLAj6eMHjSvjQ9OfOZ3Nc9APMwWh8JvdVFsmjfuiP8ciSPOcANQ5O1/SUDA
# cgjWoYIDIzCCAx8GCSqGSIb3DQEJBjGCAxAwggMMAgEBMGowVTELMAkGA1UEBhMC
...
# 9w0BCQUxDxcNMjYwMjA0MDQ1MTM2WjA/BgkqhkiG9w0BCQQxMgQwt+4icl7TJSvY
# DuVjRLBnbFM7pACdvfHddZniiIUAwgYqKu5wHjkOnoEhUpUdU7AIMA0GCSqGSIb3
# DQEBAQUABIICAB9H2VMW9w7jeuJ6WAuryZpDZf562aC1CL/WyG4lXjkn8iFh0Ykt
# Mh4DvlCb111xstI6WlA2QtQtaNHL258vxjxssIwKAk2Z0y9Z5uJXivoZvN/AbexY
# 8k+BnNDthTVfDbex9L9qZrWFMIego2aEPPkwerS/ZpCWNt3UC8M1K+8yXn6NH2lP
# OKzzJit4jv1LCvn16HT1sBTzeer1UhmalCaxuAZY01wE0CsvdTMInjilYGv0ksyF
# WXAFIG1VOC2fqcJ/B18Z+26mGqcRRUCmVAsygImeU6/xaO6snt+fPv2g0ForcUhC
# lpNzTuVYtpUqp2/QnULM/wGIXRrYtv3yfiLWnsKDArv0MLNB33YC2fZJU7/H09qS
# K02pd2DRth2fdxrbMv/yTnoojr29OLpNHb6co3OMhUHM40SSIC12QVE9BFA5kgyx
# cNnpA9rBPeE9w2WEJ2d2ahaqmzTXG1EOuGHwUem8lSIdqvkyeIfHveGUzdKvHNwc
# 2nWZkDTkr5QPi0U31ywrC83JgsFaEsUKJ+duDmq73svn0/zwUBSmLBJX9sDqctY9
# dAfLyZFAgrpykWwvMzeuOWcn8HJBn7WInz9FYDfpzfM1wZ4lrC1fBX0XYc9SgHtQ
# b1/aBLzf4T1dDtttqm33CLFUweLO3BIiZ5JyG0hjO7OYfAYONJu/YNTE
