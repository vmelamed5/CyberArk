...
.LINK
   https://vpasmodule.com/commands.html#Invoke-VPASCredentialProvider
.NOTES
   Category: PAM
   Tag: Applications
   Since: v14.2.1
...
function Invoke-VPASCredentialProvider{
    ...
    Process{
        try{
            ...
            Write-Verbose "$SDKLocation GetPassword /p AppDescs.AppID=$ApplicationID /p Reason=`"$Reason`" /p Query=`"Safe=$Safe;Folder=$Folder;Object=$ObjectName`" /o Password,passprops.UserName,passprops.Address,passprops.Safe,passprops.Object,passprops.PolicyID`" /d `"VpasModuleDelimiter`""
            $AllDetails = & $SDKLocation GetPassword /p AppDescs.AppID=$ApplicationID /p Reason="$Reason" /p Query="Safe=$Safe;Folder=$Folder;Object=$ObjectName" /o Password,passprops.UserName,passprops.Address,passprops.Safe,passprops.Object,passprops.PolicyID /d "VpasModuleDelimiter"
            Write-Verbose "PARSING DATA"

            $AllDetailsSplit = $AllDetails -split "VpasModuleDelimiter"
            $outputobj = @{
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUrAmuCf2VytCr1u3aymoN2V/m
# NeGggiTgMIIFbzCCBFegAwIBAgIQSPyTtGBVlI02p8mKidaUFjANBgkqhkiG9w0B
...
# CisGAQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFPPxEAfZ4hlNMIropgjYfcN+G5R3
# MA0GCSqGSIb3DQEBAQUABIICAIh72FwPSY/KMNskSO9xeV2tw4JaXIF9e1Q7hzlC
# 7PfpifyQlBcDsF+Ck13+/HaW8RYgvKHqCA0LaI08Q+CEuZU6AQdgjNtoFnRItZ1h
# jY2AyJaM+pQgqr9ie/g7WflMKOx6swNjdVdv7j/pw4jqx/0efCfsBL7MfRXmqgi6
# GkRpCTZIBUGQbzhU8xAezCFW0PVNVuzQJPP4YUfKYgYViccSjuR2O9w1ePQufcwr
# MhrQ5ZWJ7oxcN+NPAqtmtELSnFam7JIy+VPPbeZlblrKD8MKdRA9/2DPRPdIDudb
# E4y3Qseiw6fos9YvPWXS0W24EhtEkx1Bkc3Y67b+P/1A/UT9lkQA0MmyFvHe+Bg5
# M0J40FrwcL9pL+Pr3GOS7iUEc6LEGDGXjEKdu4WtabyRWtDWqYoyGvXoeJ4i2ZBG
# 9zTqEDtpcpP3Scbt3Pt3s1lXvBpp6ZAWuvRTvJMublne66YuPXm/NRgGBO0TzHNc
# HP7evMrY26UAAW1CIVvVbWsJP+0apPoXhMUSlstoUPbMI6WsGdwzb/CP2AtKjZix
# WYc6PbjB9xKXbnmeJ4gYXQHnaijnoxhkphZgVnNsNJ/au5O3gm03bXVAwCtGY+MP
# WFP9cdR+6K/oFjXpD74Lgoz7qXNoCeaL41eO0Do9n6OZAwp3RKqxtNKtbSptjNIB
# doGGoYIDIzCCAx8GCSqGSIb3DQEJBjGCAxAwggMMAgEBMGowVTELMAkGA1UEBhMC
...
# 9w0BCQUxDxcNMjYwMjA0MDQ1MTUxWjA/BgkqhkiG9w0BCQQxMgQwWfIpBIs/orOl
# udPjHMHIE3BDi6E1bW5LuV6Ce4a5ZX2HrYsVgvxPyXXxWIDb9sFMMA0GCSqGSIb3
# DQEBAQUABIICAENI7s8ch2CbI3TmAr11SioGh7mebuSdA5kipdd0SQIVYvl0neN6
# NIxmQTTBVUp1wh2TD+a3UCr6o5HHpGpGrtAhm0OHr6coq7EYcAhnpwSROCiverbk
# vset+COWDl7stPpHmnpksThvtrX4alpCT/c9q3A2712UVSesATg5eI2z0wjXXZ/b
# sBggSjdbpBDGfyz8cGe6BSjeB2EBpLf5+JgR7ov0KdFNFWLzYw82nSj0lBSAQ9IA
# Pu8el4qW4ZDTITSCcX30pP8zDzwC9uxBKt77gig7XVDy/aghP+7ixi+nKmCPv8fq
# wQs2VZHY6XjqYg93Qre9ylPbVt1hIYPy9nMrL8XGLDyEVmIeSCn88IzUUdA3SIv9
# q19esoZWtUUo1rZ0qtbPXgBCiiS1Oh1TZjuKdnF4U5cy8Ji0L7Xb4HS/9hDTZEip
# eJheF1fasGUqQDVzIMMGVEqlI7Ib+GFniBjGWH0iCNXzvNuQb8mbCRf+4X3ArBiX
# G+LTCUrBUdutGh7z7otJGE0bwcUid/kGSOylm2nladV5UspV3CcE0wt69qd/H7kN
# Sos3gdf2TKWaS7jIY+WuHcafzcrQSYI35ar3qD4rRInfTXHKNecVTbpszl07iw45
# kZUF9fxdrUVD826AV3067xaWOgLRlLtPzq9Zmi2Ew3kHmh3anShvoef3
