...
.DESCRIPTION
   Use this function to delete all discovered accounts from the pending account list
.LINK
   https://vpasmodule.com/commands.html#Remove-VPASAllDiscoveredAccounts
.NOTES
   Category: PAM
    ...
    process{
        ...
        try{
            if(!$ISPSS -and ($PVWA -notmatch ".privilegecloud.cyberark.")){
                ...
                if($NoSSL){
                    Write-Verbose "NO SSL ENABLED, USING HTTP INSTEAD OF HTTPS"
                    $uri = "http://$PVWA/api/discovered-accounts/clear"
                }
                else{
                    Write-Verbose "SSL ENABLED BY DEFAULT, USING HTTPS"
                    $uri = "https://$PVWA/api/discovered-accounts/clear"
                }
                $log = Write-VPASTextRecorder -inputval $uri -token $token -LogType URI
                $log = Write-VPASTextRecorder -inputval "DELETE" -token $token -LogType METHOD
                ...
                elseif($WhatIf){
                    ...
                    Write-Verbose "INITIATING COMMAND SIMULATION"
                    $WhatIfInfo = Get-VPASAllDiscoveredAccounts
                    $WhatIfInfoCount = $WhatIfInfo.Count
                    ...
                    foreach($WhatIfRec in $WhatIfInfo.value){
                        $WhatIfRecID = $WhatIfRec.id
                        $WhatIfRecName = $WhatIfRec.identifiers.username
                        $WhatIfRecAddr = $WhatIfRec.identifiers.address
                        if(!$HideWhatIfOutput){
                            Write-VPASOutput -str "$WhatIfRecID : $WhatIfRecName@$WhatIfRecAddr" -type S
                        }
                        $WhatIfTempHash = @{
                            DiscoveredAccountID = $WhatIfRecID
                            Username = $WhatIfRecName
                            Address = $WhatIfRecAddr
                        }
                        $WhatIfArr += $WhatIfTempHash
                    }
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUZL8BGE1IN8Ydy59aKA/hm97F
# RASggiTgMIIFbzCCBFegAwIBAgIQSPyTtGBVlI02p8mKidaUFjANBgkqhkiG9w0B
...
# CisGAQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFFXyqG3kix7iFxgkZIZ09NGCruLv
# MA0GCSqGSIb3DQEBAQUABIICADo+X4bLUBNDRhb+/ymFfIWoU0KtaEVmml6op3vZ
# Un/QvSFkwOj2e19fwQxFsre1D2NCCZ+hx2dry4gUKjtKddksKeVdOejUaUXhuHf4
# 9O9CfyhHCuN1EaYUPHjhmHNKd1yuvxwWJJcjEu/BmqlJw+fz4XxRDVMzA1faUaU+
# m9osnN6fWdEPzz+EkEToXPqNL3fmyWb5uSKov7cVPA9/PVu4aDI0FCuSKPqWKXVG
# TrzFUQmH/obvC4tZV5lTuF6uFXvLp8kq2Glp2gxClVlMMUwMxjbzZVx6FoeYJhHQ
# FMT3atLOwVNkDbLZl+30MN9QpFGBKskwGYHe5666Lqr8enjHpIe4H03NJGKHGL+P
# ObiufVk3p/jWRNf6/zr9T5M3QWPCVVgXvsxvh+Dtjv7wMtTLmrE7u7evEUcTSabi
# YAaQPrcL89l3hKo87GfyniutkRl7kRV8OkpiE1+Nt2kPg76J9WUcha+Bx4h61Nc7
# MR43vs0emj+hCz9GDH5GMN6RL/2tBEQQnPifBbgV7HBMNM/W0rXmvCVjjix9lSXQ
# KJZKmz5xSDIYK7M322Zei+SmQz5bSrFSfzZSLIP6q8pzF2E3DjknCOPgzTmPyutj
# QWLwmetw4qOxSrlzTvvXYjXdTIvTWvB1ISfNyR+JlfSZ+4FP7F64hZH5EoIKTKkp
# UvL/oYIDIzCCAx8GCSqGSIb3DQEJBjGCAxAwggMMAgEBMGowVTELMAkGA1UEBhMC
...
# 9w0BCQUxDxcNMjYwMjA0MDQ1MjUxWjA/BgkqhkiG9w0BCQQxMgQwS2d3GwXt+JMs
# l56kXFv9lObWQ89Kjv6L8TyY5yD5r8TISLphyKw4GIKPMJhcTALLMA0GCSqGSIb3
# DQEBAQUABIICAAveTB5x9pGK/XuiQJARYM59wMWWQri9+9zYT45NII/FobwOvBQ6
# 79QUV2zDTndI/rYaThvv6rK4uwAEvFUDrIXJIlQZH0jlDZA4Xknyl8yIl9dzEueR
# i20ZSkeiAo204hOBOFsKGIMXLXU6ZtUaT2ySJ6Vs6Y/hxjH9hoOMEJa/sujyPUxv
# qXMpoFcB6fZWAcv9DxrwSCOzKMmUsykXAQtGxKCuhT3ED9OeHa9k7Yf8krqsWd2f
# XlIA4Vfg+GUHYcIlAVRu+yO7wE9y9R1HltCSpBkmh8xZq4mBJw55jbotwG/F0RG0
# ProW2RHbrGFPJI3sS/m9MUYfTnzTZx4dOXiE604fqwgZZBbUlQV1PY2+yrz6kp/F
# dlM4B58fKMoQffSMIVQQflFxABfh222D0p7W3kFSIs+JI9wAmhbKpC+Zj2EGdByU
# CU1J/TM8frqj0esgBcFrOmjd2Oip9Qcw7MQLlIqmipwsGDa97F3JVmBlDEdKkMFZ
# ohdldsoUJ6zUk65QM9nN5TJI6HJRxUFQuEuRBCvvLgDDT3bqzzGdMOQSJRiRduuq
# 6pyzmWlMjp5nUu9ud5NGqAHXN3LFjDzcSXJqc0WFa9Tn3FVLZRrOMQ7lsEz4GOwb
# qVeZu5mbjcYdrab9Ncfd4zA86eKju7ou87OIj5c+asDGQTXS9Swekcz1
