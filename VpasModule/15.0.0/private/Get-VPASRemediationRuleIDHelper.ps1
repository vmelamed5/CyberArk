<#
.Synopsis
   Get remediation rule ID
   CREATED BY: Vadim Melamed, EMAIL: vpasmodule@gmail.com
.DESCRIPTION
   Helper function to retrieve remediation rule IDs from CyberArk
#>
function Get-VPASRemediationRuleIDHelper{
    ...
    Process{
        try{
            ...
            if($counter -gt 1){
                ...
                Write-Verbose "MULTIPLE REMEDIATION RULES WERE RETURNED, ADD MORE SEARCH FIELDS TO NARROW RESULTS"
                $log = Write-VPASTextRecorder -inputval "MULTIPLE REMEDIATION RULES WERE RETURNED, ADD MORE SEARCH FIELDS TO NARROW RESULTS" -token $token -LogType MISC -Helper
            ...
            elseif($counter -eq 0){
                ...
                $log = Write-VPASTextRecorder -inputval "NO REMEDIATION RULES FOUND" -token $token -LogType MISC -Helper
                $log = Write-VPASTextRecorder -inputval "REST API COMMAND RETURNED: -2" -token $token -LogType MISC -Helper
                return -2
            }
            else{
                write-verbose "FOUND UNIQUE REMEDIATION RULE ID"
                Write-Verbose "RETURNING UNIQUE REMEDIATION RULE ID"
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUNJwgIhaAQqYtW0yCks3whjbY
# D0mggiTgMIIFbzCCBFegAwIBAgIQSPyTtGBVlI02p8mKidaUFjANBgkqhkiG9w0B
...
# CisGAQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFN8+U1OFw9xBcyQ469Y586/Ius7m
# MA0GCSqGSIb3DQEBAQUABIICAKvxnDDQVPdGzRPxTBU0K1pGNVCgQ5BKTv3t/xPr
# 4Hu59YHZg1zEjQinsQgkKFxAn6PvZxc0qHyZtDFm+V94/s1i2gfRARx/AKG4uder
# PJpje11YMdiYMz1Opkp42uEuVdnQMC/LomOStHS8zEAK5H+IfNDaYJIoa+7mR/2U
# y2+hZFn5gNpJjaVp7nAVUy6BmiYJ9COtpEdHmm8ekOUV0IKRcYQ0VdIuP4/kNn76
# bfXFuWnmAyLdJ36i+qemze4Zx80ITGzb2WMqG1JwgBW3jeSIfXiaNGizHjoKH9Ub
# gU2n3TTU1xNwILg5miV97hM6gWXMTsoTZxm0LjSH8TDPDeX1yXsLjXtgIQ3yCkkB
# SU2Zp3Zc4USR9lpRLh4/hmepkKzxMCwm9vUZgudj6b3I97FEiT1WvA0A7muxteyE
# rapQ9AqSpLGId743maGgsbqj45vgp4v57Oudf3X4INF2pG4HsCY8XL+3n/FVrT27
# RPFxbxdUqB8LCE3zW1mU4IrHvRCuS2DW+SDcqGVVCx8ehR/DeI2kS6V+vid3bRrG
# XPkLJKxYLxI8UFBo9r8QU9Li5tVMJLrvZdC8da6c8zsAmcOiPssbwRUjKwp9+cDd
# oswqcc/nRvXHtOxqDu+U7SLSrnnR49IDxrgKhkyv2MxLTcKsCrKMp9cki4MtBa+c
# NcQcoYIDIzCCAx8GCSqGSIb3DQEJBjGCAxAwggMMAgEBMGowVTELMAkGA1UEBhMC
...
# 9w0BCQUxDxcNMjYwMjA0MDQ0MTQ3WjA/BgkqhkiG9w0BCQQxMgQwRqFXlI1OYsY8
# 4x6vwNg+BwU0PCyMBMHzXtzZeXbTtlTVnMJtOY9UJie5PT79KwOpMA0GCSqGSIb3
# DQEBAQUABIICAJ6Zx43zEuu3wFl3F/LPp2fRdE0HAL3QMPHWMvrJt7WVaa03wFfa
# vqZAp4JNDZWqlGRaujYGGuW8YMWbgU4tb/he0lVAaP0GsUi/bLE+2jzlBNrmzjVu
# jRmswkJ+Fj78dV5oRBnpezQ0jIo0Sq7iijYZssvqt7ojBIx5wilaYv0WIbJa06m9
# GSJCaN6Pf5M1UOqvMTyd3WfmnAR9ls1olM6upBwqUtokqsPqZVUzhWaWmdXaLxLZ
# KDfhVc2NGePH5nrhOWGs2OOnp5PfqWp/M09XodZFPKJlYe8gMDp1sCD3y7RFY6hX
# ydVXofaxJVOZQ6hEYCykjG8dON6UQ8ZY20NZFpNJRG++ePB2jLIzBTRlfAbV3KNf
# Nu4Lo8QapjBY44Mqz+RtYQXt/SiZHSjUTUtZSGVJyZGIRzf3ZHy9VisPo78LSBUe
# PqRYblHBs0UxSCF1GbdC6bLi3hRKOQy6TCaSiKP0Z5oqSVU8I3HZ9FgiAtul487I
# A34HSH4k+dFLCeiRGTfHtyb7hd6QI6uwN9nqlVGxVbVny2+UlrW4QFcFB5aX6wa4
# ZTQWzqMkHI5J0f9CBcjonp31LRbydsaWvamyuFhheXECHWbh3ftYPUFgkwfvKUyC
# 14AkWoHxm+rVV+wA2yoP8D2QuEil5gCat99HcUjFwitiMK2tTJ8UDN6v
