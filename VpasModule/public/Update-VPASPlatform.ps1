...
.DESCRIPTION
   Use this function to update a platform
.LINK
   https://vpasmodule.com/commands.html#Update-VPASPlatform
.NOTES
   Category: PAM
   Tag: Platforms
   Since: v15.0.0
...
.EXAMPLE
   $UpdatePlatform = Update-VPASPlatform -PlatformID {PLATFORMID VALUE} -Field {FIELD VALUE} -FieldVal {FIELDVAL VALUE}
.EXAMPLE
   $InputParameters = @{
   ...
   $UpdatePlatform = Update-VPASPlatform -InputParameters $InputParameters
.OUTPUTS
   $true if successful
   ---
   $false if failed
#>
function Update-VPASPlatform{
    [OutputType([bool])]
    ...
    Param(
        ...
        [Parameter(Mandatory=$true,ParameterSetName='Set1',ValueFromPipelineByPropertyName=$true,HelpMessage="Target field that will be updated (for example: Name)")]
        [ValidateSet('name')]
        [String]$Field,

        [Parameter(Mandatory=$true,ParameterSetName='Set1',ValueFromPipelineByPropertyName=$true,HelpMessage="Updated value for the targeted field (for example: NewWinSeverLocal)")]
        [String]$FieldVal,
    ...
    Process{
        ...
        try{
            ...
            if($platID -eq -1){
                ...
                Write-Verbose "FOUND PLATFORMID: $PlatformID"
                ...
                if($Field -eq "name"){
                    ...
                    $log = Write-VPASTextRecorder -inputval "UNKNOWN FIELD TO UPDATE...REST API COMMAND RETURNED: FALSE" -token $token -LogType MISC
                    Write-Verbose "UNABLE TO UPDATE $PlatformID"
                    Write-VPASOutput -str "UNKNOWN FIELD TO UPDATE: $Field" -type E
                    return $false
                }
                ...
                Write-Verbose "SUCCESSFULLY UPDATED $PlatformID"
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUqY/bNCMYcZvW+xmyzSgIDeBm
# OrSggiTgMIIFbzCCBFegAwIBAgIQSPyTtGBVlI02p8mKidaUFjANBgkqhkiG9w0B
...
# CisGAQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFD4aRqwx7uMllFxNKPlGhDsLWdEg
# MA0GCSqGSIb3DQEBAQUABIICAK2LgYTkFhsn10/NhtPwyckQMvFexbxV6HZmJ5iu
# /tJ49dEllUhZsDB7FeA1OWVsjth6dl1M8RwTwhzu6pjxdJCOBw7SmKjWk7ZYXRwQ
# 3yRXRIH2zgqRWiDM2aTf/I+fPr26o18pfM6eXGCsv7cbb04gxRsJ0+3Ge4w+2Mhl
# x6ov4664NwnZ/FkdYFQ+1o6/jYp4PWQ+WOWpxZUiTvd3+d7bw3aE70NT3YSt73Uo
# aVKfpPdvWAVV7HRyWc1VrbDjsYErOxZGQJdssedCMVZOyudIa49giaEhwOZ+EO2G
# 8txB/thA4RJjJ9Ge3uvbCuhF0b6q9sVfpX9H7FeJoE/ct7fUdyACz2DudzFL7FZL
# OwhexL95W6Rv7cGMYw+PZHysGrc5tJgjzAlZ3bv2S3a2jITnGW0W7HXtDEvExtqG
# 2pyov0mkPmokFCQSlaJ9U23vFkZOxXa3Rpntso0wM20emMKQqjZnb2CAzbeMvYw2
# veio7OG0UTjfJJpfjNNF/50VOyRyLCL0R+m4M67TrTwJszyi7rvrHc6AgPuaAFSB
# rfwOKv0kqRc9W8KiqfowKJW8EArM4BumJdb5wdp9KzjT1n8hlEsVa02yd+/6c5SS
# RfhyIrKqUhtTi/nArM3nKXsAL2adVhWqfAdQffW+5TBlMEWXuQaSuJ2bd4qWQiHy
# JfG4oYIDIzCCAx8GCSqGSIb3DQEJBjGCAxAwggMMAgEBMGowVTELMAkGA1UEBhMC
...
# 9w0BCQUxDxcNMjYwMjA0MDQ1NTMwWjA/BgkqhkiG9w0BCQQxMgQw082OEzHcBdST
# 8M7ZuwgHHiO4tMqhoJb2tFBbsKtvJVOaw/yLh6UivifvQ5wDE6YNMA0GCSqGSIb3
# DQEBAQUABIICAAYxkBYbieKV0Y79iidEWdQJ18JQUlLzMIqshNyuyKImTKa8ptHc
# Um9uXMNrkkupHLGG/moT218X822ILbXOAREuIZ0qUeUfcO1AN2VpmnbIh/tY/tKO
# 0MTrP3VhYMqcbd62duLzv8CKmeZRSTPP3uvjUBpiJwxB52j1MGJHznp0/3U9f2+r
# H5fq5J2xiRtTEpUt2bQx6Ftpw5k1BcPhleh4i0isrSDJ0CCZ5+zZGr2eV1PVEhBc
# CnhDMMhvckQ67rJYLxwRx7E5zAnD/DitoN6ZHgwwri+7/j/OuLX/6QsjcC92hRw5
# N9Za7r8muY2N0drBWhAqsjYP4e1ZNMz4Gosj4xT0kKrWWip2B18Eem8Dp+u8C5xW
# 1nvtFQ321UxiEB+53uSeSx/Fd4jKKtI1e1JbTdXkzORe/DDVcAoEqeChAgnjDdCk
# UgLBv1SJrErmHbMRKdoApuDqoEwNMkgGfgN2U+7QMiGEMsgmlqkzfKmU12ATvr3T
# WKu3S1XGKeggrGNPGFuor9sHZL/pCn4a/v+xvXLnqfqrKXe5siCawBxJHybXfY/u
# /SQagB0976pCtAOKkG9R4Ug6oPc/bgYT9byJtbnCPi0rzsAU6xllCgqxLCrDKd7Q
# x/BcPBe6A6L6zgUPZOzs/CAd/ZKLfdY49okaep/YJh/1NTgLpf28bb0j
