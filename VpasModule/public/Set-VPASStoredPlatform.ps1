<#
.Synopsis
   Overwrite platform with stored platform
   CREATED BY: Vadim Melamed, EMAIL: vpasmodule@gmail.com
.DESCRIPTION
   Use this function to overwrite a platform with a stored platform previously imported
.LINK
   https://vpasmodule.com/commands.html#Set-VPASStoredPlatform
.NOTES
   Category: PAM
...
.PARAMETER OverwritePlatformID
   Unique PlatformID to overwrite with a stored platform if exists
.PARAMETER InputParameters
   HashTable of values containing the parameters required to make the API call
.EXAMPLE
   $OverwritePlatformStatus = Set-VPASStoredPlatform -OverwritePlatformID {OVERWRITE PLATFORMID VALUE}
.EXAMPLE
   $InputParameters = @{
        OverwritePlatformID = "OverwritePlatformID"
   }
   $OverwritePlatformStatus = Set-VPASStoredPlatform -InputParameters $InputParameters
.OUTPUTS
   {
   ...
   $false if failed
#>
function Set-VPASStoredPlatform{
    ...
    Process{
        try{
            if($PSCmdlet.ParameterSetName -eq "InputParameters"){
                $KeyHash = @{
                    set1 = @{
                        AcceptableKeys = @("OverwritePlatformID")
                        MandatoryKeys = @("OverwritePlatformID")
                    }
                }
            ...
            Write-Verbose "FAILED TO OVERWRITE PLATFORM"
        ...
        try{
            ...
            if($NoSSL){
                ...
                $uri = "http://$PVWA/PasswordVault/API/Platforms/$OverwritePlatformID/Update"
            }
            else{
                Write-Verbose "SSL ENABLED BY DEFAULT, USING HTTPS"
                $uri = "https://$PVWA/PasswordVault/API/Platforms/$OverwritePlatformID/Update"
            }
            ...
            Write-Verbose "SUCCESSFULLY OVERWROTE $OverwritePlatformID"
            Write-Verbose "RETURNING PLATFORM ID"
            return $response
        }catch{
            $log = Write-VPASTextRecorder -inputval $_ -token $token -LogType ERROR
            $log = Write-VPASTextRecorder -inputval "REST API COMMAND RETURNED: FALSE" -token $token -LogType MISC
            Write-Verbose "UNABLE TO OVERWRITE $OverwritePlatformID"
            Write-VPASOutput -str $_ -type E
            return $false
        }
    }
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQU++CSC10j2DHuk6dCP7Ikejg8
# M1eggiTgMIIFbzCCBFegAwIBAgIQSPyTtGBVlI02p8mKidaUFjANBgkqhkiG9w0B
...
# CisGAQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFAeLb1C+1SHn7X5MfQKeRpKeIkNO
# MA0GCSqGSIb3DQEBAQUABIICAH2ZvBKnbbtDYiGUUqsvlub2CzpCvdKIW7HnVk+Z
# y5HDDFkvXB3d6GpWQwTuPSZ05gG7vKsA/Cpn8qc2N68jnmP4TS64dsjSuYn1Kj2p
# B1NVh7E3ppUZE0rb202Fn0J9YsmuBNMdWA2k1ovg0SvWXrbeHZPCHLb3ZMuvVhjA
# O6bREs0ypx8QkJLsuNymLZ1WuxU/vzGcbl6LupenYH45/rfWBHZLKrDiD7I1dn5n
# +Q9U0tozfoMVWB18WADD03E8Y7hyyb7QUiWsfqxb3KoIkb9UIPeIOG/43zBpGyOa
# fS1f9ruRJgd5wlsYIsUmO6+YKrXPRhPbDSVjAE3OUsDOWYCol/Z9yfqTu9zwVWQq
# spKmCIUt+CAN8BzyegfDf2H6i5u8D44jn7IswzJ7QY2BPDDjnuSg+7+7TLvwAnD8
# yS0wtNj5NZ/LBfQWeOEgd6Jgn4dxoWccvqoSSVnmxl6mZAB14mSAAEfhXfpH/QDG
# S1FXc/1RxAAidILlpMEr0hPQ/xQG+FKJZDzVx3kD0BnnMFImaMTtTFnm52tVIcmq
# y5TGCCAi93XbK9SQxN7QQSt/axPzlAKrgDXX2HJo/cjUxvG6JfshQGRbaWSdlKPU
# 6RANiimtQBgxq2poZ8IKi9J1RAwBWjikVi0kbFiLDQtMQwjZAiYLXwZ4FxvxffUS
# xG42oYIDIzCCAx8GCSqGSIb3DQEJBjGCAxAwggMMAgEBMGowVTELMAkGA1UEBhMC
...
# 9w0BCQUxDxcNMjYwMjA0MDQ1NDQyWjA/BgkqhkiG9w0BCQQxMgQwwANxXmx4qZiT
# aSSHnR7uldtO7RJ3n8BNjVBxbacpCX6qAXJM/IfmQFD7Ed34Xvx5MA0GCSqGSIb3
# DQEBAQUABIICAL9vg+uZ01w+73c2f1crOlac297Q4jvQ5UBThw5w9wY9xRJDB/2V
# fY1abv7Y0U61+UjUOMPiuo7Z91EAc9eqk/s/yE5IPjyFwY8r9o5mVNd7JrR4RzIi
# Sc7+TPWFMdj/Hv60sx+nrt3m9pDKNV0EsNevOKLiibg8aQw6c8y7IE6fUb2X8L20
# vKVVyh5LzoW4BC/5BvwzIDxscj83KVl6g9nDIQjd4bmHrGcniRWPIR692NE8Jzpc
# NdW75lophnhpJcfvUrmNH6+CjJ7agqJdzCQIv7qdFlxyB6kldq69SF12NG/KTz6F
# q3zmqXvrqnQM1qa+7ytEH+L6LhbJ9DL9ZHYc76rBedHVk6qKaXM4g61CkmxBNfBE
# EqoK71+JwTabh04GwMKrBkJaz0Gx5n2CV1aA/gUwFWYLf63hCweoMFfTuJeai8ji
# B4sllrXDxSgZ1n8MN2XXIfXrggQTgwFmGRuWzEY+T/pgWGKIFgF+KQP2iXE095bb
# nKcgt9LT1rafuCWYsQ6RHEbmNArRi0B2Lj3tMXDPHvCiBwpMbibj2aX+3P8Wdje5
# FBk0fmmrGtFJDyA4o29Jekx4mQ0pt3P9OG+QUQPeKDFhsfj4tD42Tzwue93/ct7H
# rjiSe6rCngfJx2mGJ3YbiDVCm75bIMs15UaQiKTGp3MKeQzH3KpCy+vw
