<#
.Synopsis
   Get stored platform details
   CREATED BY: Vadim Melamed, EMAIL: vpasmodule@gmail.com
.DESCRIPTION
   Use this function to get details about a temporarily stored platform
.LINK
   https://vpasmodule.com/commands.html#Get-VPASStoredPlatformDetails
.NOTES
   Category: PAM
...
.EXAMPLE
   $StoredPlatformDetailsJSON = Get-VPASStoredPlatformDetails
.EXAMPLE
   $InputParameters = @{
        ExportToCSV = $true|$false
        CSVDirectory = "C:\Temp"
   }
   $StoredPlatformDetailsJSON = Get-VPASStoredPlatformDetails -InputParameters $InputParameters
.OUTPUTS
   If successful:
   {
        "StoredPlatformDetails":  {
                                      "Id":  "VmanWebsite",
                                      "BaseId":  "GenericWebApp",
                                      "Name":  "VmanWebsite",
                                      "Version":  null
                                  },
        "ConflictedPlatformsDetails":  [
                                           {
                                               "Id":  "VmanWebsite",
                                               "BaseId":  "GenericWebApp",
                                               "Name":  "VmanWebsite",
   ...
   $false if failed
#>
function Get-VPASStoredPlatformDetails{
    ...
    Process{
        try{
            ...
            Write-Verbose "FAILED TO RETRIEVE STORED PLATFORM DETAILS"
        ...
        try{
            ...
            Write-Verbose "RETURNING STORED PLATFORM DETAILS"
            return $response
        }catch{
            $log = Write-VPASTextRecorder -inputval $_ -token $token -LogType ERROR
            $log = Write-VPASTextRecorder -inputval "REST API COMMAND RETURNED: FALSE" -token $token -LogType MISC
            Write-Verbose "UNABLE TO RETRIEVE STORED PLATFORM DETAILS"
            Write-VPASOutput -str $_ -type E
            return $false
        }
    }
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUPc5jj2bL8R1mJWn5w0LAAG9c
# Yy+ggiTgMIIFbzCCBFegAwIBAgIQSPyTtGBVlI02p8mKidaUFjANBgkqhkiG9w0B
...
# CisGAQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFIa4EkwQNQHYEAM8Y14CWyOJRkA7
# MA0GCSqGSIb3DQEBAQUABIICAHCykcn8rp/r22BX/kFXXBirOKRE6EvlrsMxOxDS
# 2NMAxBHaORteqx+tw5bfhKEZDctVIkQRQLxdRT562A7CCSnOGuklORklNVSkNV+P
# 6r4MI2qMQpXVLDXAwphCdmtvdcODG90on3DXXKvbHVNQMCAMRjbDY8+S0JwR2ytH
# l1K8Z5wOhp/Li8ec5kFzTWruSvXlrN9nBAndNzBkKIL1NGPek0+wieRBpenCU8++
# irKWJZ+25HhO387x/Sq/yTMNnBxPLGPEMnn4J7ooN3W74gUw9iqE/N7kfNmGmXUS
# lIbjFGTe9YmF79CmlfDTlJh8FdrsDdJ3cSJWC/0yNDliRkSMbnuO3qJFG6kXv0X2
# vGNCxA41KiD6s1nMHLSFHWl2xq0vqCw2MCmcLB8GMZ5PyvK/shkCPmjRT8CVvATH
# lzep9SiDLvP22Dmc/zMtQXMfP7ImGg0L+66EStM2MEeLetsJIsKkmm/0N0GJQzg2
# X9Yg/14UwJdfPFmxuaUgAZXpwn/7g3z5jORl9/KEvLb/g1tERi1wLqkozcYYkYZu
# EAuoPmeJGmc/0R6UUkJMm6GNJUC1BssGyrxKDRRlC6icKw4kPm8D/6T7i96RHSFB
# WDtfOVet9riO/YdYmJ5+chfjpKAi+qey0YQ5GlPqyQF1Xw847RVGcxilDD965+vu
# qCwmoYIDIzCCAx8GCSqGSIb3DQEJBjGCAxAwggMMAgEBMGowVTELMAkGA1UEBhMC
...
# 9w0BCQUxDxcNMjYwMjA0MDQ1MTA5WjA/BgkqhkiG9w0BCQQxMgQwdrxxlZIssAPv
# aMg9TBQYoX/iJ5HrxHpXO8k5J6ZR4jiLMSnvw+nxRUnmuCJY5i2lMA0GCSqGSIb3
# DQEBAQUABIICAMRGCe6AALLxO0HuXi+C9FZDJYdzpOVw8YxIYL1SAK8FbCtLLBNJ
# V/xwxSt7vsNlIk8jGnu0ve+HpR//K644+WBaePq1sRV+j2fSsOYsCoSBqrAMTxZp
# hbldN5ZaB0wl/RPDXQiAyTWyAAbgrQxMRBHQeWTXzwEv/YIiGeVnNVBs186fbZez
# rojxNYaLWPBnb2dVnHnwJnhPEiiXm3p1qcN0AqA2Ib+lIh2jzZEggMV6FXLsQ18D
# +AGArQimu6DORyciU/JzPPkPJzCnPCa64FlPEFFex+jgO5obmEVbL54yfmj0x/Q/
# M1GhVhKF5iaX0Lf36zInp5vuPn6tiAvor08scoBOkfgzx0xp9QBjF+HHhaGCQwlZ
# QhfWwy7cKZTsyFZk3uuHEmPlczBl0luei5Cf77qI9Pa3HQn2gTtaO2huwaTnatNI
# 5ONThzDmL+cdDalNm34KoiPxczDcdr1P+fEHM4/Wns3g8qfWYwe1KoiC4CKpa3px
# ctEBjBt7l5qfXEkv03KeoZ6OOSniI8toD8XxLVMQOuFFxi3CGbCCxdiMcN6+Piml
# udK69K+6DUZTQ21688SOUApqKQxRKXuXEuhf0A5UpjYmTAbb2IhGrNnmtYp8nNgz
# lgyqYYOhFgDVqcXB82f35TFZDpay6CfMFIzSyeW4qvnkQgMc/NS62lDM
