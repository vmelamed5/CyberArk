<#
.Synopsis
   Get discovered account activities
   CREATED BY: Vadim Melamed, EMAIL: vpasmodule@gmail.com
.DESCRIPTION
   Use this function to retrieve the activity for a discovered account from the pending account list
.LINK
   https://vpasmodule.com/commands.html#Get-VPASDiscoveredAccountActivities
.NOTES
   Category: PAM
...
.EXAMPLE
   $DiscoveredAccountActivitiesJSON = Get-VPASDiscoveredAccountActivities -SearchQuery {SEARCHQUERY VALUE}
.EXAMPLE
   $DiscoveredAccountActivitiesJSON = Get-VPASDiscoveredAccountActivities -DiscoveredAccountID {DISCOVERED ACCOUNT ID VALUE}
.EXAMPLE
   $InputParameters = @{
   ...
   $DiscoveredAccountActivitiesJSON = Get-VPASDiscoveredAccountActivities -InputParameters $InputParameters
.EXAMPLE
   $InputParameters = @{
...
.OUTPUTS
   If successful:
   {
        "items":  [
                      {
                          "id":  "1234567-8901-abcd-efgh-ijklmnopqrst",
                          "creationTime":  "2025-11-26T07:21:18",
   ...
   $false if failed
#>
function Get-VPASDiscoveredAccountActivities{
        ...
        try{
            if(!$ISPSS -and ($PVWA -notmatch ".privilegecloud.cyberark.")){
                ...
                if($DiscoveredAccountID -eq -1){
                    $log = Write-VPASTextRecorder -inputval "COULD NOT FIND UNIQUE DISCOVERED ACCOUNT ENTRY, INCLUDE MORE SEARCH PARAMETERS" -token $token -LogType MISC
                    $log = Write-VPASTextRecorder -inputval "REST API COMMAND RETURNED: FALSE" -token $token -LogType MISC
                    Write-VPASOutput -str "COULD NOT FIND UNIQUE DISCOVERED ACCOUNT ENTRY, INCLUDE MORE SEARCH PARAMETERS" -type E
                ...
                elseif($DiscoveredAccountID -eq -2){
                    ...
                    if($NoSSL){
                        ...
                        $uri = "http://$PVWA/api/discovered-accounts/$DiscoveredAccountID/activities"
                    }
                    else{
                        Write-Verbose "SSL ENABLED BY DEFAULT, USING HTTPS"
                        $uri = "https://$PVWA/api/discovered-accounts/$DiscoveredAccountID/activities"
                    }
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUP/6epowLXolN7QvvN5JeqhSR
# lMyggiTgMIIFbzCCBFegAwIBAgIQSPyTtGBVlI02p8mKidaUFjANBgkqhkiG9w0B
...
# CisGAQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFHmhmdOT0n4NJfPCVrKhTAofNFJ1
# MA0GCSqGSIb3DQEBAQUABIICAIIuZUJSLX+M4HryM5vyWTvqey/82On9o8ZLlLLg
# 3avVMopc4ABfm8X3HfK4WXlkx9mE9Ybz6LkFGwHJyjkqoPtkFTIrfdRxBDMeSljZ
# 9tvqAs2ld6EhGupgvJES8nq+aXmI/aZDUZWmdeBci5YO43jPaiUQDF9zif67JfiH
# NMpaTIHZAAxGrtsdXnfHj5+MQv5L3bhc38juU0Y9waSr/qvhm5FaYCd1a0jwx0OV
# iIqljAL4tSziia6hy+D2DJc8JoF9dvr/N6f6RsqjyWrLanXYrrgf5QHUN3fukvfR
