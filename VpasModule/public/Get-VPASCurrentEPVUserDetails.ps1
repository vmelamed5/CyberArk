...
.DESCRIPTION
   Use this function to retrieve details of the current logged in user
.LINK
   https://vpasmodule.com/commands.html#Get-VPASCurrentEPVUserDetails
.NOTES
   Category: PAM
   Tag: EPV Users
   Since: v11.6.0
    ...
    Process{
        ...
        try{
            if($ISPSS){
                ...
                $tempparams = @{}
                if($ExportToCSV){
                    $tempparams += @{ ExportToCSV = $ExportToCSV }
                }
                if($CSVDirectory){
                    $tempparams += @{ CSVDirectory = $CSVDirectory }
                }
                $ISPSSReturn = Get-VPASIdentityCurrentUserDetails -token $token -InputParameters $tempparams
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQU8MEH2n/tV39X4QEje+Gr6XHO
# q/GggiTgMIIFbzCCBFegAwIBAgIQSPyTtGBVlI02p8mKidaUFjANBgkqhkiG9w0B
...
# CisGAQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFPE9nyT1nhoP9sCUcpwRwjoB2G9H
# MA0GCSqGSIb3DQEBAQUABIICAFdrCWg32t7TZB/IIHQhhF5IxPIMUfbovriC9M7x
# fAgs/snWfoOAtnbpLPYYOxWuy0AjacMWhIdcPnbQaE9rbCNaZazPP+xklBx3ILt9
# o5PTMOCzrZBUywOFSPD0ypsLksNmh7aRRkJRpKTI1IDK35VBgKTA+hBkeXPsDatp
# kYRHDriFzIjmc7W2Qp9d1ani3KdW/QsbtXe7N1L90GAxukwUBCm5cqp6X2RAtS5+
# dqWqIjcACAIbV5hipvUO6Co2UYLYqzD+KSZWGuGmBPjNnOnMB/fE6Pf1H28JoFji
# 11dmgjmjjCRgRfIrLtsjsM3w/HARwb7DPJMwGgVWGsFZH497xUruBtqYjPb3hFe3
# nM+y/ObMxLzxYiEM7EcNpZX4PXejGXbuITeiqVQ8sduZ31YxQO/DZ7ktqqUmeK47
# DkRxyOlt63VbaDyZC5FjYEi2Et2aqNbFeynywrX7Mw2y8Kf8PUMTe7BfCP67DFhf
# 9H8TveumPwHvkX9hWFIhCkhekXetWRcZ+1+90p2fDhS+MEbvMExy8QQCN1UW8ONG
# zbwWug+4mHckjr8IXeAl+aydlja5KREXC5bVTH7gEF+C+cCINxTOwAO70Wt7ZVNZ
# nghSk5o55eCIiGIIZbHUUc5Z9v0LXeGtR6CpcwIRrqj3bBfjHlizQzJqRLWqOwpP
# bTRaoYIDIzCCAx8GCSqGSIb3DQEJBjGCAxAwggMMAgEBMGowVTELMAkGA1UEBhMC
...
# 9w0BCQUxDxcNMjYwMjA0MDQ0NzM2WjA/BgkqhkiG9w0BCQQxMgQwlQHb8oX2zaH1
# ktXZeLgKjqsWnWDArvys5iyMMQJVoz8Yjl9e1V6CoOzd+I/mUrCpMA0GCSqGSIb3
# DQEBAQUABIICACJoFErHWK3/4MawZgYrT0E7WGHOFL2pnOTPvUStjG+Mu+NsnxNK
# m7wYDI8/s1libWhnflrsj1L5jNbCwqn1pp97RNAMKuTSfSoalCdnLMZGjTEgXPSx
# dDAF9K3VmQDzOrAa8Gndge1lUS1ensPnPcOlqCFx/X5hKI57fuXzTS1fn3/EOK9z
# p7MYgwnM8uI/VHwKKG1eaiMNi6MewF8h6TPJBqbVhDv/+HW/hGW35OUk6BkCb5Hy
# fLmkJiq5I8oehDbJiSQS4gGIhuEdoNod2zz+tVB7ujJU9NUCqEjdk49/94OXd97X
# 6Lex3IxisJkrnQeezjlngepPEeZpU+pzP/fPZYrAkpMth6cg+4SzvjaOAZ5+7S+/
# YHidKIhgVb78oohFrUECnD8Eg0MBtUfbA5Cgf8BJqLaLLsUNMaMdLnS7TTTfemE8
# Ta6ZXI9jZYgkc8OiXu2APZgPZteFeInyDXhlf4uGSJ4flBxVeC31teNWzXq9RNQS
# +GdTDVqfFF7lau2OzbW0HIzI7Tkqh/J896F6jrrfskyq+O/BuE/gLUCm6j1v3CqK
# /rxXfn/H3YR27rrVYGPjypo/cip1qG1sbbcDyZ3aKgOi8EJIuN2u8tmEwrLBfYbm
# LD6SMrslf4RkVDbT8vQrW3OSfqKrAepZfRu58OVWS452F/W+FnDVZssh
