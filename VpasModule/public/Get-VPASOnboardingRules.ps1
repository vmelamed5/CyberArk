...
.DESCRIPTION
   Use this function to get an onboarding rule's details based on a search query
.LINK
   https://vpasmodule.com/commands.html#Get-VPASOnboardingRules
.NOTES
   Category: PAM
...
.PARAMETER SearchQuery
   Search string that will be used to query for the target onboarding rule if no onboarding ruleID is passed
...
.EXAMPLE
   $OnboardingRulesJSON = Get-VPASOnboardingRules -SearchQuery {SEARCH QUERY VALUE}
.EXAMPLE
   $InputParameters = @{
   ...
   $OnboardingRulesJSON = Get-VPASOnboardingRules -InputParameters $InputParameters
.OUTPUTS
   If successful:
   {
        "AutomaticOnboardingRules":  [
                                         {
                                             "RuleId":  1,
                                             "RuleName":  "APITestRule",
                                             "RuleDescription":  "Rule created via apis to test api",
                                             "RulePrecedence":  3,
   ...
   $false if failed
#>
function Get-VPASOnboardingRules{
    [OutputType('System.Object',[bool])]
    [CmdletBinding(DefaultParameterSetName='Set1')]
    Param(
        [Parameter(Mandatory=$true,ParameterSetName='Set1',ValueFromPipelineByPropertyName=$true,HelpMessage="Searh string to find target onboarding rule (for example: TestRule01)")]
        [String]$SearchQuery,
    ...
    Process{
        try{
            ...
            Write-Verbose "FAILED TO RETRIEVE ONBOARDING RULES"
        ...
        try{
            ...
            $log = Write-VPASTextRecorder -inputval $output -token $token -LogType RETURNARRAY
            if($ExportToCSV){
            ...
            $log = Write-VPASTextRecorder -inputval $_ -token $token -LogType ERROR
            $log = Write-VPASTextRecorder -inputval "REST API COMMAND RETURNED: FALSE" -token $token -LogType MISC
            Write-Verbose "UNABLE TO RETRIEVE ONBOARDING RULES FROM CYBERARK"
            Write-VPASOutput -str $_ -type E
            return $false
        }
    }
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQU7XQDKn0WDCKaKd6sn7UVgE/F
# DniggiTgMIIFbzCCBFegAwIBAgIQSPyTtGBVlI02p8mKidaUFjANBgkqhkiG9w0B
...
# CisGAQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFB/1MOLjY2KqlA/X1zfqqEz9fnts
# MA0GCSqGSIb3DQEBAQUABIICAH4WQ1nByh+Hcp7ilJ3vDE6QR+cZ9b6941XyUFi1
# 6mWsy4E5qUfVDnXdFtmi1f3JDjPXw5c+WYou2VJrBVOe+XZLk4HoWygMgjyg7BYe
# mX5HQEjGAsZwKdJYWHyBRhvxBDWraHpHE4GhePaLFkza2FW5nQXVAuKqlCnab57z
# dDaCozpeUUwN9N+Zc92zqTzoqsW03dwmmdCi2TCDagPvuIPJAtVwgcRRXxkmgiNq
# fE9/SAKEJezPK8vX5lj+kvzZ8ks1y+N0GRrGHZTV6MV31pU3EoLSdPKaTJ/slJNe
# e4ns2JTgoVAk3uwbmHe79ZPRMQWSYJhaPhwZ7qhKHI5JYSYUqJK9ybTdOZDXHft2
# P0JVW8Zh/OXq99Ll83Y0aoWRKwclghMxZbmGWYim4oSnltGxpjPGCmbLs6TxAWub
# CrCXcLjktsIFMMRCwvHh8JH841fyWJAczz6KUVlUMLBjK/lre3bhHBdejwipyT/W
# NdMC0BiAowIBK99aiUnV1jhY1LnCTOU9TbecWhsQaVOJb5VWngvx5NHUC3rSY2oQ
# 0lrl6rDgaCnh7qf84JROk4b6FbAI+Km/fSNulffLsmH/CtdB0143vBwdfHNF1qmk
# 5/Q994xLTsbJxyejakisEB8fKkT5sBm52u1uJaSpprbLsmPmaH3YxPaykOe/LKQ0
# aEsuoYIDIzCCAx8GCSqGSIb3DQEJBjGCAxAwggMMAgEBMGowVTELMAkGA1UEBhMC
...
# 9w0BCQUxDxcNMjYwMjA0MDQ0OTI0WjA/BgkqhkiG9w0BCQQxMgQw2Zd7DgIEzDG/
# K8tgFnBqk7uUWC138AN8cOsy+4fgoj4D2946Pzf7IiNMcqfn3jCfMA0GCSqGSIb3
# DQEBAQUABIICAFU5Oo+YDelcbAaGc7k/6DejaoaXpxG8sI9Kr6JhFEJ3ri/t/EwQ
# ucw7psRzBiwbIleTeqPmdNrFaRM1fekFvUqwP6nFIP0wnTHwbbf+nUWmh2Rv30xE
# T8XrKMp97/gaiCUFS5AOuz+r4lFd58CT9N6+cOSSx7Uj4bCAfH2eP7GKR3BtBsNN
# 2zacTGk1R6KI5o/eJ3iphX5f7L4g6ylwoET6oy9J843Z7A/izQV4NUIw3JjghqJu
# osrSAo8fLtrtyb8WwHQ6QcEWfHsLK3M4+3OcCj1cube1F+TQw7JFFqypQM4DSy4r
# N1MnXIp2K38g3q+yjrTNmqKk47sYPqGZrroJr1zyoK1oJF8aCszH9UH1nD8DUsuM
# D2V4a1XYCZaC803Zh5/czYXVd6PpNAGALqFGdwZdi2LI4GPMhm8p4EVN6ANVu23c
# uHdZ7vJDcoEW+uzyWlm4dV7YytxB15oi5B8Pn5a7UciNxD0UjaKQ7IWGz5YOMb4b
# Vpg+z2ccL/5o+tkRs/V2O4LGFpYcKq4yc7EXtvlfwQN6OkUd7jqKrkVvx3s0ByhN
# +LtyTbEROK5deyTxJ2MyF+949QR14dVcPuryS+NAVGeE/dmvPJntojn7KFpPlqa7
# 4QD4fgDv51A/MYq2jaFm5bgZBlUK/9Yoh9GNf5vmmRDjmyZuY6MDOEXy
