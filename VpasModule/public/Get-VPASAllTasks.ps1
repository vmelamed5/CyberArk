...
.DESCRIPTION
   Use this function to retrieve all scheduled reports available to the current user
.LINK
   https://vpasmodule.com/commands.html#Get-VPASAllTasks
.NOTES
   Category: PAM
   Tag: Vault
   Since: v14.6.0
...
.EXAMPLE
   $AllTasksJSON = Get-VPASAllTasks
.EXAMPLE
   $InputParameters = @{
        ExportToCSV = $true|$false
        CSVDirectory = "C:\Temp"
   }
   $AllTasksJSON = Get-VPASAllTasks -InputParameters $InputParameters
.OUTPUTS
   If successful:
   {
        "tasks":  [
                      {
                          "id":  "949e1e86-65cf-4fe4-b55e-b58429bb2b97",
                          "folder":  "Root\29",
                          "type":  "Report",
                          "subType":  "InventoryReports.InventoryReportUI",
                          "name":  "Privileged Accounts Inventory",
                          "keepTaskDefinition":  true,
                          "schedule":  {
                                           "startTime":  "2025-08-04T04:00:00+00:00",
                                           "recurrence":  {
                                                              "type":  "Monthly",
                                                              "recurrenceValue":  6,
                                                              "daysOfWeek":  [
...
function Get-VPASAllTasks{
    ...
    Process{
        try{
            ...
            Write-Verbose "FAILED TO RETRIEVE TASKS"
        ...
        try{
            ...
            if($NoSSL){
                ...
                $uri = "http://$PVWA/PasswordVault/API/Tasks"
            }
            else{
                Write-Verbose "SSL ENABLED BY DEFAULT, USING HTTPS"
                $uri = "https://$PVWA/PasswordVault/API/Tasks"
            }
            ...
            $log = Write-VPASTextRecorder -inputval $_ -token $token -LogType ERROR
            $log = Write-VPASTextRecorder -inputval "REST API COMMAND RETURNED: FALSE" -token $token -LogType MISC
            Write-Verbose "UNABLE TO RETRIEVE TASKS FROM CYBERARK"
            Write-VPASOutput -str $_ -type E
            return $false
        }
    }
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUJ0AQljDdC+uhnM5WVaE6SziT
# xRaggiTgMIIFbzCCBFegAwIBAgIQSPyTtGBVlI02p8mKidaUFjANBgkqhkiG9w0B
...
# CisGAQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFO4VPYWoqXQBDN/PZCN1QQDFowbd
# MA0GCSqGSIb3DQEBAQUABIICAKyhMtGDPM1IT6YtERz201IgN9aoFyAKMVK/hDy6
# QhQiK9DNryoOvUkmUwAYBaD+QGXdY4Rjlc1qI3hq2lyPoQitbImiw0089K/im3LP
# +w+VugFAdYXzrRk64QEZXlWq+MVHi+yxlhLJQVMXhOscL8g5z+v2O3Tp3ZmuIEQD
# S3gdOselZ46iy0b5r0+T4JwhmbwpMJOO6jY1ke2W4Xe9xIUXJyzMvogQsVZW4j83
# bzHJbtLzcVjdNfiQDTy4R7LN+OyF0EZC4F8/n34dM623VnyRny0MVLoNAxpoQob7
# xU5XhrOSzrgOzK76RBXdOV99EGfCUA+lDbdfklTnH9ODQNzIUWvfy64DfUAbCVll
# WWWmOb9QcfnqOjOMohutJ9oin6xmvQK3NLlPTnaYjEt0J/dJXI4sH+JmlySdueSM
# gHlPU0rvF08D+SRhIOunMFUrpxRJ3/nxlas1215qBDsy7DYtr0s1aga1P2cr2dZ/
# nKfcSq+BDLBjWcusqGD/lcUiH065bFICfqyfZHY5Lda+BEEgJ3apCl7XxnCkzgT9
# Squur1s9xJR08OftXRuSDO6X5ebP0p64i6yFUoYgn/r1x+ioLRkOaRdC94PVkYQp
# PquaxqbENsD4T353n9LL7KkUtgXy8rqO/kCjFVgnUd2mvPdlaqPuzrWQmgoG1sFM
# DONKoYIDIzCCAx8GCSqGSIb3DQEJBjGCAxAwggMMAgEBMGowVTELMAkGA1UEBhMC
...
# 9w0BCQUxDxcNMjYwMjA0MDQ0NjQxWjA/BgkqhkiG9w0BCQQxMgQwwzbB/k646Y2y
# uSeWLZo0HRyEKf6UykRjpWCJ3Lcx6xv/Aped0hzwQfyInsutVPl2MA0GCSqGSIb3
# DQEBAQUABIICAA3es7dztFbGuxMsvgF3IzWcmh/HJsPCjB+tAgEWKvClE/l95b3W
# YaTZeitnYa6bHLOMNQQBDcDzIbiXhav/1jERrUal5F4eTnNHFwCt/4KB4xtjpl9f
# HG1v2y9g3QbFTF15pw3+cTM9aR2dCtOQPxkAlYWzH3orLnYRP/vsRIzq0ZiSijzi
# hbaqkc8VeZSR40SxipkLjOAleXyIm7PouAKW2xjXTx9ZojkL9b2lipTNU77vpDph
# pwX36n3Co02CwU42TH6gVuIKKeqS4Od5XAig8ogmRbdk5wsGAtpbw7sLsXKsJaU2
# oLXdRbdUuk8ctFbF1sudSZcee3FJndUtmtwXjn6Bln9DED5SllxTd1tQGlO4HAnQ
# SbAsPkfH5qENogwN3oVT9ZwcFJ51U4ocxa9zK5y7QRzveHuShpVORc7FxV6JBBAb
# RwLadgym74DhfVnxWOgq6R6XcBUCYAXAIbT7oQLdzcmLIeHyt6oVW96PEUHuPZlU
# Y8pD673Cu23yIfuD0fwgQAyGwQ+Li0rPGx4IwR4QVgv1NhWPB60OB280XLf3fNz4
# F0mpCh2C1zI+S1CDAcQcQer5RlFmiP48KXj5qifFdpj0dIY48VrLJOLM85exQYsg
# TFCc36py0X7Ei1QHrO5/icV1IZvbCDQQsSqO7c32oBIKe788UkS+xQhS
