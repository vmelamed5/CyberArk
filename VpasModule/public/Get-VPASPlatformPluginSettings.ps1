<#
.Synopsis
   Get platform plugin settings
   CREATED BY: Vadim Melamed, EMAIL: vpasmodule@gmail.com
.DESCRIPTION
   Use this function to retrieve the plugin settings set for a platform
.LINK
   https://vpasmodule.com/commands.html#Get-VPASPlatformPluginSettings
.NOTES
   Category: PAM
   Tag: Platforms
   Since: v15.0.0
...
.EXAMPLE
   $PlatformPluginSettingsJSON = Get-VPASPlatformPluginSettings -platformID {PLATFORMID VALUE}
.EXAMPLE
   $InputParameters = @{
   ...
   $PlatformPluginSettingsJSON = Get-VPASPlatformPluginSettings -InputParameters $InputParameters
.OUTPUTS
   If successful:
   {
        "params":  {
   ...
   $false if failed
#>
function Get-VPASPlatformPluginSettings{
    ...
    Process{
        try{
            ...
            Write-Verbose "FAILED TO RETRIEVE PLATFORM PLUGIN SETTINGS"
        ...
        try{
            ...
            if($sessionval){
                $response = Invoke-RestMethod -Headers @{"Authorization"=$Header} -Uri $uri -Method GET -WebSession $sessionval
                $APICounter += 1
            }
            else{
                $response = Invoke-RestMethod -Headers @{"Authorization"=$Header} -Uri $uri -Method GET
                $APICounter += 1
            }
            if($ExportToCSV){
            ...
            Write-Verbose "RETURNING PLATFORM PLUGIN SETTINGS"
            return $response
        }catch{
            $log = Write-VPASTextRecorder -inputval $_ -token $token -LogType ERROR
            $log = Write-VPASTextRecorder -inputval "REST API COMMAND RETURNED: FALSE" -token $token -LogType MISC
            Write-Verbose "UNABLE TO RETRIEVE PLATFORM PLUGIN SETTINGS"
            Write-VPASOutput -str $_ -type E
            return $false
        }
    }
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUhAjPBMJDbuBArex410Goah7x
# G6CggiTgMIIFbzCCBFegAwIBAgIQSPyTtGBVlI02p8mKidaUFjANBgkqhkiG9w0B
...
# CisGAQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFD2N0SR78xCQmAjUDZu76FeZZMiC
# MA0GCSqGSIb3DQEBAQUABIICAHOQzMPi7zkEHLTpMhfuoAK/hLvsCLq8Gd7zVpdI
# eaoTSYfGizfDdKf4ZqY+0tBktAVF4DWstHYclK0U/zqRw0+EtYItCSOtJ/HyWhav
# xE0zrX8aHiAg1V8fqEJegtAuVAMgyayLRhDBau/r3YCU/30PTpuAGbe+Pyt/TPTP
# 7C8pyxy/hJndtlrgk43zjbW8+uXIkrYgt6uDsoDF3Cof0vEHfKfgsASHMvWRr8nt
# aykj8lHm8318AP2fwFTj3xMOPJCKg1KVcH/8O5UAOq6aDRQnWAwF2BFXWTba8KhL
# lhvSDQrRZNuZH9zMbBi/ZxkIcMtYOAF+5ppbm1ph0kXdVHVirEE6opKqBiJQIp8b
# 1LwzJ6ElzNH/JBEeQPfeR1HMrb/aTilKMDLNUtx7r9sobraWsqSrxUQwq1KQ1kYr
# K82RNcidDxYa0xohFa5nw+2qeerYLsnPGX/02DjDCorDgsgi0PaBqyvDUtIj2w0j
# t2Xz23YWd6DcangQovZ5Tn22VhJagqrXXCQW2I3AOiygXniUL02ZkEuXNadY9RM+
# 0JBD4LsqSGtgBuco4MMPcXZDTxm1WCUg4m+QC1vuEjCOBNsOJ80Cwp/f63xlXqeA
# le1OCFwp0/SrcfdDnU3ofnv6UCAzQrprT0d+ra5srg+w6R/FIO9SeAClrj08weN+
# 5LO6oYIDIzCCAx8GCSqGSIb3DQEJBjGCAxAwggMMAgEBMGowVTELMAkGA1UEBhMC
...
# 9w0BCQUxDxcNMjYwMjA0MDQ0OTM5WjA/BgkqhkiG9w0BCQQxMgQwP23rYaax9gME
# lnh4H95uYGaN5QbcyzWVLEJugjTg0IvhUp8AR3LWjekR+roT60daMA0GCSqGSIb3
# DQEBAQUABIICADU25x/f/E8UzwQdJ1UDp908w2xK/GjV84wM31R//H1L7myFWKlb
# Fuv2swE9ldqZqg9T0kZ5rajHN1Y01sx6kkS0HEdhZwE2VpQOItZGIRhrzHrc8Upr
# 9SptFF1dNPMHW6s85elMH59/MO7zUF+CjnoMXbImE1w5EvdfSjcj0EGLCFWJi7VE
# 8QO0mcSmam717Iyi2vhDEZwCIRM81E2lZJr1tW/fmzrpKpIu10+8PAn7X/UfGh46
# jop2kzLrW5+1dknAghVFVnnxt8kIWwpzTCGLx28o3HmfXq98Kt/JKy7GmObdzmuk
# gaNhm8tfmX6hzyZUAVB2ky85sud1lYDE6p3l1eTkZxtE0EaPq5Lf0gImT5Q9geTx
# AKvz55UaxHcjMk6sj5avxNEFleyDxjc2VZSfwnxATgHpH/e2m4njkeqRotXu956l
# vYCn9ASOcVSA/OGXq5eErb15yDz8PVNGS3NzsprzVC5a/Cao38KrfsUwsM3WYMhe
# eprGOzZmdBGwpbimm0XqjwXzlb1/ArTom6+9NW3ASuS+rJoVPD2eMjgQlVKt6TG6
# 4RYeAs5ObHFW9URKAeTD6K8zqM673dlloKSuBk1BIdo2tRWcfTdkBkddbDJtjklk
# 15xIBCvMnSUdawM/7q6fzPJy9moVWX7lincNr0KsIeWOtwYHJLuPLNrI
