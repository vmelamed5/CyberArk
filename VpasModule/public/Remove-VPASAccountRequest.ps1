...
.DESCRIPTION
   Use this function to delete an account request
.LINK
   https://vpasmodule.com/commands.html#Remove-VPASAccountRequest
.NOTES
   Category: PAM
...
.EXAMPLE
   $DeleteAccountRequestStatus = Remove-VPASAccountRequest -RequestedUsername {USERNAME VALUE} -RequestedSafe {SAFE VALUE} -RequestedReason {REASON VALUE}
.EXAMPLE
   $DeleteAccountRequestStatus = Remove-VPASAccountRequest -RequestedAcctID {ACCTD VALUE} -RequestedReason {REASON VALUE}
.EXAMPLE
   $DeleteAccountRequestStatus = Remove-VPASAccountRequest -requestID {REQUESTID VALUE}
.EXAMPLE
   $InputParameters = @{
        ...
        try{
                ...
                if($reqCount -eq 0 -or $reqCount -gt 1){
                    ...
                    if($WhatIf){
                        ...
                        $WhatIfInfo = Get-VPASAccountRequestDetails -requestID "$requestID" -token $token
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUi67PlR1neuDdv/ZuowURyGDh
# TG+ggiTgMIIFbzCCBFegAwIBAgIQSPyTtGBVlI02p8mKidaUFjANBgkqhkiG9w0B
...
# CisGAQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFEkX94vx+2K04ZrYu+h/6q8OOzt5
# MA0GCSqGSIb3DQEBAQUABIICAFXGFPYc88aJkISAoKaW0IuCKyBCU+ASrGaPqjzg
# qezbmgWj9DCVH90LwWnN/q4ikKKy3m6xdhk1cyDKHeGuWcTr4Z2dm3WTFvjUvDKM
# MnRascjWfxpFGXKjD84nuJ0kpRN1QGgbA1NLWli3D1AibebjpkjDq77OMfu+/i2o
# FDVy3CHJiBgPanRety1PfzHtf42S7C1nNMMTtO8W6ma2aheTWZ7ogqVeBy5NVWhw
# +1IZLfqT0C//FjciYsC6p2iZO0V59OJtK3w6Zpuh+SHEguPq5TUSvpD3aVFHxG5y
# G6NMzY03omAsoG9JhheLkhq3u/G3+KoZJuRqxopE5Xtl/v/JQLyD6aaD/qJwNK7o
# vYXFdVesj6+o8aWn1wLGAUlHDpmLaiRGLL+NtcUrienrR1rWLaoxaXjqKIQrxtkS
# ppPmBcyViUuRuqkbNMz3x0dZMIMjECuxtqU/Q3Z58k00Og9cHxjIxb7ecy5E0Ajq
# OHGggX23gNtN61FKZlpuvTHklb+uno98fyiSKgvOsnT1obF3l83q50XNnhjvyFyI
# zcNPt8vgOe4JiJI+5DkpsC0TdQfj7NfST+Uj24T0kXAXmEWXjS8Th1xPHoOM6Jam
# dqXv/W8EUl6WnxiIimZQlmCOlfNaa9PjIi9Cwc6o5owvJi/y/PvqqXlNSJ49gkkz
# fUinoYIDIzCCAx8GCSqGSIb3DQEJBjGCAxAwggMMAgEBMGowVTELMAkGA1UEBhMC
...
# 9w0BCQUxDxcNMjYwMjA0MDQ1MjQ4WjA/BgkqhkiG9w0BCQQxMgQwGgdIPirbe9FA
# T+KCFUEar9prZd7xQYU5l6HjrtHXCiCYJxuRwXUtUWtQvzflbRcKMA0GCSqGSIb3
# DQEBAQUABIICADIwfzm3TCO1bwk62/hzelqA+lVeRUQ4iGN47KzsGODcLQnSI8n4
# H2hNSbGCTJU4MbznKNyBwAs8vo2TFOmPsqDlZLHWaybAwnmvS8xFeg/utl95l0Tf
# 4CThhp/HTYFkvbOfIMH6XXtxc+vIbYbAHgGU59rtCH1zG3RYMHR32jIWdcAwKZY/
# pjk8YDWwI4h8wIrbu7+Huczv5SG/cOKPEzf/suuNpBpUis2XCtXtDVXvHBZj6ZB9
# +otT8xo3ksB7efEQPvoHGa1JvLyNoOXOZzKDVfOjScKteJS/5mIjKKndvjDkFIr0
# F+PcAR9ujdKJm8WulM6vpx81CYAmmhX+Wu46wkwkeQ7JRiQF9/zCPWzTwU+epTMz
# LtQ9SBGxBwVzkebRcmdtr1vcI4SVleg6XWCQxDPp6qALHdYWGFQSEnKCAllKR9jp
# JLnU1dAC0UJTAx13m2yMNpihFCa5W4jxyy8LUM8v+z1g2QHPuo1+ST1bfKBFbl16
# s7DG901r21qxcrnsP0l8r1c7eRgomgctPK/I4fL6lf6DE2ZB0GaGI6OzXiF/9buj
# Q1Ecdsmwu9iEH2D8C2hsK2T4Z3GmN4fw5B7A1x9Lj6wrNiK9wSqk1pbLOFNQRXLb
# 8I+KaPwEvk/VkQ1cnggrACi8siUal+F9Kq4g5l9UkezQNQCeRrHM01nW
