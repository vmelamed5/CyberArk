...
.DESCRIPTION
   Use this function to delete an authentication method from CyberArk
.LINK
   https://vpasmodule.com/commands.html#Remove-VPASAuthenticationMethod
.NOTES
   Category: PAM
...
.EXAMPLE
   $DeleteAuthenticationMethodStatus = Remove-VPASAuthenticationMethod -AuthMethodSearch {AUTH METHOD SEARCH VALUE}
.EXAMPLE
        ...
        try{
            ...
            if($WhatIf){
                ...
                if(!$WhatIfInfo){
                    ...
                    Write-VPASOutput -str "UNABLE TO QUERY AUTHENTICATION METHODS" -type E
                    return $false
                }
                ...
                Write-VPASOutput -str "UNABLE TO FIND TARGET AUTHENTICATION METHOD ID" -type E
                return $false
            }
            else{
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUn9mGP6KJbQdqjpbmHAz1Xb+/
# V6yggiTgMIIFbzCCBFegAwIBAgIQSPyTtGBVlI02p8mKidaUFjANBgkqhkiG9w0B
...
# CisGAQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFKb+FqTFGRDXkeU/S5F04nUfuIYD
# MA0GCSqGSIb3DQEBAQUABIICAAy+TpKbV55uwD8Bq0g7XRCve+dhGbSegnMFZun+
# O5+5Y0LE88CnjsbIJpj8yHN5UFmZt4wwebdNU7qj4y8MqJ0pv4z8SgVXq5c6ArEH
# MCR91MRoXlyB81pW5h0mp9DmJCZ7D5SiBUf1Pgazto67JD0DCCrM/17J9EPT8J8K
# s/3BZiGCIWNTw5xYsUKA5FUlhajJNlWMBQH6/kvYfF7qX39tcUabq3VsOzBCXuh0
# V5KATeF4aRMbwbmhWh/gCNPbT8zXOVRXSyx1Id5yY1lIoGUfwNRVcXVHg0T4SLwW
# 0BHrmjnOMiC8YOaBmNFa24Fha3dSzkxGGD3Qmo4aNcQhYfMzz8LqsxQguPcfaz5k
# ONyc37wISIxMZC80DSrHJSOSfRo90R5v9qL0KFP8VnxdgZBAeQV5GrzDotxP/Xnr
# fd/pJWY61vOL2IE3MEkgOtAAwBA+XSIgJUJx8ZXlJlFIcxlaqAgV3tJcREIxwhoS
# DMYo4YWJ/mK/ua6W8qj+k0xBctF2LmuU9t1Y7ioqPHjI8fcKQ9G3VICSpDYzJqwC
# RPjX026y7mrHsCHWAh29LXZSGYYveWjw2zb8NPUuKpBewGJM0wkgcivk2m5FWv5w
# J7VBRwovFx1lvzHrAoOa1YlZw6fpHr7f68AWCAVMZ559fFn+HEmKlQFzJNNPXcqf
# OV7coYIDIzCCAx8GCSqGSIb3DQEJBjGCAxAwggMMAgEBMGowVTELMAkGA1UEBhMC
...
# 9w0BCQUxDxcNMjYwMjA0MDQ1MzAwWjA/BgkqhkiG9w0BCQQxMgQwiCjaUDb/B5vi
# f+dIP80z2JWRncuDwFYAXVi/xF/cqPl0pZszzexQlc8Ql0rtpr3pMA0GCSqGSIb3
# DQEBAQUABIICABc6lnH6pqUeggNTmoIZSBSu1W9zPDQ0APBa1Wj/RMlC8p4dU3Is
# sRDQT/Z5sFvlinTZ+gE7pbwXxyEnE5DTL9bAG3o1ZwV0hDL87cWZ1INuiIl8gh43
# TvAZw0zU3i4fQ5o4cnDheqv20LXZ1ldr4paSOyytM5z0hAjzmZuxeO3N4fPY4hq+
# cO0rnUE6RxMWSc5xJiVZza49CSs6+DhBSMk+sM+V67GHWJFFqawbvKBNi4ESIZgH
# iS5IqM2ztFVoZWV+akoM1MUAKVFu2TyE1/xdNvnYhGho9ABi4pLGffy4+S50I22s
# OUJjzvf6qn/ggSmyTphD88KoQ89H8SPrx12zg9jViF1Zx0gcedr7jhLhgfqopfFj
# d3/iQHXeEnyAIRx8rppVta42W0kLow8gGAgF148b4bl6iA7rUfVVw2/2w8fQ6Nry
# 1PhJKCysgQuqqVCMRgi0lSgupYizP4m2f5nkaG+6d9Iy3O+pXPYMUYvMr/mPa+fa
# pdlhDWIxs/gkMMhHoeMJx5jkPGZJghzbDe73FzUyKMbcOug8dQ97Avrykwi9K0Y8
# jeAPwzIagvrhUbP0BW0u7dqT+eQCWUDs4SA4hXpLLlLAXO6KSTuwi12f5vfDgF84
# r0FUTaVXLiM4l5P538q4wPj1Hsv/pmnOfJzPtoPWZzzm4T2KNdj2V1+y
