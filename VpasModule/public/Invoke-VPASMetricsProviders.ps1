<#
.Synopsis
   Run various provider metrics
   CREATED BY: Vadim Melamed, EMAIL: vpasmodule@gmail.com
.DESCRIPTION
   Use this function to generate various Provider related metrics and KPIs
.LINK
   https://vpasmodule.com/commands.html#Invoke-VPASMetricsProviders
.NOTES
   Category: PAM
   Tag: Metrics
   Since: v14.2.0
...
.EXAMPLE
   $GenerateReport = Invoke-VPASMetricsProviders -TargetMetric {TARGET METRIC VALUE} -MetricFormat {METRIC FORMAT VALUE} -OutputDirectory {OUTPUT DIRECTORY VALUE}
.EXAMPLE
   $InputParameters = @{
    ...
    Process{
        ...
        try{
            ...
            if($TargetMetric -eq "ApplicationIDsOnSafes"){
                ...
                $AllAppIDs = Get-VPASAllApplications -token $token
                if(!$AllAppIDs){
                ...
                $AllEPVGroups = Get-VPASAllEPVGroups -IncludeMembers -token $token
                if(!$AllEPVGroups){
                ...
                if(!$AllSafes){
                    ...
                    foreach($safe in $AllSafes.value){
                        ...
                        if(!$skipval){
                            $AllSafeMembers = Get-VPASSafeMembers -safe $targetSafeName -IncludePredefinedMembers -token $token
                            if($AllSafeMembers){
                            ...
                            if($AllSafeMembers){
                                foreach($mem in $AllSafeMembers.value){
                                    ...
                                    if($AllAppIDsArr.Contains($targetMember)){
                                        ...
                                        $AllAccts = Get-VPASAccountDetails -safe $targetSafeName -ExactMatch -token $token
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQU7p32Ya4pwltKGtDkXkSdyPC7
# fR2ggiTgMIIFbzCCBFegAwIBAgIQSPyTtGBVlI02p8mKidaUFjANBgkqhkiG9w0B
...
# CisGAQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFF6PxUW8JP1eSz+T33ia5/mJY8vm
# MA0GCSqGSIb3DQEBAQUABIICABgP8r0G8zDyXsGi06kvqhtlINyYe4rFQaSC6Dyx
# yMnNyyb8mPP0h5IMMXox+T3/vMkKOiOaDSSI1cVruI2TZJ5llG+zFs+qJyntskXS
# cH9fVZRNI+LcaY1FXPtvYVchOtANp3jD6FSpXncJY5OjjXKGsSUxaaaU4yrKd12u
# m1sM/wuVLRF9UhwUCxxUWJGAGLM/ra4gIHKyWuVZGMTSluA7KWmayB3lRPZWiP4M
# 7Ga+DCTsRmftFh689rcIBGEfUTQ/GO+7zTQc73t68VXtJd2/OREOzEvYVFOQz+4k
# 7xUi6SBi/mBjioHcmB0IHENn0BF24MHN3k3K3JPg83xYIO57YOzXFEsGsUbtiJrJ
# 8lDtKEQQpTmQbZtjmmgxOZLdd1XuiMkhjQR/b9FG/dgoYf9hePxcSvFnS7Kky3o6
# zOd8GVP94ilz6mi3KPpiHVyObX5p+3REmwroi2rhUs0QiLzNhkwJeFG1AvO9Sryo
# UnvVVeUQbLadxdazXrVfE+Jb5AMzwggEHG8dQqvRhRLNRVCiT6IJhtJlwDKevsZf
# /flYoynOXvWlw/ttKhBnnhwUXozscLTgaJvGV82WFQcK8AcBhhgrup7i30Y4Bq6L
# Ygw/fto2wrhugL6mohZk1vmK/bzqRHftDabt3on6tf9930VU2YcdOeCcd5K2iEPi
# MmXEoYIDIzCCAx8GCSqGSIb3DQEJBjGCAxAwggMMAgEBMGowVTELMAkGA1UEBhMC
...
# 9w0BCQUxDxcNMjYwMjA0MDQ1MjA2WjA/BgkqhkiG9w0BCQQxMgQw2wj50WCX1glG
# pNu/A2ZNGpKuuK6DMgUe38OUMLrJ1KEUXPVQI4zd8LKT1yzjxQldMA0GCSqGSIb3
# DQEBAQUABIICACDqtVVrIxnZrCwy50sWqikqjkJ1d1Jb0tn1LBmp0j/eQTEGWVdg
# XjP1PkZJ2fqVDYZ01uldUKMnSQSo0yuwSthxPfiVOT38XssNWEp2d3GYSdL4uSO2
# E+WabxXrYRktdTGBGVOXbwnTnmdrdPgm+Ud2IGEYaTruwhbbnF5unfZ7R0YiBZtU
# aXB0VOIWGGywJ+KPfbrxej/l8D5ZNOaLPLwHFrAdFLzAGL6BW3V6b/8sRWfNa2tH
# WZHrrXyxca+8Tzb5Y7I1BlPmmoe54C/BaRzEj9tKJ8fG2hdjuy+1sPQE0/h8Zk6t
# oV4Z1mMPV8oYYPZ4QvtEX7Xh1b4/14XYUvu9jScg2m10zhlKzyQDiSz0LYS0Dq9j
# dzY43HGGi4u2YednFlCMkI3Vv0EyF7oiqzlx5UMe8auqgvNNWteJrR3I7KLHZEB1
# IxM0DaJjr3pZn85SZvg/YiKs64T1lic0C1b6cDfPRQz7NrIqFfJVHRRuBPCfPpZB
# bRVOBLTKr0+SKSgJc4VFoVSiTa8jX97gUb3oo4gc3I0HfUKGatIU3VxFGieQ2sZY
# ngJh9nPp5VDryDDjAZdrx4Hwa4L0djMh+1EuAc1stuMGKmCCmjVxj9bKQRShSZ0y
# uI/vKY+t1uuA0Ebr+X8fG3HJh4hJaFFsm/WMwGVlzPVSqy8Wo25h9dft
