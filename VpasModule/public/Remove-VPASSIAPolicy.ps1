...
.DESCRIPTION
   Use this function to delete a policy from SIA
.LINK
   https://vpasmodule.com/commands.html#Remove-VPASSIAPolicy
.NOTES
   Category: SIA
   Tag: Policies
   Since: v14.2.1
...
.EXAMPLE
   $DeletePolicy = Remove-VPASSIAPolicy -PolicyID {POLICY ID VALUE}
.EXAMPLE
   $DeletePolicy = Remove-VPASSIAPolicy -PolicyName {POLICY NAME VALUE}
.EXAMPLE
   $InputParameters = @{
   ...
   $DeletePolicy = Remove-VPASSIAPolicy -InputParameters $InputParameters
.EXAMPLE
   $InputParameters = @{
        ...
        try{
            ...
            if($PolicyID -eq -1){
                ...
                if($WhatIf){
                    ...
                    $WhatIfInfo = Get-VPASSIAPolicyDetails -PolicyID $PolicyID -token $token
                    ...
                    Write-Verbose "SUCCESSFULLY DELETED SIA POLICY: $PolicyID"
            ...
            $log = Write-VPASTextRecorder -inputval $_ -token $token -LogType ERROR
            $log = Write-VPASTextRecorder -inputval "REST API COMMAND RETURNED: FALSE" -token $token -LogType MISC
            Write-Verbose "FAILED TO DELETE SIA POLICY"
            Write-VPASOutput -str $_ -type E
            return $false
        }
    }
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUIQ0+ugwkG4qQQaJz6Hp7OIxA
# ts+ggiTgMIIFbzCCBFegAwIBAgIQSPyTtGBVlI02p8mKidaUFjANBgkqhkiG9w0B
...
# CisGAQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFId0d1FWjtCOjlsoMm25z+jShp5q
# MA0GCSqGSIb3DQEBAQUABIICABTxInH9SJOs1HYB9KEKctn/EQWE6BhatiFg3bq7
# dqWml1K0jRNNpGbR1J+IMkNPa2Fr1Ak49O1FLxx2c6weZJxDWoW7gyg4s6UuXbc/
# 1OOuPEfSdjerApn1vYrF1uO+UYjdpGhLSCYvWZT7kpf+3rWGrnCWu/GmKyfy7o0c
# tIsXhcoyF3TBLF5Yqg63cHIqmm6W9H0yEau2JiSmnQHos6fBy3SxMXRkWsmy/kEC
# vq7gDOOnN3NL035bdg4VmOxy0KqWWW+H37JWl+VojLDCxy/Sjr+4L/vYClhckv3Y
# ZgMSsMktVE/QuGnOPH4uanjisiVL4l5q+fYUvSXL6g861ARko8Y43cobGCYo0hpN
# 0qGpQnROefEw57B8+T3/czqAddHI27/HD0JLOiloZK5ZRrzuZ3E608Wg5SKSxpZ+
# NJRH/9LIqv1ElqaHMAaj39jSvf3r/g6Oihp4RaD1YYA/rt+Ix3IutRF5+scIPLVR
# cloDm8mhxFTvTa2b5OtdtW9nZr5hp9kpg40Wn6/b4OF7oLR1E6aKSdixzZb5lULu
# 7GjD+lcuLEjLV9DNKiM/omEXeq8a2f2kVtS0DZJciUb6InjK6enMvvWHSdd6YCAO
# OXd5Z6oPyLo1ZtS/FbGr2zdA3oXvfOUfRkpTkb5Ea8OQAOtG0fexmYAAYSjsipf4
# JlNVoYIDIzCCAx8GCSqGSIb3DQEJBjGCAxAwggMMAgEBMGowVTELMAkGA1UEBhMC
...
# 9w0BCQUxDxcNMjYwMjA0MDQ1NDAwWjA/BgkqhkiG9w0BCQQxMgQwSJEFrniKzG7d
# 9CgmbxjBCoBc0Yo3SiREu+aieoqaBjAMDUNydWUIx9dR7IpxdSMKMA0GCSqGSIb3
# DQEBAQUABIICAKKc7SSgeH2oZ/byIaHcl1uo6/+58qCzgjX8arM3vSLr/689Leus
# kCDjEL2MDax0C9Tu2CJ+aqnVvUmaI/4XNBa2BkYQ8xWMP0UyDqw8qap1OsOUq8EE
# n+Meg5y/ixz6hO4kwLLF6eaoiWqASNcRH9o4bO9GoB3kOOwyx+z3cXuDYayAwIwF
# KVA1hx2OTX4uBHf6nFKfJ7KfAGJLFUSQB1wagqEal5NM54022IQTuxfBQWz2rizJ
# dTJbJpWJYaIx0zSJYh64dxgnkdH08veuZ62JcdMKRT6NUURCIAuqzPxxcHbhp55k
# 5ur5I+ZiV3IXoLHNq147wfCJgNyJsfO5YdFxN3/sy0WZkN7PsKNVlOMBszbcF5tN
# 72H2V8rV8VHL/dQK+6aKGvia0mrGn0k96zpQPGWY0LPaYF4AFMsDIkV5NOxaYk0m
# bbhmsxhsAXOpNZq1N3eA5sd+xsWjP3Sq9jlKpeRR/XDtt64tQbHg/VPUZPufWh0N
# kDWY3fcyXaRrSo0mpPssaLn0v3K43L8+TKUshIZct0uftt9vF2lvzwDAl6BhEElh
# mjTL3kur9f5+yS7TeYt2XVzyUYZYGC2/lqGVMCEHuLTdpZIDU/wE+3eXJtpEY1Gp
# nwM5x1hVSMI2rZbTkkxQ3A/wNtrckJGzEPv4lGFMSnr1RIA3zWTTLZRo
