...
.DESCRIPTION
   Use this function to delete a temporarily stored platform
.LINK
   https://vpasmodule.com/commands.html#Remove-VPASStoredPlatform
.NOTES
   Category: PAM
   Tag: Stored Platforms
   Since: v14.6.0
   Version: 3
   SelfHosted: TRUE
...
.EXAMPLE
   $DeleteStoredPlatformStatus = Remove-VPASStoredPlatform
.EXAMPLE
   $InputParameters = @{
		WhatIf = $true|$false
		HideOutput = $true|$false
   }
   $DeleteStoredPlatformStatus = Remove-VPASStoredPlatform -InputParameters $InputParameters
.OUTPUTS
   $true if successful
   ---
   $false if failed
#>
function Remove-VPASStoredPlatform{
    ...
    Process{
        try{
            ...
            Write-Verbose "FAILED TO REMOVE STORED PLATFORM"
        ...
        try{
            ...
            if($NoSSL){
                ...
                $uri = "http://$PVWA/PasswordVault/API/Platforms/Storage"
            }
            else{
                Write-Verbose "SSL ENABLED BY DEFAULT, USING HTTPS"
                $uri = "https://$PVWA/PasswordVault/API/Platforms/Storage"
            }
            ...
            if($WhatIf){
                ...
                $WhatIfInfo = Get-VPASStoredPlatformDetails -token $token
                foreach($WhatIfPlat in $WhatIfInfo){
                    $WhatIfStoredID = $WhatIfPlat.StoredPlatformDetails.Id
                    $WhatIfStoredBaseID = $WhatIfPlat.StoredPlatformDetails.BaseId
                    $WhatIfStoredName = $WhatIfPlat.StoredPlatformDetails.Name
                    $WhatIfStoredVersion = $WhatIfPlat.StoredPlatformDetails.Version
                    $WhatIfConflictedID = $WhatIfPlat.ConflictedPlatformsDetails.Id
                    $WhatIfConflictedBaseID = $WhatIfPlat.ConflictedPlatformsDetails.BaseId
                    $WhatIfConflictedName = $WhatIfPlat.ConflictedPlatformsDetails.Name
                    $WhatIfConflictedVersion = $WhatIfPlat.ConflictedPlatformsDetails.Version
                }

                if(!$HideWhatIfOutput){
                    Write-VPASOutput -str "====== BEGIN COMMAND SIMULATION ======" -type S
                    Write-VPASOutput -str "THE FOLLOWING STORED PLATFORM WOULD BE DELETED:" -type S
                    Write-VPASOutput -str "StoredID           : $WhatIfStoredID" -type S
                    Write-VPASOutput -str "StoredBaseID       : $WhatIfStoredBaseID" -type S
                    Write-VPASOutput -str "StoredName         : $WhatIfStoredName" -type S
                    Write-VPASOutput -str "StoredVersion      : $WhatIfStoredVersion" -type S
                    Write-VPASOutput -str "ConflictedID       : $WhatIfConflictedID" -type S
                    Write-VPASOutput -str "ConflictedBaseID   : $WhatIfConflictedBaseID" -type S
                    Write-VPASOutput -str "ConflictedName     : $WhatIfConflictedName" -type S
                    Write-VPASOutput -str "ConflictedVersion  : $WhatIfConflictedVersion" -type S
                ...
                $WhatIfHash = @{
                    WhatIf = @{
                        StoredID = $WhatIfStoredID
                        StoredBaseID = $WhatIfStoredBaseID
                        StoredName = $WhatIfStoredName
                        StoredVersion = $WhatIfStoredVersion
                        ConflictedID = $WhatIfConflictedID
                        ConflictedBaseID = $WhatIfConflictedBaseID
                        ConflictedName = $WhatIfConflictedName
                        ConflictedVersion = $WhatIfConflictedVersion
                        RestURI = $uri
                        RestMethod = "DELETE"
                        Disclaimer = "THIS STORED PLATFORM WILL BE DELETED IF -WhatIf FLAG IS REMOVED"
                    }
                }
                ...
                Write-Verbose "SUCCESSFULLY DELETED STORED PLATFORM"
            ...
            $log = Write-VPASTextRecorder -inputval $_ -token $token -LogType ERROR
            $log = Write-VPASTextRecorder -inputval "REST API COMMAND RETURNED: FALSE" -token $token -LogType MISC
            Write-Verbose "UNABLE TO DELETE STORED PLATFORM"
            Write-VPASOutput -str $_ -type E
            return $false
        }
    }
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUi0cnGqbQyZ+xmvo328nrmPd+
# R92ggiTgMIIFbzCCBFegAwIBAgIQSPyTtGBVlI02p8mKidaUFjANBgkqhkiG9w0B
...
# CisGAQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEF