<#
.Synopsis
   Update platform rotation policy
   CREATED BY: Vadim Melamed, EMAIL: vpasmodule@gmail.com
.DESCRIPTION
   Use this function to update a platform rotation policy
.LINK
   https://vpasmodule.com/commands.html#Update-VPASPlatformRotationPolicy
.NOTES
   Category: PAM
   Tag: Platforms
   Since: v15.0.0
...
.PARAMETER Field
   Target field that will be updated
   Possible values: maxRetries, minDelayBetweenRetries, resetOveridesTimeframe, allowedManualChange, specificTimeframeChange, daysChange, fromTimeChange, toTimeChange, allowedPeriodicChange, intervalChange, headstartIntervalChange, autoOnAddChange, overridesMasterPolicyChange, enforcePasswordPolicyOnManualChange, allowedManualVerify, specificTimeframeVerify, daysVerify, fromTimeVerify, toTimeVerify, allowedPeriodicVerify, intervalVerify, autoOnAddVerify, overridesMasterPolicyVerify, allowedManualReconcile, specificTimeframeReconcile, daysReconcile, fromTimeReconcile, toTimeReconcile, autoReconcileWhenUnsynched, allowedSafes, enableDownloadRotationLogs, enableRotationNoticePeriod, rotationNoticePeriod, safeReconcile, nameReconcile, indexReconcile, labelReconcile, safeLogon, nameLogon, indexLogon, labelLogon
.PARAMETER FieldVal
   Target value to update the target field with
.PARAMETER InputParameters
   HashTable of values containing the parameters required to make the API call
.EXAMPLE
   $UpdatePlatformRotationPolicy = Update-VPASPlatformRotationPolicy -PlatformID {PLATFORMID VALUE} -Field {FIELD VALUE} -FieldVal {FIELDVAL VALUE}
.EXAMPLE
   $InputParameters = @{
        PlatformID = "TargetPlatformID"
        Field = "maxRetries"|"minDelayBetweenRetries"|"resetOveridesTimeframe"|"allowedManualChange"|"specificTimeframeChange"|"daysChange"|"fromTimeChange"|"toTimeChange"|"allowedPeriodicChange"|"intervalChange"|"headstartIntervalChange"|"autoOnAddChange"|"overridesMasterPolicyChange"|"enforcePasswordPolicyOnManualChange"|"allowedManualVerify"|"specificTimeframeVerify"|"daysVerify"|"fromTimeVerify"|"toTimeVerify"|"allowedPeriodicVerify"|"intervalVerify"|"autoOnAddVerify"|"overridesMasterPolicyVerify"|"allowedManualReconcile"|"specificTimeframeReconcile"|"daysReconcile"|"fromTimeReconcile"|"toTimeReconcile"|"autoReconcileWhenUnsynched"|"allowedSafes"|"enableDownloadRotationLogs"|"enableRotationNoticePeriod"|"rotationNoticePeriod"|"safeReconcile"|"nameReconcile"|"indexReconcile"|"labelReconcile"|"safeLogon"|"nameLogon"|"indexLogon"|"labelLogon"
        FieldVal = "UpdatedValue"
   }
   $UpdatePlatformRotationPolicy = Update-VPASPlatformRotationPolicy -InputParameters $InputParameters
.OUTPUTS
   If successful:
   {
        "createdAt":  "2025-09-05T16:21:00.335Z",
        "updatedAt":  "2026-01-21T04:22:02.166Z",
        "createdBy":  null,
        "updatedBy":  null,
        ...
        "reconcile":  {
                          ...
                          "autoReconcileWhenUnsynched":  false
                      },
        "linkedAccounts":  {
                               "reconcile":  {
                                                 "safe":  null,
        ...
        "origin":  "OUT_OF_THE_BOX",
        "allowedSafes":  ".*",
        "enableDownloadRotationLogs":  true,
        "enableRotationNoticePeriod":  false,
        "rotationNoticePeriod":  60
   }
   ---
   $false if failed
#>
function Update-VPASPlatformRotationPolicy{
    [OutputType([bool])]
    [CmdletBinding(DefaultParameterSetName='Set1')]
    Param(

        [Parameter(Mandatory=$true,ParameterSetName='Set1',ValueFromPipelineByPropertyName=$true,HelpMessage="PlatformID of target platform to be updated (for example: WinSeverLocal)")]
        [String]$PlatformID,

        [Parameter(Mandatory=$true,ParameterSetName='Set1',ValueFromPipelineByPropertyName=$true,HelpMessage="Target field that will be updated (for example: daysChange)")]
        [ValidateSet('maxRetries','minDelayBetweenRetries','resetOveridesTimeframe','allowedManualChange','specificTimeframeChange','daysChange','fromTimeChange','toTimeChange','allowedPeriodicChange','intervalChange','headstartIntervalChange','autoOnAddChange','overridesMasterPolicyChange','enforcePasswordPolicyOnManualChange','allowedManualVerify','specificTimeframeVerify','daysVerify','fromTimeVerify','toTimeVerify','allowedPeriodicVerify','intervalVerify','autoOnAddVerify','overridesMasterPolicyVerify','allowedManualReconcile','specificTimeframeReconcile','daysReconcile','fromTimeReconcile','toTimeReconcile','autoReconcileWhenUnsynched','allowedSafes','enableDownloadRotationLogs','enableRotationNoticePeriod','rotationNoticePeriod','safeReconcile','nameReconcile','indexReconcile','labelReconcile','safeLogon','nameLogon','indexLogon','labelLogon')]
        [String]$Field,

        [Parameter(Mandatory=$true,ParameterSetName='Set1',ValueFromPipelineByPropertyName=$true,HelpMessage="Updated value for the targeted field (for example: 'Mon,Tue,Wed')")]
        [String]$FieldVal,
    ...
    Process{
        try{
            if($PSCmdlet.ParameterSetName -eq "InputParameters"){
                $KeyHash = @{
                    set1 = @{
                        AcceptableKeys = @("PlatformID","Field","FieldVal")
                        MandatoryKeys = @("PlatformID","Field","FieldVal")
                    }
                }
            ...
            Write-Verbose "FAILED TO UPDATE PLATFORM ROTATION POLICY"
        ...
        try{
            ...
            Write-Verbose "FETCHING CURRENT ROTATION POLICY VALUES FOR $PlatformID"
            $currentValues = Get-VPASPlatformRotationPolicy -platformID $PlatformID
            if(!$currentValues){
                Write-Verbose "COULD NOT FIND $PlatformID ROTATION POLICY DETAILS"
                Write-VPASOutput -str "COULD NOT FIND $PlatformID ROTATION POLICY DETAILS" -type E
                return $false
            }

            $singlefields = @("maxRetries","minDelayBetweenRetries","resetOveridesTimeframe","allowedSafes","enableDownloadRotationLogs","enableRotationNoticePeriod","rotationNoticePeriod")
            $changefields = @("allowedManualChange","specificTimeframeChange","daysChange","fromTimeChange","toTimeChange","allowedPeriodicChange","intervalChange","headstartIntervalChange","autoOnAddChange","overridesMasterPolicyChange","enforcePasswordPolicyOnManualChange")
            $verifyfields = @("allowedManualVerify","specificTimeframeVerify","daysVerify","fromTimeVerify","toTimeVerify","allowedPeriodicVerify","intervalVerify","autoOnAddVerify","overridesMasterPolicyVerify")
            $reconcilefields = @("allowedManualReconcile","specificTimeframeReconcile","daysReconcile","fromTimeReconcile","toTimeReconcile","autoReconcileWhenUnsynched")
            $reconlinkedfields = @("safeReconcile","nameReconcile","indexReconcile","labelReconcile")
            $logonlinkedfields = @('safeLogon','nameLogon','indexLogon','labelLogon')

            Write-Verbose "SETTING PARAMETERS"

            #HANDLE DIRECT PROPERTIES
            if($singlefields.Contains($Field)){
                Write-Verbose "REPLACING $Field VALUE WITH UPDATED VALUE: $FieldVal"
                $currentValues.$Field = $FieldVal
            }

            #HANDLE CHANGE PROPERTIES
            if($changefields.Contains($Field)){
                Write-Verbose "REPLACING CHANGE $Field VALUE WITH UPDATED VALUE: $FieldVal"
                $tempfield = $Field -replace "Change",""
                if($tempfield -eq "days"){
                    $dayssplit = $FieldVal -split ","
                    $currentValues.change.timeframe.$tempfield = $dayssplit
                }
                elseif($tempfield -eq "specificTimeframe" -or $tempfield -eq "fromTime" -or $tempfield -eq "toTime"){
                    $currentValues.change.timeframe.$tempfield = $FieldVal
                }
                else{
                    $currentValues.change.$tempfield = $FieldVal
                }
            }

            #HANDLE VERIFY PROPERTIES
            if($verifyfields.Contains($Field)){
                Write-Verbose "REPLACING VERIFY $Field VALUE WITH UPDATED VALUE: $FieldVal"
                $tempfield = $Field -replace "Verify",""
                if($tempfield -eq "days"){
                    $dayssplit = $FieldVal -split ","
                    $currentValues.verify.timeframe.$tempfield = $dayssplit
                }
                elseif($tempfield -eq "specificTimeframe" -or $tempfield -eq "fromTime" -or $tempfield -eq "toTime"){
                    $currentValues.verify.timeframe.$tempfield = $FieldVal
                }
                else{
                    $currentValues.verify.$tempfield = $FieldVal
                }
            }

            #HANDLE RECONCILE PROPERTIES
            if($reconcilefields.Contains($Field)){
                Write-Verbose "REPLACING RECONCILE $Field VALUE WITH UPDATED VALUE: $FieldVal"
                if($Field -eq "autoReconcileWhenUnsynched"){
                    $currentValues.reconcile.$Field = $FieldVal
                }
                else{
                    $tempfield = $Field -replace "Reconcile",""
                    if($tempfield -eq "days"){
                        $dayssplit = $FieldVal -split ","
                        $currentValues.reconcile.timeframe.$tempfield = $dayssplit
                    }
                    elseif($tempfield -eq "specificTimeframe" -or $tempfield -eq "fromTime" -or $tempfield -eq "toTime"){
                        $currentValues.reconcile.timeframe.$tempfield = $FieldVal
                    }
                    else{
                        $currentValues.reconcile.$tempfield = $FieldVal
                    }
                }
            }

            #HANDLE LOGON ACCOUNT PROPERTIES
            if($logonlinkedfields.Contains($Field)){
                Write-Verbose "REPLACING LOGON ACCOUNT $Field VALUE WITH UPDATED VALUE: $FieldVal"
                $tempfield = $Field -replace "Logon",""
                $currentValues.linkedAccounts.logon.$tempfield = $FieldVal
            }

            #HANDLE RECONCILE ACCOUNT PROPERTIES
            if($reconlinkedfields.Contains($Field)){
                Write-Verbose "REPLACING RECON ACCOUNT $Field VALUE WITH UPDATED VALUE: $FieldVal"
                $tempfield = $Field -replace "Reconcile",""
                $currentValues.linkedAccounts.reconcile.$tempfield = $FieldVal
            }

            $log = Write-VPASTextRecorder -inputval $currentValues -token $token -LogType PARAMS
            $currentValues = $currentValues | ConvertTo-Json -Depth 100

            Write-Verbose "MAKING API CALL TO CYBERARK"
            if($NoSSL){
                Write-Verbose "NO SSL ENABLED, USING HTTP INSTEAD OF HTTPS"
                $uri = "http://$PVWA/api/platforms/$PlatformID/rotation-policy"
            }
            else{
                Write-Verbose "SSL ENABLED BY DEFAULT, USING HTTPS"
                $uri = "https://$PVWA/api/platforms/$PlatformID/rotation-policy"
            }
            $log = Write-VPASTextRecorder -inputval $uri -token $token -LogType URI
            $log = Write-VPASTextRecorder -inputval "PATCH" -token $token -LogType METHOD

            if($sessionval){
                $response = Invoke-RestMethod -Headers @{"Authorization"=$Header} -Uri $uri -Body $currentValues -Method PATCH -ContentType "application/json" -WebSession $sessionval
                $APICounter += 1
            }
            else{
                $response = Invoke-RestMethod -Headers @{"Authorization"=$Header} -Uri $uri -Body $currentValues -Method PATCH -ContentType "application/json"
                $APICounter += 1
            }

            $outputlog = $response
            $log = Write-VPASTextRecorder -inputval $outputlog -token $token -LogType RETURN
            Write-Verbose "UPDATES MADE TO $PlatformID ROTATION POLICY, RECEIVED JSON OBJECT"

            return $response
        }catch{
            $log = Write-VPASTextRecorder -inputval $_ -token $token -LogType ERROR
            $log = Write-VPASTextRecorder -inputval "REST API COMMAND RETURNED: FALSE" -token $token -LogType MISC
            Write-Verbose "UNABLE T