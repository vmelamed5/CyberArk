...
.DESCRIPTION
   Use this function to retrieve all remediation rules currently configured
.LINK
   https://vpasmodule.com/commands.html#Get-VPASAllRemediationRules
.NOTES
   Category: PAM
...
.EXAMPLE
   $AllRemediationRulesJSON = Get-VPASAllRemediationRules
.EXAMPLE
   $InputParameters = @{
        ExportToCSV = $true|$false
        CSVDirectory = "C:\Temp"
   }
   $AllRemediationRulesJSON = Get-VPASAllRemediationRules -InputParameters $InputParameters
.OUTPUTS
   If successful:
   {
        "count":  6,
   ...
   $false if failed
#>
function Get-VPASAllRemediationRules{
    ...
    Process{
        ...
        try{
            ...
            if($NoSSL){
                ...
                $uri = "http://$PVWA/api/discovery-rule-sets/?limit=50"
            }
            else{
                Write-Verbose "SSL ENABLED BY DEFAULT, USING HTTPS"
                $uri = "https://$PVWA/api/discovery-rule-sets/?limit=50"
            }
            ...
            if($counter -ge 1){
                Write-Verbose "RETURNING ALL REMEDIATION RULES"
                $outputlog = $response
                if($ExportToCSV){
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUBQX/eIFYAbzKauPl2dFbAVJi
# cIyggiTgMIIFbzCCBFegAwIBAgIQSPyTtGBVlI02p8mKidaUFjANBgkqhkiG9w0B
...
# CisGAQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFA7XlJ0E3XafaJsOvWMG7cTmVo9T
# MA0GCSqGSIb3DQEBAQUABIICABrBuGzH8icJNFmJAW8UwcJxwWq0Q3vPTRHF4gnX
# MCkEcUyIhdxrGmvonHzBqFO595eGx5yfOJ28cMxt9GAQ5PytAPIzcWojoUrN74MZ
# SvZ8No0cLp7p1WBj/C7yJKdfJL1p2ZFgTQk/W8PqZoJTuwmkS9OT9wO5qNBTjzwu
# Kvt5+ZP9DJrIHR5BYB+uxOlg4khYyB+p+jIp4iDO53ShV3E39qx9Hzf4vFpxE6bv
# kIqbhCRf9yGjkOGtc/BM6NPiuFj0YmJIhcuIWXnhS3PrtdlzhIEC5x/4tRH1HO81
# Cg+Z4zhdIH4R7oAzFoOAsg5VEvc9a+78OTMxxnVeF/8V9eh5y4kK07U6DKkbnG2G
# S/B2eTKJ9nrQFCjT4wLr6QFBtM8KuQN1kSFR1SD50OwVEuk4BpOUmIt1IuO2LNQe
# LMNwaoQfjMvLwE7bearcG8LrRFBfJJ2t+3dlwfiIzcNniigT7SMcwfMunzryqURv
# mCEgyvUPNlRZkFjtVWDUzuklpW1C6cDE4mgIPngiZ+ZVBMc3deUgF6s5QimAzvXs
# M3HeLJFFNyjIL62X8ZN53GWQDG4WzIArJkY8WEFIcFA0ka6Q0xQwzRKLnbxy+FGK
# nPlopFF6Z0zRIMkcPD4h/yzM8myeXvpwX36Be/lFSlmEnx/k3PsKQqJi51fdr8dC
# Y4iZoYIDIzCCAx8GCSqGSIb3DQEJBjGCAxAwggMMAgEBMGowVTELMAkGA1UEBhMC
...
# 9w0BCQUxDxcNMjYwMjA0MDQ0NjI2WjA/BgkqhkiG9w0BCQQxMgQwrhduNT7F5AQD
# mZOaC+rxL2mo/zFlA97x2GYdBEcAh9XPJmhoPb974YS2IzmwFb5HMA0GCSqGSIb3
# DQEBAQUABIICAAFgif2pHnFVy9ZiRPOyqGIQDTnXhgemu26BXi5UT2WMq8FUHUJM
# +xB8vI7mtRJY6hODudEUDOFN6gTuOIKfFCa1eJ+mRgpoNCYf8EywBmVp8gaRb8n+
# m7cKMIrBXhSx2C8aWh9MDfp8cXxAXWuPKVHFgVERNo33JWBCGPoUMb2q7AQwT5qM
# hpa8y+Z3pAtHX3dA6BkVy6X00dGvvJRJFd/HeUN3uICMLQpW4a1ncVEcsN3ECGtw
# XxXXALAg1Nj8MCB6qb1pkebgOWsKpz7SDP8W/hqRJiOXAEQzKnJHQpSkooz6SDMh
# XMVKtN7aFsPmz/Cthb1zMBNwhrDc99Q8uyoqr73Z7CBv3YkeJbfloa8QXWRxUW1g
# LzwpM3Ru/eDDed2jhLNMTq9ZZJHkjIC5MnPvktXJyKbXZhGcTAGtYqJ9gykICDn9
# v14hpB4h/Bo1otcL6u2C3wX446O4naWWtPE8lqiC1OUghOl2rUQKNQIRgwOHfcER
# xgKrfm9MUPExxuW66885A2r9GWYGWdaUPaZWhTktVEK4d+Dn2cy6JPB5lkcMGyOz
# BUrG40EilzXUsW6KRxSJTMUjhlQEsqDS3KvPJm5Wji5cOfxLCVPgUqU3vkJa1/at
# y9FUhKGOYBfTJylIkg1RoCh1sj0ZsJN7G80KoSI0MTe+YDh+/rfBzDS0
