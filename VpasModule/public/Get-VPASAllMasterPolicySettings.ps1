<#
.Synopsis
   Get MasterPolicy settings
   CREATED BY: Vadim Melamed, EMAIL: vpasmodule@gmail.com
.DESCRIPTION
   Use this function to retrieve master policy settings for all target platforms
.LINK
   https://vpasmodule.com/commands.html#Get-VPASAllMasterPolicySettings
.NOTES
   Category: PAM
   Tag: Master Policy
   Since: v14.6.0
...
.EXAMPLE
   $AllMasterPolicySettings = Get-VPASAllMasterPolicySettings
.EXAMPLE
   $InputParameters = @{
		ExportToCSV = $true|$false
        CSVDirectory = "C:\Temp"
   }
   $AllMasterPolicySettings = Get-VPASAllMasterPolicySettings -InputParameters $InputParameters
.OUTPUTS
   {
        "value":  {
                      "VmanWebsite":  {
                                          "DualControl":  "@{Value=False}",
                                          "MultiLevelApproval":  "@{Value=False}",
                                          "OnlyManagersApproval":  "@{Value=False}",
                                          "ConfirmersNumber":  "@{Value=1}",
                                          "EnforceExclusiveAccess":  "@{Value=False}",
                                          "EnforceOneTimePassword":  "@{Value=False}",
                                          "TransparentConnection":  "@{Value=True}",
                                          "AllowViewPassword":  "@{Value=True}",
                                          "RequireReason":  "@{Value=True}",
                                          "AllowFreeText":  "@{Value=True}",
                      ...
                      "WinLocalVman":  {
                                           ...
                                           "RequireReason":  "@{Value=True}",
                                           "AllowFreeText":  "@{Value=True}",
                                           "PasswordChangeDays":  "@{Value=999}",
                                           "PasswordVerificationDays":  "@{Value=998}",
                                           "RequireMonitoringAndIsolation":  "@{Value=True}",
                                           "RecordActivity":  "@{Value=True}",
                                           "RetentionPeriod":  "@{Value=90}"
                                       }
   ...
   $false if failed
#>
function Get-VPASAllMasterPolicySettings{
    [OutputType([bool])]
    ...
    Process{
        try{
            ...
            Write-Verbose "FAILED TO RETRIEVE MASTER POLICY SETTINGS"
        ...
        try{
            ...
            Write-Verbose "FETCHING ALL TARGET PLATFORMS"
            ...
            foreach($plat in $AllPlatforms.Platforms){
                ...
                Write-Verbose "FOUND PLATFORM $platformID, FETCHING MASTER POLICY CONFIGURATIONS"
                if($NoSSL){
            ...
            $log = Write-VPASTextRecorder -inputval $_ -token $token -LogType ERROR
            $log = Write-VPASTextRecorder -inputval "REST API COMMAND RETURNED: FALSE" -token $token -LogType MISC
            Write-Verbose "UNABLE TO GET MASTER POLICY SETTINGS FOR PLATFORM: $PlatformID"
            Write-VPASOutput -str $_ -type E
            return $false
        }
    }
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUlULMR67a5YjiEgU++fQS5MMx
# e92ggiTgMIIFbzCCBFegAwIBAgIQSPyTtGBVlI02p8mKidaUFjANBgkqhkiG9w0B
...
# CisGAQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFH2H3swKGPLhIhuMVc46eUgUdV9+
# MA0GCSqGSIb3DQEBAQUABIICAJlrygj0TLTik2C3K3u1jVRd3s98xtzeMt5zZCS7
# pDAVuzpuO9jLCzxh6Vm4wev08Te6o52S/zr2WWcB5lQSOaIwRLS4d5jcuFLpefkR
# Ok7yXU061Y4k+TMK/7+nNaL83iHUb2qun4rROC2xN8itjWCTMk4HNbTfGUphSgEE
# E0/AeD/qZHjxFW3grEKj46hr81nhHMBx+/oprDS6r0VoI1Y62ZUTwpZCIRAcvQGl
