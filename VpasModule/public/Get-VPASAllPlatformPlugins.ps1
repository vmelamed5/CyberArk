...
.DESCRIPTION
   Use this function to retrieve all plugins configured on all platforms
.LINK
   https://vpasmodule.com/commands.html#Get-VPASAllPlatformPlugins
.NOTES
   Category: PAM
   Tag: Platforms
   Since: v15.0.0
...
.EXAMPLE
   $AllPlatformPluginsJSON = Get-VPASAllPlatformPlugins
.EXAMPLE
   $InputParameters = @{
        ExportToCSV = $true|$false
        CSVDirectory = "C:\Temp"
   }
   $AllPlatformPluginsJSON = Get-VPASAllPlatformPlugins -InputParameters $InputParameters
.OUTPUTS
   If successful:
   {
        "results":  [
                        ...
                        {
                            "dateAdded":  "2025-04-22 12:50:31.245000+00:00",
                            "connectorManagementFolder":  "PMWindowsRegistry_19.0.1",
                            "name":  "PMWindowsRegistry",
                            "version":  "20.0.1",
                            "isOutOfTheBox":  true,
                            "id":  "12345cf2e5262312f12987654321b6b21299c29dc5f924c220abcdefga699bbb57ec05638dccc2525f31513b4ba8694c685d5fcfb2b6e0dc7cb274410a9b493b"
                        },
                        {
                            "dateAdded":  "2025-01-01 08:11:01.228000+00:00",
                            "connectorManagementFolder":  "XMLFile_12.0.0.8",
                            "name":  "XMLFile",
                            "version":  "14.0.0.8",
                            "isOutOfTheBox":  true,
                            "id":  "12345cb029a23814ae108599949e619ddb1a1e7fed51abcdefgde68f42ed5d95f41d906f23ce32ce52da72a980e3987654321jahdjklkaj16be4ff2b1687aede"
                        },
                        ...
                    ]
   }
   ...
   $false if failed
#>
function Get-VPASAllPlatformPlugins{
    ...
    Process{
        try{
            ...
            Write-Verbose "FAILED TO RETRIEVE PLATFORM PLUGINS"
        ...
        try{
            ...
            if($NoSSL){
                ...
                $uri = "http://$PVWA/api/rotation/plugins"
            }
            else{
                Write-Verbose "SSL ENABLED BY DEFAULT, USING HTTPS"
                $uri = "https://$PVWA/api/rotation/plugins"
            }
            ...
            Write-Verbose "RETURNING PLATFORM PLUGINS"
            return $response
        }catch{
            $log = Write-VPASTextRecorder -inputval $_ -token $token -LogType ERROR
            $log = Write-VPASTextRecorder -inputval "REST API COMMAND RETURNED: FALSE" -token $token -LogType MISC
            Write-Verbose "UNABLE TO RETRIEVE PLATFORM PLUGINS"
            Write-VPASOutput -str $_ -type E
            return $false
        }
    }
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUma1OFvEa+3Mzc1FHcWDq9c6z
# BU2ggiTgMIIFbzCCBFegAwIBAgIQSPyTtGBVlI02p8mKidaUFjANBgkqhkiG9w0B
...
# CisGAQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFCwLdiQYGF5yhg79VE37mbf950T/
# MA0GCSqGSIb3DQEBAQUABIICADjK2V9mGmS8Jn6VE6MsTVZUZlgttN8hFBQlQNTG
# MF8V1GlUTpsP0NqT9T+w18/JElH2mKnLzmWI1vamaUT1rrp5YN6rsHRK2XAYLxo9
# +3MVuyg12q/PjGZPGH0OUdgTKQsWLmEMnxpnKVWIf7s8J/hukB5a7Q6dOe7pw8kD
# Dvk3oezSDSrbpqLOZozLvB3GgtFRXpm+FbVtpBC6LOvycgqinNS3Ynff868lBvDU
# ku/2ULb69chYNFCYM78too8tnC2FBRWK/WI0Hix1LhNJEqHSaY5BTLh7YGRvwy7Q
# rovr7qMTMVp/m9upqFk1lfvGrq4O1EUH8ew2XWBvDvIfQEDCP3JP6BkF5yW2KajF
# mSLL6YC+E7GY5T3MlxCWDxY9AFlcET95YoB/QflXd9+5dFLL7vyQkOUql2FHvIfh
# ExprdVZaqBVV9f3qnUqZsAXbiI3xC3jKP1txu0GI8We5KSXRp3MZ2rCg28OZvXJ2
# gk/WPgZs++shZjeahDcLDF9Im3aTGYpyDgJdOPhZjI8XxkJbCanhPJ8SrnJWTxzk
# G9U6D6rlLpSOYEVwjSA6FfY6K9ss2AvwyUtur/FCExGBGBu9xSLQgcUCmKQ8Mmpp
# mHxhCwoP3kC7LQ/KjqjSy6t28OVSO4VCiYNu5qx8zTl/kLquvMQaYpeHa9EPKLBa
# UC+moYIDIzCCAx8GCSqGSIb3DQEJBjGCAxAwggMMAgEBMGowVTELMAkGA1UEBhMC
...
# 9w0BCQUxDxcNMjYwMjA0MDQ0NjE0WjA/BgkqhkiG9w0BCQQxMgQwB4bRrCwjN4RL
# U8NbYM66yowgLx509s1mTLZsQdoreYyDE8kuTx8cIPdo3cfckZ6YMA0GCSqGSIb3
# DQEBAQUABIICAJsR1Vy9W969LLdRg3/0TexozB0MzVwfblvKXv7cbbJMTGguu4yJ
# OyiyzlldxobyvIQ+1mMB2MwImfjfrlQfrl04chitLTyAM4HpFXUG4kwRGT83MHUr
# JP2b4Z0tuJp2nQ1l/Meq7Rvn1U5VN0UBB6Wye5jo2I2OM4TDG1Z2H15Q8ViXrEe0
# u0FaYnuNELYuB+LtC9BOqAZlDHS1Nmp2D+MqceYfriwfA/zeAmMYqCz+LJaz7yCz
# Yv50sXwfckjaGSuEZKpqcZ3u6EgZKTEuToeokIQDku0WaUuWutKC+p1LpvZ9DeRO
# RLNMOJuiGwQ/h2n7AoOlwm5QugCQDIY1oWFSZOpzNFLFSRjvAjizc6uHN0eKTkD8
# 6SXP7xl2CwYRfqSR/jM1z+PLCCmhqvV4ud0Qf/onAtRAJbq9irUay78mwhOCaQmS
# GLUD8YoXe2QtnV3S/9eHmkpUoDOurPmMMhZjVKFQq9EPwe2iRF9KhhyHP7gBLO2k
# Bvn4gzb6vXRG7cDwhjMzB/RagmUeQZrqanW/h0OUzHfxhPZuVpFCfbwNtphE6+MA
# 9Mst+8eOcKR7WoQCX9YYkK6205+g3iRXsiHF4O/xh/KiYclh74+t5WGzuxi4I9NL
# i9/wH6sF819SA7Qd+Z3lGr9t6MXDbEOak+MLZ4fyT1szKEHaD7okZRgB
