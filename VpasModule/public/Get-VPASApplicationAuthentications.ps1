...
.DESCRIPTION
   Use this function to retrieve all the authentication methods for a target application ID
.LINK
   https://vpasmodule.com/commands.html#Get-VPASApplicationAuthentications
.NOTES
   Category: PAM
   Tag: Applications
   Since: v10.10
...
.EXAMPLE
   $ApplicationAuthenticationsJSON = Get-VPASApplicationAuthentications -AppID {APPID VALUE}
.EXAMPLE
   $InputParameters = @{
   ...
   $ApplicationAuthenticationsJSON = Get-VPASApplicationAuthentications -InputParameters $InputParameters
.OUTPUTS
   If successful:
   {
        "authentication":  [
                               ...
                               },
                               {
                                   ...
                                   "AppID":  "VPasAppIDTest",
                                   "AuthType":  "path",
                                   "AuthValue":  "/home/SomeDirectory/test.ps1",
                                   "Comment":  null,
                                   "IsFolder":  "False",
                                   "authID":  "2"
                               },
...
function Get-VPASApplicationAuthentications{
    ...
    Param(
        ...
        [Parameter(Mandatory=$true,ParameterSetName='Set1',ValueFromPipelineByPropertyName=$true,HelpMessage="Enter target ApplicaionID to query ApplicationID Authentications (for example: TestApplicaion1)")]
        [String]$AppID,
    ...
    Process{
        try{
            ...
            Write-Verbose "FAILED TO RETRIEVE APPLICATION AUTHENTICATION DETAILS"
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQU/IlfWd5c33GIggBI6pLpmNAJ
# 6z+ggiTgMIIFbzCCBFegAwIBAgIQSPyTtGBVlI02p8mKidaUFjANBgkqhkiG9w0B
...
# CisGAQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFIVKXdTGWL/LzjoB8F6VYAAEkZX0
# MA0GCSqGSIb3DQEBAQUABIICAF6fOyv5gUuRjoE5DgkE4Hs6gMEASW/trg/s436/
# irZnLs6nZCg9P6wBx3h4x7Ms53T5r1YLLdWS8wvY0ARXsvfau6P0Jz5Od05mTV3o
# 67mD1rGxxqnt75EoXz8i0avn20IBwoVHb2PwuyyBQOpXKSg6F8I/Go5pu0ahqHe9
# Gx5EcwpUjkfQH0uAcm+gqJEaRtAL9WoGaB0/ZYn+3UQdcJoLCd4CgWXDKEs9hPYg
# GX1GYq/sMPhk+ObGZCfmJaoORxjPYOLYZoy1shUozNSSDYO57KiGxrfu1Angh5Ud
# X8A1ed2IIFnurU+arY/R59UdHgIkGL5IkfV1eiEDg+67NTMCdzun8PhhIwwNuvPQ
# bnwmrYmlIZrItqkoeCB+gw3FV6ZAcuR3X6Kr/cApNSvVZZTDBeGn90R5HMKacY/K
# U/tt9Il8m3BZq6Engg0qtB2Nx8i+p5yMBqf9GcXNLow0erOJYM2HFpwmAoRA5knV
# CrgI80Iz5Ne67HMTuu6gKMC3vd2mpOuh4Ci1WHkaCUR1NlVWfTXEYRWKrbzl7Cj6
# TX4pY1FXqAMpB0YKXYuYGa+HOmWe+FQkheF0OAaVG7v9sfB4wtIITfpy2psuXa1a
# WYmWk02hmu67xBLrRuLZ/4m/pEkrpCwaSj6DM3fb5zdtzULiOAsRWp2yR72CTn/M
# yMSToYIDIzCCAx8GCSqGSIb3DQEJBjGCAxAwggMMAgEBMGowVTELMAkGA1UEBhMC
...
# 9w0BCQUxDxcNMjYwMjA0MDQ0NjQ3WjA/BgkqhkiG9w0BCQQxMgQwXZgX4T8SuhyZ
# wLElC2rUNr4qHg71iq8V534OVK2uNtEfATFI4gG7XfPwSCzYur+7MA0GCSqGSIb3
# DQEBAQUABIICAGaPoaRUm84bqoFGCLjhmpq4Z6RlOVvAEHFQaTsJNDOrvAYOMvDd
# 9wegAyC9iBt6mFrVMegFUAeY1719pAYtkHFV/52IGV2wAgcEOMi5wQ0Z2F0M+5bh
# xYRmOJSSeT2VrcUcJHZRDgfexlmGf3qxtgV9nZmqAzIWCArfXOr53RX8v/P2l25h
# x/5PpJoduNidQUGODP+bzXcoEdVplQr4J3VW7kF9oO8ODa+lPWpfyLm+h0EYIJkN
# kSOOIsaKtqa4Nm7Ox9KVrTANriSFAipgTk79+K1x8yPwbZKNmq4Huf1alUqAayF5
# HgSRhQg9JMBCRcE0etawZxACUIg2mNdHyluknVkjT/hMghnFUgKffb3IFudRDvH+
# B36grF3g9rbvc/sldSWVuhjvq90YbWYAeSj5zOF7YQqb0ZHo3jGfpo65sdVAOfna
# ImnS9szEBA4FVMvVhRzLsFASdEW8nE0tR77W3DgB7EpMsYA41K/17QLnglP67H95
# XZPV2vMKrLBoCjpGK6q5o636muPxaZF1WluM/OpqMXLXt5xWCizflN/Nsvpy1a0u
# ZOJ5XYjQQLlVBJj00AYx/V5zt6I2eTOkCTG8O3d9FFrseO21k6g7IMMICi6fcPtB
# yfKUFw0m78rYwDTUdAtMDRaauNjM29z8NeUFmdEThiqbIyWl1VNoDphf
