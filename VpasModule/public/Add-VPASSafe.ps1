...
.DESCRIPTION
   Use this function to create a new safe
.LINK
   https://vpasmodule.com/commands.html#Add-VPASSafe
.NOTES
   Category: PAM
   Tag: Safes
   Since: v10.10
...
.EXAMPLE
   $CreateSafeJSON = Add-VPASSafe -safe {SAFE VALUE} -passwordManager {PASSWORDMANAGER VALUE} -Description {DESCRIPTION VALUE} -numberOfVersionsRetention {VERSION RETENTION NUMBER VALUE}
.EXAMPLE
   $CreateSafeJSON = Add-VPASSafe -safe {SAFE VALUE} -passwordManager {PASSWORDMANAGER VALUE} -Description {DESCRIPTION VALUE} -numberOfDaysRetention {DAYS RETENTION NUMBER VALUE}
.EXAMPLE
   $InputParameters = @{
        safe = "NewSafe1"
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUZQ58wdbHLoYwy5FJxSerZJr7
# ynWggiTgMIIFbzCCBFegAwIBAgIQSPyTtGBVlI02p8mKidaUFjANBgkqhkiG9w0B
...
# CisGAQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFGCShax2VPP2r948w4E2wo5Be/Lc
# MA0GCSqGSIb3DQEBAQUABIICAJXWVJ4i4jcxk2Dvh49KXfabL+hqgCsxqp/V+AZx
# V8dp3cF15TuMdK4XGlFaA5DaJzQBCMmJOuu4ajfpx1AB3OJDLaGIWbWWMCB9n+GZ
# ZhE65Od5UgU5+KM2L5gQ9EUFLH3xHcphBEQhjSscDPDvdlQHLZpWKDuaIvGovXLk
# MMy1QsKVN1D7weCo+iNX9BYjEBtNvLXdA0qJaNTkkhXnsv6kfP9IRQIhnyA2M1Xd
# 0fxzpajGVsyqdKubEuXDDcbv8m3Df3txYelhDRht9GeqH+ABAfavdmXObN1H0Tth
# 26r1hBtYi2841jT/tYYECgOo97GqRiD9z8F7Lvg46hCgkGB8Dxnb3yjZ86AFjATq
# 7X/tMKdrWeIlgE1TD9/ZeL8kBQMi4mZvoiA5ZWm78D03lfEQwd/L2qM1Nelekzn8
# 90JLMbZ9PyKrl8HrVuqosDd6pRKntMVTrtDgYe3GOhZzro/UMzBExw1ptrE1WdAR
# C3HprMdBNeW52M+6iheIw+La48CjZFatoGDVx4Pkuh0d4i+E9u/soGjjfeiJFv6w
# i18RjleqdGwusehugE2Ix8nA3paUwxu6rGn+d69wiU9xFbc+aFNJ5yyYKBofia/S
# cJg7vnp18MxPtf8ezL5RlhjZHD+GiruMJpv2J9L/+VuUgdP0Jie4aMa1fcHyvfBR
# 9U4JoYIDIzCCAx8GCSqGSIb3DQEJBjGCAxAwggMMAgEBMGowVTELMAkGA1UEBhMC
...
# 9w0BCQUxDxcNMjYwMjA0MDQ0MzM4WjA/BgkqhkiG9w0BCQQxMgQw/i6mHAwG0TIW
# yqOcNgLLlJ20bXS7shYPU6QfOeErI+9bGHQr9Ax8njrJgTVHbWVPMA0GCSqGSIb3
# DQEBAQUABIICAJbkkFwVlgUkWDYB/CWdq4J7T3I6+6Jtv19eoDokVozDsv2BbNT8
# /7EkIZyjIJplnbNjiECVgmVV2pHMJfq7YLMWPnJqXBQzykR4Ig594LumXyfBr0zt
# v1amxbkg0lthayNElrKV8+e/Rnib4whqspKs+akraj7JiwCsG4oYq1TV9z0bkJDK
# BOqMJz9tsZvV87vwzXaxc1kBtmztuOZI5eAnAldnqXsxcIewmUtlNLSpG4bwuAOG
# d4vlV9HPdNLlJocjCkgx0lsxtO4GNdKQqUK8t9KKqTfWvqHDzeNZzwkB33WpkOVD
# TOmWzlTnR7rLqQPG/BHA+u181GfLzxSJCppwVFxIjydWCgrjl/1TnCuSw/K79CwZ
# vq3Uw1vO2DJgNr2QFZv8k5dYkEi+iDXHhvWOPu1l8kY4j1FA87DrnTOLLJc7mz3D
# 0e4I2pt0hikKOQ+lUnI0PF0L2WrUkjHdMOC9YgclTrQVEMQL1YGK2JQMPnVguJ53
# Tq3mmN3WqouiSmBZ8fAuFjY141adaBBwtBWetlt7VOC3/cBqYF9kwpJWtu+5fXTN
# J5syVJoh5SB0PJ1D1p6JmgL2Hivo+6gDiuGyqmdYHS4L+FayACohoPBwqm0JR27z
# OKll56VrW59LhDtZUU4/SDJggunKWHS4+/DPcOv+vwyPh2ZvoYJRf+KK
