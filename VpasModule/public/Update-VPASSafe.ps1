...
.DESCRIPTION
   Use this function to update a safe (Name, Description, Managing CPM, Version Retention period, Days Retention period)
.LINK
   https://vpasmodule.com/commands.html#Update-VPASSafe
.NOTES
   Category: PAM
   Tag: Safes
   Since: v10.10
...
.PARAMETER field
   ...
   Possible values: SafeName, Description, ManagingCPM, NumberOfVersionsRetention, NumberOfDaysRetention
.PARAMETER fieldval
...
.EXAMPLE
   $InputParameters = @{
        safe = "TargetSafeName"
		field = "SafeName"|"Description"|"ManagingCPM"|"NumberOfVersionsRetention"|"NumberOfDaysRetention"
		fieldval = "New description as an example"
   }
   $UpdateSafeJSON = Update-VPASSafe -InputParameters $InputParameters
.OUTPUTS
   If successful:
   {
...
function Update-VPASSafe{
    ...
    Param(
        ...
        [Parameter(Mandatory=$true,ParameterSetName='Set1',ValueFromPipelineByPropertyName=$true,HelpMessage="Enter target Safe to update (for example: TestSafe1)")]
        [String]$safe,

        [Parameter(Mandatory=$true,ParameterSetName='Set1',ValueFromPipelineByPropertyName=$true,HelpMessage="Enter which field to update (SafeName, Description, ManagingCPM, NumberOfVersionsRetention, NumberOfDaysRetention)")]
        [ValidateSet('SafeName','Description','ManagingCPM','NumberOfVersionsRetention','NumberOfDaysRetention')]
        [String]$field,
    ...
    Process{
        try{
            if($PSCmdlet.ParameterSetName -eq "InputParameters"){
                $KeyHash = @{
                    set1 = @{
                        AcceptableKeys = @("safe","field","fieldval")
                        MandatoryKeys = @("safe","field","fieldval")
                    }
                }
            ...
            Write-Verbose "FAILED TO UPDATE SAFE"
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUlndLqjPBPfdSuDPqCgL1ClaA
# tieggiTgMIIFbzCCBFegAwIBAgIQSPyTtGBVlI02p8mKidaUFjANBgkqhkiG9w0B
...
# CisGAQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFAy6gi/gwf+U5+Kntvu5HiHxnW2U
# MA0GCSqGSIb3DQEBAQUABIICAIdifrQI96z3FHUsChVWCuZMZBhBA1so3ZfWYblq
# EBRjpH6j/yoB+wpGbXm9w3QnOxDr+n4njKcZyiWzoszzocou8ZH1c7WLkJFwkEQI
# SyWDGz63NVa3bW1PLxpT5YRQVos2RVXibKeStAUXyqsj0DT76sJFK+g3QJd/zP9I
# tIq7hneROEFpM/k2hJ8cmgB85EqyoKpk0v6UkT6k+RH1Kw0jq2eQRYHC2EljLFG1
# 8vY3fdHk9nIQY1MzpDKeHpgc7N3r9HltOuhbRa8BsG9bjKzVLDgosW/SKCZi2YCE
# CFXv6xNEcyMGZXFt9R0H1GWp5D7vBjuNEUxDZkrO0jeDy9Y8Ooy8Wj5bNUC4bkbe
# vFbZuWzp0HWSYjmCafa7WcJ4Wd5FVXdbMHSbytQYVg7dq6KnoAnDSExJZINPSIAb
# LNDzRLKypeeNmsD8NmsIPmzjgQkc7rDslDjeKmGqS7rqJTLPqfIeOZ5Z+UCP3hfm
# M9I9cMIsDcpUnrIlxUHO9HTkqNVQsfvRuGAxTkWzyy+NQVP49uDy0gtrILOg7Utn
# kbgfMOfprL1P7RQkGh47NoBQWh0ihiCCtdWmgfxtle78/TYcYfaVVlq2iJgTRyCr
# dKiGnZBCOnD67TbjTkezbFjuDZRobt5NLD6IjX53+1ydeTcWG59xISEcablOrR8J
# gu1yoYIDIzCCAx8GCSqGSIb3DQEJBjGCAxAwggMMAgEBMGowVTELMAkGA1UEBhMC
...
# 9w0BCQUxDxcNMjYwMjA0MDQ1NTQ4WjA/BgkqhkiG9w0BCQQxMgQwT6F7x3qoRTNz
# nVTJHXEqRC/DSAjaJuk+OatPqYziqOM9rhs+NRl2U3CZfbB/W5zlMA0GCSqGSIb3
# DQEBAQUABIICAEyd9A/Zb7+mFTHJQr6JMosaywvtUbKRhF6I6GlW8EFKjXNsSRQj
# HDYSdF1JyjupH6cf3VlpfmDb4Sz3rMi099J8aCkxShWeEafgnQLHqFs96t2FvJoc
# V7Lnr42sHIhO3ZsTVAbFmMbBVvWA0izIivlb972jao1cD6xU7q194DMRACDW1sro
# 5IWQ406rG4aO1UXPShUF17XhGrA/mG1zf4N52d+vW2QzcLy2OrwB6VkgIyrudb2j
# dICXkY2hTteCkSAQd2H/YNICu/j0iZIiOkm28A4Px4qv7O78F9eWes+bLPVqhvTO
# cuDXYZp1JBbXszOb3AKQDCSjbz49RoOb9Yz5OmdOGwrJVcKMQsvaY1FrO8Lm2fjx
# H0CR0ez6oFyKel73TpkqrAWv544mcU1xISwfcMOomXaJipFjvc4V2c+GtrnPwcK5
# NTrqaJSFKSAyt5wYucmPhOAnRFt7bOgEs59mZ+BB+NLsiGzHAixgsB24/8rU8V1G
# ZnwxeMZnoRyrulkqSLbaw5HREXHqwpQnwtzupdrsvcMtWDxBIto3Tg/2XI0GQAY6
# FNPhcxog/WrnLlXbHiQJweoyJzgC9idxHynHJxuew2pM6CT0lLNVsKssRXQx5n1m
# 2agocGDSkwMLJlJ2ckp9HWfxyhxZ6TDyx9Ms9IX9aqgal/EHf5ZwjQe3
