...
- Step2: Import VPasModule Required Version 14.2.0 into Powershell
...
SYNTAX:
	Invoke-VPASMetricsPlatforms [-TargetMetric] <String> [-MetricFormat] <String> [[-OutputDirectory] <String>] [[-HTMLChart] <String>] [[-token] <Hashtable>] [<CommonParameters>]
PARAMETERS:
	-TargetMetric <String>
		Specify which report will be run
...
SYNTAX:
	Invoke-VPASMetricsProviders [-TargetMetric] <String> [-MetricFormat] <String> [[-OutputDirectory] <String>] [[-HTMLChart] <String>] [[-token] <Hashtable>] [<CommonParameters>]
PARAMETERS:
	-TargetMetric <String>
		Specify which report will be run
