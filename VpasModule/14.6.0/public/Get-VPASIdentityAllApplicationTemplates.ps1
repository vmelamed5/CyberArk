<#
.Synopsis
   RETRIEVE ALL APPLICATION TEMPLATES
   CREATED BY: Vadim Melamed, EMAIL: vpasmodule@gmail.com
.DESCRIPTION
   USE THIS FUNCTION TO RETRIEVE ALL APPLICATION TEMPLATES IN IDENTITY
.LINK
   https://vpasmodule.com/commands/Get-VPASIdentityAllApplicationTemplates
.NOTES
   SelfHosted: FALSE
...
.OUTPUTS
   If successful:
   {
        ...
                    {
                        "Entities":  "",
                        "Row":  "@{ProvSettingsIsEnterpriseScimUser=; Featured=; ProvSettingPreview=; Name=ZyloSaml; Category=Software Development; OrgId=; MobileAppType=; DirectoryId=; ProvSettingsValidateEmailAttribute=; DisplayName=Zylo; AppTypeDisplayName=Web - SAML +
 Provisioning; OnPrem=False; OrgPath=; ID=ZyloSaml; ShadowAppLink=; IsSwsEnabled=; ChildLinkedApps=; MunkiMetadata=; AdminTag=; UserNameStrategy=ADAttribute; Description=Zylo is the leading SaaS management platform for enterprises. Discover, manage, measure, and secure al
l cloud-based software subscriptions.; SkipSwsForAwsCli=; ParentAppTemplateName=; ProvConfigured=; Version=; IsGatewayed=; Generic=False; CatalogVisibility=; CorpIdentifier=; MobileAppSource=; Brand=; LastUsedPodUrl=; IsBuiltInApp=; WebAppLoginType=; AppType=Web; AuthChal
lengeDefinitionFlowId=; ServiceName=; LastUsedCentrifyUrl=; PortalApp=; ParentApp=; DeepLinkUrl=; Icon=/vfslow/lib/application/icons/Zylo.png; PolicyScript=; WebAppTypeDisplayName=SAML + Provisioning; WorkflowEnabled=; CertBasedAuthEnabled=; BypassLoginMFA=; WebAppType=Sa
ml; IsTestApp=; ProvSettingEnabled=; TemplateName=; _TableName=application; Notes=; IsMarketplaceApp=; AuthChallengeDefinitionId=; IsIdentityAsIdpEnabled=; Handler=cloudlib;Centrify.Saas.apphandlers.SamlAppHandler; WebUPAppType=; State=; NotSelfService=True; IsScaEnabled=
; DerivedCredsSupported=; VersionName=; Popular=; ProvCapable=True}"
                    },
                    {
                        "Entities":  "",
                        "Row":  "@{ProvSettingsIsEnterpriseScimUser=; Featured=; ProvSettingPreview=; Name=Zyprr; Category=CRM; OrgId=; MobileAppType=; DirectoryId=; ProvSettingsValidateEmailAttribute=; DisplayName=Zyprr; AppTypeDisplayName=Web - User Password; OnPrem=; O
rgPath=; ID=Zyprr; ShadowAppLink=; IsSwsEnabled=; ChildLinkedApps=; MunkiMetadata=; AdminTag=; UserNameStrategy=SetByUser; Description=Zyprr is a modern cloud based CRM and business process software to manage complete lifecycle of the customer from lead nurturing to reven
ue.; SkipSwsForAwsCli=; ParentAppTemplateName=; ProvConfigured=; Version=; IsGatewayed=; Generic=False; CatalogVisibility=; CorpIdentifier=; MobileAppSource=; Brand=; LastUsedPodUrl=; IsBuiltInApp=; WebAppLoginType=; AppType=Web; AuthChallengeDefinitionFlowId=; ServiceNam
e=; LastUsedCentrifyUrl=; PortalApp=; ParentApp=; DeepLinkUrl=; Icon=/vfslow/lib/application/icons/Zyprr.png; PolicyScript=; WebAppTypeDisplayName=User Password; WorkflowEnabled=; CertBasedAuthEnabled=; BypassLoginMFA=; WebAppType=UsernamePassword; IsTestApp=; ProvSetting
Enabled=; TemplateName=; _TableName=application; Notes=; IsMarketplaceApp=; AuthChallengeDefinitionId=; IsIdentityAsIdpEnabled=; Handler=cloudlib;Centrify.Saas.apphandlers.BrowserExtensionScriptHandler; WebUPAppType=BrowserExtensionScript; State=; NotSelfService=; IsScaEn
abled=; DerivedCredsSupported=; VersionName=; Popular=; ProvCapable=}"
                    },
        ...
   }
   ---
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQU