...
.LINK
   https://vpasmodule.com/commands/Invoke-VPASMetricsCPM
.NOTES
   SelfHosted: TRUE
...
.EXAMPLE
   $GenerateReport = Invoke-VPASMetricsCPM -TargetMetric CPMAccountManagementStatus -MetricFormat ALL -OutputDirectory C:\Temp\Metrics\CPMMetrics
.EXAMPLE
   $GenerateReport = Invoke-VPASMetricsCPM -TargetMetric CPMAssignedToAccounts -MetricFormat ALL -OutputDirectory C:\Temp\Metrics\CPMMetrics
.EXAMPLE
   $GenerateReport = Invoke-VPASMetricsCPM -TargetMetric CPMAssignedToSafes -MetricFormat ALL -OutputDirectory C:\Temp\Metrics\CPMMetrics
.EXAMPLE
   $InputParameters = @{
        ...
        try{
            ...
            if($TargetMetric -eq "CPMAssignedToAccounts"){
                ...
                if($SafeSearchQuery.count -gt 0){
                    ...
                    foreach($query in $SafeSearchQuery){
                        $smallquery = Get-VPASSafes -searchQuery $query -IncludeAccounts
                        foreach($rec in $smallquery.value){
                            $recSafeName = $rec.safename
                            if(!$SafeMatrix.Contains($recSafeName)){
                                $AllSafes.value += $rec
            ...
            if($TargetMetric -eq "CPMAccountManagementStatus"){
                ...
                if($SafeSearchQuery.count -gt 0){
                    $AccountMatrix = @()
                    $TempAllAccounts = Get-VPASAllAccounts
                    if(!$TempAllAccounts){
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUxN2dDWIiqsDw/ntULyax7b48
# yOuggiTgMIIFbzCCBFegAwIBAgIQSPyTtGBVlI02p8mKidaUFjANBgkqhkiG9w0B
...
# CisGAQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFPr1jrUXGnHmnR5QGJxRIyQEuszk
# MA0GCSqGSIb3DQEBAQUABIICAG1qS75ZwZyeRwqz3nDpccZClBPXercbElOxCDg3
# KL4AxZ/VG44PpfqVRfW5MbmdhPyw0/xXnhlX8kjSfoA9K1ol3nnpeFE9OWf6Ppix
# uAfmzxOJ9eWQJQThDZ1hwG/lQYN9bRwsPxTnN/TTR2YqvEBC4pwjv4lF1iuFDycg
# Di3ivdd8kmh9C6GZr3TqRlmsVvyxWH5VQG43dCNd4aOwX0ss0bi5ptOrXF0P/OVK
# 73aP27F0+XtFwAbyRZXI9n3GukefRsPvOR747ypmQLvkQC0v8fu+Keg2JMeW/0xH
# svVnkwEHSPHCsbcLqWWTStJ3xdrRxv/Yyu6x6VJtWq2O7rilL/xb8M2NpFldVWI5
# nOZP0snLcSNEnqLsNjeG84PSSPNr+ZevDxXMcQsyZnxjvUjPv3CT3XqnYmrIFBQx
# sR4IWT3Ck5dg+qdWAxX5Iy7NGp/1ZocUWX8nc6XiF4fmgeTY2PEIT2d5sfgiabZ8
# 0Jl3BmIVB82JlXxRZjV/iwGQJ5Vkzd68iPm2niCzDco9bIwiPlJpaV3gXqi08GPb
# orEhcC64VG9ge5Er+tOWk9o65OUoHdOzt9wGlUgxnASNL1xcVSIGzRT6+n6WZv7w
# ilzDnzDyNxAbkOt/81plztf6NYewr2QboJ5HsO6OZwJrNbgXqE4I8iPQ6d9k4+X8
# YsyuoYIDIzCCAx8GCSqGSIb3DQEJBjGCAxAwggMMAgEBMGowVTELMAkGA1UEBhMC
...
# 9w0BCQUxDxcNMjUwNzE3MDQ1ODM3WjA/BgkqhkiG9w0BCQQxMgQwThuUZYMxiJNu
# qOjV4SUdqqPlt38dhVdXAWSTA14jPfOzsqvI71AF7rOSJqnjMJU7MA0GCSqGSIb3
# DQEBAQUABIICAB96m965zIzi+gOv9K+Y7aUw1kTdX/qAUvoyYPkojFRkZxf4SolL
# av3U6MNMKPoGPt+C/TnGVIuIk2ShtyUTFzwH3xFdEbG29vUCgOPKKJeAV0HXdvSa
# wfbBvYWiWhgOHDaXOBIl5s4k0T6Z+hcKKvRUMng3vhm7rOGnFPo0zae8a/f0M6Ud
# PMJniJfsAgdCJzTkeLbYws88B8w03AGLN4gciy/McCpXefx1yTo7AYvEtamx3hXM
# 6tNxMwuVzgNWItsf1I6ObZmUXnR6rHx1QtO5+QJPbw/zKXLVw6KLNZwiWLUsF6Zt
# 4k2WnjvMkek3zFdWBc0UO0Z09WhKk7bJZ5hAhRmiF/dtUbg7mTgFQcl+kRTiZEUC
# Q8NmtqBWj/fDueTgDRWF/VhdmJodWtJP1v8BvZhkkRkQxsttT67dEv4reMDAvaW3
# zLqYIDAbIrU/wUnnFgeFTAhPgpirzcIXNZnybWY/76HnJJU+txxgIZsbg55aKKL8
# 8VSm8LS+KTvuMOK+/aVsXQS3nLLcrxuogzR+7tLSUv9xZyelC7gN35zol6cQcAv2
# 5XTMpss2OvKwprBkKrGrzY31tIhMnYOTNB2wQ7zWHwpPOLVRNphbQQSG/ycOE51N
# NzpIEGaQNOVjO2n19X+4RK1H1rEqcFN8JeZZoBraji/Uyzc3b8I4puGp
