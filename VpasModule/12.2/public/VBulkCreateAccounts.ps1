                    ...
                    if($response){
                            ...
                            try{
                                ...
                                if($foundacctflag){
                                    try{
                                        ...
                                        $response = Invoke-RestMethod -Headers @{"Authorization"=$token} -Uri $uri -Body $LinkAccountParams -Method POST -ContentType "application/json"
                        ...
                        if($CPMFlag){
                            try{
                                ...
                                $response = Invoke-RestMethod -Headers @{"Authorization"=$token} -Uri $uri -Method POST
