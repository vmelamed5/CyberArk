    ...
    Process{
        try{
            ...
            if([String]::IsNullOrEmpty($tokenval)){
                ...
                return $tokenval,$sessionval,$PVWA,$Header,$ISPSS,$IdentityURL,$EnableTextRecorder,$AuditTimeStamp,$NoSSL,$VaultVersion,$HideWarnings,$AuthenticatedAs,$SubDomain,$EnableTroubleshooting
            }
        }catch{
            Write-Verbose "UNABLE TO FIND A SESSION TOKEN"
