    ...
    try{
        ...
        if($ReportType -eq "SafeContent"){
            ...
            if($SearchQuery -eq "all"){
                ...
                if($NoSSL){
                    $Safes =  VGetSafes -token $token -searchQuery " " -NoSSL
                }
                else{
                    $Safes =  VGetSafes -token $token -searchQuery " "
                }
                ...
                if($NoSSL){
                    if($WildCardSearch){
                        $Safes = VGetSafes -token $token -searchQuery $SearchQuery -NoSSL
                    }
                    else{
                    ...
                    if($WildCardSearch){
                        $Safes = VGetSafes -token $token -searchQuery $SearchQuery
                    }
                    else{
