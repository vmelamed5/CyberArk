    ...
    try{
        ...
        if($ReportType -eq "SafeContent"){
            ...
            foreach($safe in $TargetSafes){
                if($NoSSL){
                    $FoundAccounts = VGetAccountDetails -token $token -safe $safe -NoSSL
                }
                else{
                    $FoundAccounts = VGetAccountDetails -token $token -safe $safe
                }
            ...
            if($ReportFormat -eq "JSON" -or $ReportFormat -eq "ALL"){
                ...
                Vout -str "FINISHED EXPORTING JSON FILE: $targetFile" -type C
            ...
            if($ReportFormat -eq "TXT" -or $ReportFormat -eq "ALL"){
                ...
                Vout -str "FINISHED EXPORTING TXT FILE: $targetFile" -type C
            ...
            if($ReportFormat -eq "CSV" -or $ReportFormat -eq "ALL"){
                ...
                Vout -str "FINISHED EXPORTING CSV FILE: $targetFile" -type C
            ...
            if($ReportFormat -eq "HTML" -or $ReportFormat -eq "ALL"){
                ...
                Vout -str "FINISHED EXPORTING HTML FILE: $targetFile" -type C
            ...
            if($ReportFormat -eq "XML" -or $ReportFormat -eq "ALL"){
                ...
                Vout -str "FINISHED EXPORTING XML FILE: $targetFile" -type C
