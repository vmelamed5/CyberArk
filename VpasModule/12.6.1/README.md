...
- Step1: Install VPasModule from github or from Powershell Gallery https://www.powershellgallery.com/packages/VpasModule/12.6.1
- Step2: Import VPasModule Required Version 12.6.1 into Powershell
...
SYNTAX:
	VConnectWithPSM [-token] <Hashtable> [[-safe] <String>] [[-platform] <String>] [[-username] <String>] [[-address] <String>] [[-ActiveSessionID] <String>] [[-OpenRDPFile]] [[-NoSSL]] [[-AcctID] <String>] [-ConnectionComponent] <String> [[-TargetServer] <String>] [[-Reason] <String>] [<CommonParameters>]
EXAMPLES:
