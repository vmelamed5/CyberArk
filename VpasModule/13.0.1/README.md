...
- Step1: Install VPasModule from github or from Powershell Gallery https://www.powershellgallery.com/packages/VpasModule/13.0.1
- Step2: Import VPasModule Required Version 13.0.1 into Powershell
...
SYNTAX:
	VEnableEPVUser [-token] <Hashtable> [-LookupBy] <String> [-LookupVal] <String> [[-NoSSL]] [<CommonParameters>]
EXAMPLES:
