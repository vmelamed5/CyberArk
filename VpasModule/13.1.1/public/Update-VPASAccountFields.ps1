...
function Update-VPASAccountFields{
    ...
    Param(
        ...
        [Parameter(Mandatory=$true,ValueFromPipelineByPropertyName=$true,HelpMessage="Enter target field to update (Name, Address, PlatformID, Username. Status, StatusReason, RemoteMachines, AccessRestrictedToRemoteMachines)",Position=5)]
