...
- Step1: Install VPasModule from github or from Powershell Gallery https://www.powershellgallery.com/packages/VpasModule/13.1.1
- Step2: Import VPasModule Required Version 13.1.1 into Powershell
...
PARAMETERS:
	...
	-field <String>
		...
		Possible values: Name, Address, PlatformID, Username, Status, StatusReason, RemoteMachines, AccessRestrictedToRemoteMachines
