    ...
    Process{
        try{
            if($token){
                ...
                $EnableTroubleshooting = $token.EnableTroubleshooting
                $APICounter = $token.APICounter
                $Creds = $token.Creds
                $AuthType = $token.AuthType
                $IDPLogin = $token.IDPLogin
                $SRS = $token.SRS
            }
            else{
                ...
                $EnableTroubleshooting = $Script:VPAStoken.EnableTroubleshooting
                $APICounter = $Script:VPAStoken.APICounter
                $Creds = $Script:VPAStoken.Creds
                $AuthType = $Script:VPAStoken.Authtype
                $IDPLogin = $Script:VPAStoken.IDPLogin
                $SRS = $Script:VPAStoken.SRS
            }
            ...
            if([String]::IsNullOrEmpty($tokenval)){
                ...
                return $tokenval,$sessionval,$PVWA,$Header,$ISPSS,$IdentityURL,$EnableTextRecorder,$AuditTimeStamp,$NoSSL,$VaultVersion,$HideWarnings,$AuthenticatedAs,$SubDomain,$EnableTroubleshooting,$APICounter,$Creds,$AuthType,$IDPLogin,$SRS
            }
        }catch{
            Write-Verbose "UNABLE TO FIND A SESSION TOKEN"
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUG/n22czKTkmDjD4AniEIPnV9
# MJ+ggiTgMIIFbzCCBFegAwIBAgIQSPyTtGBVlI02p8mKidaUFjANBgkqhkiG9w0B
...
# CisGAQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFGDeYXzn8BnHEqEnPAhlvC0YeiOu
# MA0GCSqGSIb3DQEBAQUABIICAIPdBWHmwsHdulZpvEbjpzyNPtvpKG+pyUQVZEGz
# Y7iCaVbCLYmRP/JhgrqQDV4t0RiToMZ2PWsUvQ1sHKRJn9loKaDeziwDrgtfF68t
# if/Uw0ZKGvUemegthndsQSNrUYy/7MESe9Ujm82R4UubD4Oqxl54Rg1l9QzgK00t
# 7DsYwW8IyRS8TdxoBAVI4T9/hChL3AGHoNM//Qe5KamBIyJOWuE/A5Ozq8/t74f+
# TcsAN1j8S8BXW4nUR6Cx6EGDHxsttMLE4WwWho7rlaRiZ/81Ipg09Ca+wrtbkeYj
# YIzQ9PCokF83+oIeKJv+9WKeO3dNEOzSObX9Qodrz14LWsWIxzBcpEbM2q86sEMA
# eZkkk4vih7tPEouDcI0DWe1xhRJ6sHkGLrcpaOS9fZe721dcR2zOCnMZYQj8+NmV
# QPRrG3GVCk1S907Vk6cIpJd0vCWbcb5wpoDLxfMExIpWT6ZdRc0rJSCUNVfidVPI
# Gxd7wqbbpLTZBSS2rHIwYMJUflX/6aL/qaN+63FrVQb2RzaMLXW8qVMSXVSiyWjI
# jkUcPTrcNxzM46jiEFk7hb3GUGbvEp5OG6AxpRQEytqPO1PeQntQTLAmnUYU5Nmh
# A+U5QEVeSUVfG1eMcEKIZ5xZyce+Y7Av6csjwiHFBM7OrHYP+1n1wpGVdFx9ZeuE
# a4JYoYIDIzCCAx8GCSqGSIb3DQEJBjGCAxAwggMMAgEBMGowVTELMAkGA1UEBhMC
...
# 9w0BCQUxDxcNMjYwMjA0MDQ0MTU5WjA/BgkqhkiG9w0BCQQxMgQwEnZcg93818hm
# otYGR9tXKiOnE2dP/USDadYKCPxLZjYnGbMgZn/IXcsmpScK42ZBMA0GCSqGSIb3
# DQEBAQUABIICAARtjkNpdqngxxMY7nKLZB3DBDlQqfKSCRjv+mDLSL5raMmYpmFx
# mSK9ww+YnhBJfId7TunqKZjgPu4npnXyPg6KFl9UVxVhVaPZTa84hwOlRlYk5ZKx
# 5RDmVErDQAKnxg1d23vX9bQd0210dDtfsnEt4moTeQ/ccjp5itQNFA6xSLW/Y8ew
# VD+PistpXQeTL+P0LNKv0dhaWm8sesEMISYqel+zNc93gRKbaE/jG2vF1Lto82PJ
# 8LBwJ/rKouwxcF0JcLGLMQWb9shZ3tLUIY3+pq9oyFLJ8yfX9hlD8YsAf2HNFDPw
# VlAJ6w8igkiaV+3sRPZ8UpUfh0LoLlqLgZ5ckN4SgkRrrwikiZ7pZaTdL2v2QQAb
# mzhAbgNKsGMKRZmE/DGcNFAaS2leH79yAXFGHjQ3oTMio6yl/WNPgzZBL5USxLIa
# 3NbsV3USf7DIxRmJ60TDkAoIsnCeJfzvun2qRUUhhNYJbOS/ztwXy2XuTZckM+hZ
# /pwjM/zBgbuAXwmmkNOQyJSVy43cDCxI96Ga79FUBNgvJLYgCKyjbL4eni913Bsh
# XeuOMTGsZZPYWX66GVNxt6ETwUeUyNRhS6kkMP8dyzh2qmO82OVAEF+jErpfxznW
# RMGXLPOGYAq2dVktgKiAwNKBE0fFHq3GJUT//JJS2fUs1eaK8USVQd+v
