<#
.Synopsis
   Output return from VPASModule
   CREATED BY: Vadim Melamed, EMAIL: vpasmodule@gmail.com
.DESCRIPTION
   Helper function to standardize return values in VPASModule
#>
function Format-VPASReturn{
    ...
    Process{
        try{
            ...
            Write-Verbose "FORMATTED RETURN VALUE"
            return $returnval
        }catch{
            Write-Verbose "UNABLE TO RETURN DATA"
            Write-VPASOutput -str $_ -type E
            $log = Write-VPASTextRecorder -inputval $_ -token $token -LogType ERROR -Helper
            $log = Write-VPASTextRecorder -inputval "UNABLE TO RETURN DATA" -token $token -LogType MISC -Helper
        }
    }
    End{
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUuEabQh877tP6WPWXByXriOp5
# uweggiTgMIIFbzCCBFegAwIBAgIQSPyTtGBVlI02p8mKidaUFjANBgkqhkiG9w0B
...
# CisGAQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFDCEgc5dcWI8R6TrBfrB2sALE2ez
# MA0GCSqGSIb3DQEBAQUABIICAHBSdDl07EsIvg4V5fuWZsNfLkSZLMGH8T0Xpc6O
# SJ2c/+HAnfDVbcgxJwIEntDpQf7bETAmmVa3d/uBro83ZoGDB87c/Xy9gZ3P8En5
# hyncq314ANLDS1Y19TLyIgq8uVJnmZHDcYGbb1SAqRMJahEjd1cJmgaLNe0Lmqkw
# 6H6lzsAJJlIg5SbvwCOiF2JDRpVqY8Y3qsSR8aEuqnb+gxCzeywOjnesKmy272C0
# 1yA1iKRPoeIcEQIrQbkBaXDm4WyIWjmNqY6WS+SVVvYEsbblBdaWKIBqIjRH4Irm
# vgUstAxr1C4NIsNKdaQJ0ngtk8QNydhHSvS9D+ZSO9+DSw7/Cmat/3b/5Df1+7lk
# yBikNKZiY/Wjbu9RP6Kguahaivh1adRYtLq2AQtypyVQ6CqpBqapvBI5/nkJUvhy
# EsglQuETC0xFLjS8FYI7pXfXnT1eAxQ0uwokdgMvdWJGXVKNYFwM8unEYZ4fsk2c
# 0sJ/t9Fef0g3cVRZ9N9K7NEvnQ9zhF0A/H4/U8Nmko1mcCY15fOPkyR++qSpk0X6
# H5PThJ49rT45IgM7tcTU+FqpumqWPB6kyVO5EiyDO0/rWH2TLM9mHI/MMTSqD6Xq
# pbWZvvRptk9RdR8gk4fUGqEfeV8/pUfB2vCJSm8qdrqy/+wZvID79MWEA5VywXz9
# 5cMYoYIDIzCCAx8GCSqGSIb3DQEJBjGCAxAwggMMAgEBMGowVTELMAkGA1UEBhMC
...
# 9w0BCQUxDxcNMjYwMjA0MDQ0MDQxWjA/BgkqhkiG9w0BCQQxMgQwF/Dp7YknLM6f
# wshkl4yfunaSomtTNMyD0qt4k7SZ2OANU+dGvjdzdr/MtAV6oLVRMA0GCSqGSIb3
# DQEBAQUABIICAEc/ic5ncKb+QalL2BL1SiysmL0sY+5yjOT4/PaH/p6dGzVvHrdV
# 3K+mkMNaj15JcIcaw3ASw7Tl1fOjKttRXCmfPs5IJ4p0P3lJHhFA7Rm2b0stMwfe
# BSEiZDu9u/e5UxAheB36Iml/NPOeDrC5uxoKjU32GU+EL4YhzIUUwavkemL07Wyy
# CQsmhGalU9BAhTzL86iFe8CjfF/2hPeVbk5Cn3RVoyeWGU+our+Yt+wD37QgAuCM
# U3/bp8Uykvjf4PEQ8/NynScgYVsnFMTWTWCL73RQumxx+9sQUVP5MlBOvRP+/nLc
# lPJfXUxPt9lHazXg3fVgXxkr+PVQ8fmVSS/Bi9WCB13WCmr83YYbiE9lqm7Y9ckg
# MGRA7xGoM6p/sFd2Uik19YsMKXYUZCzHwWRE7tDLi1CGPxDH9e9UmscTsgOqlVUe
# YmMHE1oLkv4fVcybeFaKajnMBt4hwOYNIfIidpqrk82glNz42kfKkLBHncyXYweD
# GZE8ZppRHd90LauKfssQ7RMAcxjiX7icofluUBpAEDggzUI/MF6qgn+TMNLvxrmB
# Mp+we8fWVIlqKMXE1omYUqolzexz9AWZMbWtbvNr+0ZqkjZFnS2FvsetqjwCRGnN
# X5SJBwhlobM1nP5mQ4IQyqlGx33q4iOUN6byQjhJX+xkmKyY0/rqjVMA
