<#
.Synopsis
   Get ConnectorManagement connector pool ID
   CREATED BY: Vadim Melamed, EMAIL: vpasmodule@gmail.com
.DESCRIPTION
   Helper function to retrieve connector pool IDs from Connector Management
#>
function Get-VPASCMConnectorPoolIDHelper{
    ...
    Process{
        try{
            ...
            $uri = "https://$SubDomain.connectormanagement.cyberark.cloud/api/connector-pools"
            ...
            $output = -1
            foreach($rec in $response.connectorPools){
                $recPoolID = $rec.poolId
                $recName = $rec.name
                $recDescription = $rec.description

                if($recName -eq $SearchQuery){
                    $output = $recPoolID
                    Write-Verbose "FOUND $SearchQuery : TARGET ENTRY FOUND, RETURNING CONNECTOR POOL ID"
            ...
            Write-Verbose "FAILED TO RETRIEVE CONNECTOR MANAGEMENT CONNECTOR POOLS"
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUVBC53zENAEqm2fQZWnY71kIU
# W+iggiTgMIIFbzCCBFegAwIBAgIQSPyTtGBVlI02p8mKidaUFjANBgkqhkiG9w0B
...
# CisGAQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFLNAV3bCwzKxiA823qsUiBwYh69c
# MA0GCSqGSIb3DQEBAQUABIICAGgDghmUbQj7YV5uopVe6DIJz0PlhKTLi8qS9jbH
# 6vYFULN5OVqMc7VlG63jc6LS8Agb0EC6hGNl2ttp/3gIgayXAdmC9KzZqbDYkV+a
# x3Lr39lkY1mhCYnoox3j7KvAkFVxJKiThSISWb+h3Txc6KXmvtuSAmHZcsKzMM2l
# 0+ugaFPASbY8CHNP0WtXbr/c6QW2zVg2EsCZAZXrG58osDMpO3Ijmn/sW5Xoa2IZ
# EsoB4OlccSX16KGrjqeTYmDTB35UtjynGrLkhmmNr63i1dJjyEgejIkxzoNY+DGk
# DjBI0ExQI9zn9Ylq/KAv9tdTcpTPY5tL7XPYMAC9E2k/NUpO0/3/aekbXwcrPqQN
# 6Ob6zdBV02b5c5g6httrxMo49SwuxeqW1SMtoEQ4ULk/IZK/ExtwMT8QREcznF6c
# GcMY3Ial48wV/Bk3oB/Q9FEGVbT1g8fVf2X2cUCOOGJBinlVTv/S+CLe0qf71Q3k
# uPiDiiqIMEX5IKnMpV7BC+FdXb7mIRpt29WXINUJIIM6SNZe9LjgetM99rcte+qR
# 25C4EngQCOXtotg9piL7pWzutYW9rHJJxz4guTjzj+Fa/eZr6aZo7ayY0CUPtFK2
# WEDLI1juDObfWI4vZR3JpHnGaApXkJ88JxWwry3orWgOwvgM8D9Kz2LCC3W66UF4
# +6uOoYIDIzCCAx8GCSqGSIb3DQEJBjGCAxAwggMMAgEBMGowVTELMAkGA1UEBhMC
...
# 9w0BCQUxDxcNMjYwMjA0MDQ0MTExWjA/BgkqhkiG9w0BCQQxMgQw0snU3fqBDFio
# r8OFpaOs/NC9vsqOnBJSeRxJqCYcr+JqAiGTZS6hpRrFwEYnwHHZMA0GCSqGSIb3
# DQEBAQUABIICALiuZoBIVtzTRb4cpy+NbWuWYPm7wxYpeDoqXJLnDRtKze3duY+A
# v4xSmFa2klIfXBykO9ZvoygNYD2H2rolAu6AiJRe63mHT+0gDdIredlzSYmDSxQl
# lMtxRIBaGAkxDs7GH/8Ly3Lbz3JTjeXEEjW90IK6Es+fcFnl7HFwhrMMzkv/5dUi
# xiuoBzoLP57gCF2rYlD+74lJP/Y76fkIHAZ1A6ybcUo0Cinz2bZ1BKR7EjEk2jN2
# iEFBN9FAeVtb6XD0bgO6ETxzBt4eg4FyFoag8YJJ6rFmh4g6YAZDXyxrT+nx2S5I
# CMN3Jfb9EjuDPrN7gz7Qzo23Ai4F3pgdCibibBefBuuAv84jg3Imb7RnCRSqWSJs
# H9sbv3UDX+EmPmL245pI5ueUVJlufo/TCngK6EqE5pSJ8oMocyEeeX66qjXlfkjI
# jsFyuWbb1JI6jWSM8D2MGjUoAb5VahKBhpNzCYB9RTxbGIe27YcUaStBH+glHJof
# Ce3Ap3kjIKCN6owZz4wTaaTuHlXbeHMKa79I/DUyfylMLBvWsPdzL3Fgcju9VxUV
# z2LkeYMDz+VICEmKn2sfGZwzbKHzCTjyXxJw6kXUTA2uRP8gF49ku1Sui6gNnqIU
# KPK6XdC2TBqJMAFe2d8QpE5hQcCrCNN8Nw4JOpCeGLKqvWBMRKYMfmDG
