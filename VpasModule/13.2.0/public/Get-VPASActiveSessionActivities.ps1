...
function Get-VPASActiveSessionActivities{
    ...
    Process{
        $log = Write-VPASTextRecorder -inputval "Get-VPASActiveSessionActivities" -token $token -LogType COMMAND
        ...
        try{
            ...
            $log = Write-VPASTextRecorder -inputval "Get-VPASActiveSessionActivities" -token $token -LogType DIVIDER
