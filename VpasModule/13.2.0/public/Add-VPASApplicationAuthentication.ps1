...
function Add-VPASApplicationAuthentication{
    ...
    process{
        $log = Write-VPASTextRecorder -inputval "Add-VPASApplicationAuthentication" -token $token -LogType COMMAND
        ...
        try{
            ...
            $log = Write-VPASTextRecorder -inputval "Add-VPASApplicationAuthentication" -token $token -LogType DIVIDER
            return $true
        }catch{
