...
function Enable-VPASEPVUser{
    ...
    Process{
        $log = Write-VPASTextRecorder -inputval "Enable-VPASEPVUser" -token $token -LogType COMMAND
        ...
        try{
            ...
            if($Action -eq "Enable"){
                ...
                $log = Write-VPASTextRecorder -inputval "Enable-VPASEPVUser" -token $token -LogType DIVIDER
