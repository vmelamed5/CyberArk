...
function New-VPASIdentityGenerateUserPassword{
    ...
    Process{
        $log = Write-VPASTextRecorder -inputval "New-VPASIdentityGenerateUserPassword" -token $token -LogType COMMAND
        ...
        try{
            ...
            if(!$IdentityURL){
                ...
                $log = Write-VPASTextRecorder -inputval "New-VPASIdentityGenerateUserPassword" -token $token -LogType DIVIDER
