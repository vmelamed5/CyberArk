...
function Import-VPASPlatform{
    ...
    Process{
        $log = Write-VPASTextRecorder -inputval "Import-VPASPlatform" -token $token -LogType COMMAND
        ...
        try{
            ...
            $log = Write-VPASTextRecorder -inputval "Import-VPASPlatform" -token $token -LogType DIVIDER
