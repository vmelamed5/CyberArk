...
function Get-VPASIdentityAdminSecurityQuestion{
    ...
    Process{
        $log = Write-VPASTextRecorder -inputval "Get-VPASIdentityAdminSecurityQuestions" -token $token -LogType COMMAND
        ...
        try{
            ...
            if(!$IdentityURL){
                ...
                $log = Write-VPASTextRecorder -inputval "Get-VPASIdentityAdminSecurityQuestion" -token $token -LogType DIVIDER
