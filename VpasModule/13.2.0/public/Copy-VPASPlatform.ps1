...
function Copy-VPASPlatform{
    ...
    Process{
        $log = Write-VPASTextRecorder -inputval "Copy-VPASPlatform" -token $token -LogType COMMAND
        ...
        try{
            ...
            if($platID -eq -1){
                ...
                $log = Write-VPASTextRecorder -inputval "Copy-VPASPlatform" -token $token -LogType DIVIDER
