...
function Get-VPASActiveSessionProperties{
    ...
    Process{
        $log = Write-VPASTextRecorder -inputval "Get-VPASActiveSessionProperties" -token $token -LogType COMMAND
        ...
        try{
            ...
            $log = Write-VPASTextRecorder -inputval "Get-VPASActiveSessionProperties" -token $token -LogType DIVIDER
