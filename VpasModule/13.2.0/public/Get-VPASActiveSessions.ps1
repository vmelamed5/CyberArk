...
function Get-VPASActiveSessions{
    ...
    Process{
        $log = Write-VPASTextRecorder -inputval "Get-VPASActiveSessions" -token $token -LogType COMMAND
        ...
        try{
            ...
            $log = Write-VPASTextRecorder -inputval "Get-VPASActiveSessions" -token $token -LogType DIVIDER
