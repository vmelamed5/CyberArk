...
function Test-VPASIdentityUserLocked{
    ...
    Process{
        $log = Write-VPASTextRecorder -inputval "Test-VPASIdentityUserLocked" -token $token -LogType COMMAND
        ...
        try{
            ...
            if(!$IdentityURL){
                ...
                $log = Write-VPASTextRecorder -inputval "Test-VPASIdentityUserLocked" -token $token -LogType DIVIDER
