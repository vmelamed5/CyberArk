...
function Reset-VPASIdentityUserSecurityQuestions{
    ...
    Process{
        $log = Write-VPASTextRecorder -inputval "Reset-VPASIdentityUserSecurityQuestions" -token $token -LogType COMMAND
        ...
        try{
            ...
            if(!$IdentityURL){
                ...
                $log = Write-VPASTextRecorder -inputval "Reset-VPASIdentityUserSecurityQuestions" -token $token -LogType DIVIDER
