...
function Get-VPASAllowedReferrer{
    ...
    Process{
        $log = Write-VPASTextRecorder -inputval "Get-VPASAllowedReferrer" -token $token -LogType COMMAND
        ...
        try{
            ...
            $log = Write-VPASTextRecorder -inputval "Get-VPASAllowedReferrer" -token $token -LogType DIVIDER
