...
function Get-VPASUsagePlatformDetails{
    ...
    Process{
        $log = Write-VPASTextRecorder -inputval "Get-VPASUsagePlatformDetails" -token $token -LogType COMMAND
        ...
        try{
            ...
            foreach($rec in $response.Platforms){
                ...
                if($recplatformid -eq $platformID -or $recname -eq $platformID){
                    ...
                    $log = Write-VPASTextRecorder -inputval "Get-VPASUsagePlatformDetails" -token $token -LogType DIVIDER
