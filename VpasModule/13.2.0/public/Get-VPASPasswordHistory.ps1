...
function Get-VPASPasswordHistory{
    ...
    Process{
        $log = Write-VPASTextRecorder -inputval "Get-VPASPasswordHistory" -token $token -LogType COMMAND
        ...
        if([String]::IsNullOrEmpty($AcctID)){
            ...
            if($AcctID -eq -1){
                ...
                $log = Write-VPASTextRecorder -inputval "Get-VPASPasswordHistory" -token $token -LogType DIVIDER
