...
function Get-VPASSafeAccountGroups{
    ...
    Process{
        $log = Write-VPASTextRecorder -inputval "Get-VPASSafeAccountGroups" -token $token -LogType COMMAND
        ...
        try{
            ...
            $log = Write-VPASTextRecorder -inputval "Get-VPASSafeAccountGroups" -token $token -LogType DIVIDER
