...
function Invoke-VPASAccountPasswordAction{
    ...
    Process{
        $log = Write-VPASTextRecorder -inputval "Invoke-VPASAccountPasswordAction" -token $token -LogType COMMAND
        ...
        elseif($actionlower -eq "changeonlyinvault"){
            ...
            if([String]::IsNullOrEmpty($newPass)){
                ...
                $log = Write-VPASTextRecorder -inputval "Invoke-VPASAccountPasswordAction" -token $token -LogType DIVIDER
