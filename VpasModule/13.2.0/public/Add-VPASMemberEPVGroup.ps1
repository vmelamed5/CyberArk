...
function Add-VPASMemberEPVGroup{
    ...
    Process{
        $log = Write-VPASTextRecorder -inputval "Add-VPASMemberEPVGroup" -token $token -LogType COMMAND
        ...
        try{
            ...
            $log = Write-VPASTextRecorder -inputval "Add-VPASMemberEPVGroup" -token $token -LogType DIVIDER
            return $true
