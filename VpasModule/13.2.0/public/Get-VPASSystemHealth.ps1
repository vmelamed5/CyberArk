...
function Get-VPASSystemHealth{
    ...
    Process{
        $log = Write-VPASTextRecorder -inputval "Get-VPASSystemHealth" -token $token -LogType COMMAND
        ...
        try{
            ...
            $log = Write-VPASTextRecorder -inputval "Get-VPASSystemHealth" -token $token -LogType DIVIDER
