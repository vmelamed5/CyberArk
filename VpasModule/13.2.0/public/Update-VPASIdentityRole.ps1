...
function Update-VPASIdentityRole{
    ...
    Process{
        $log = Write-VPASTextRecorder -inputval "Update-VPASIdentityRole" -token $token -LogType COMMAND
        ...
        try{
            ...
            if(!$IdentityURL){
                ...
                $log = Write-VPASTextRecorder -inputval "Update-VPASIdentityRole" -token $token -LogType DIVIDER
