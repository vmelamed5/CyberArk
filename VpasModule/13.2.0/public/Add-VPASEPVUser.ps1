...
function Add-VPASEPVUser{
    ...
    Process{
        $log = Write-VPASTextRecorder -inputval "Add-VPASEPVUser" -token $token -LogType COMMAND
        ...
        try{
            ...
            $log = Write-VPASTextRecorder -inputval "Add-VPASEPVUser" -token $token -LogType DIVIDER
            return $response
        }catch{
