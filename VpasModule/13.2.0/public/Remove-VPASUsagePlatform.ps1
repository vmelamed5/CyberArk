...
function Remove-VPASUsagePlatform{
    ...
    Process{
        $log = Write-VPASTextRecorder -inputval "Remove-VPASUsagePlatform" -token $token -LogType COMMAND
        ...
        try{
            ...
            if($platID -eq -1){
                ...
                $log = Write-VPASTextRecorder -inputval "Remove-VPASUsagePlatform" -token $token -LogType DIVIDER
                ...
                if($WhatIf){
                    ...
                    if($NoSSL){
                        $WhatIfInfo = Get-VPASUsagePlatformDetails -usageplatformID $UsagePlatformID -token $token -NoSSL
                    }
                    else{
