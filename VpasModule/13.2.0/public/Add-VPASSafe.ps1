...
function Add-VPASSafe{
    ...
    Process{
        $log = Write-VPASTextRecorder -inputval "Add-VPASSafe" -token $token -LogType COMMAND
        ...
        try{
            ...
            $log = Write-VPASTextRecorder -inputval "Add-VPASSafe" -token $token -LogType DIVIDER
