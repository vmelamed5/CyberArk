...
function Get-VPASPSMSessions{
    ...
    Process{
        $log = Write-VPASTextRecorder -inputval "Get-VPASPSMSessions" -token $token -LogType COMMAND
        ...
        try{
            ...
            $log = Write-VPASTextRecorder -inputval "Get-VPASPSMSessions" -token $token -LogType DIVIDER
