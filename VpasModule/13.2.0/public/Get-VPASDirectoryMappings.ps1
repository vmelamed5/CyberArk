...
function Get-VPASDirectoryMappings{
    ...
    Process{
        $log = Write-VPASTextRecorder -inputval "Get-VPASDirectoryMappings" -token $token -LogType COMMAND
        ...
        try{
            ...
            $log = Write-VPASTextRecorder -inputval "Get-VPASDirectoryMappings" -token $token -LogType DIVIDER
