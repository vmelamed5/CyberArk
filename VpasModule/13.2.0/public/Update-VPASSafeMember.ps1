...
function Update-VPASSafeMember{
    ...
    process{
        $log = Write-VPASTextRecorder -inputval "Update-VPASSafeMember" -token $token -LogType COMMAND
        ...
        try{
            ...
            $log = Write-VPASTextRecorder -inputval "Update-VPASSafeMember" -token $token -LogType DIVIDER
