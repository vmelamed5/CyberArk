...
function Add-VPASAccountGroup{
    ...
    Process{
        $log = Write-VPASTextRecorder -inputval "Add-VPASAccountGroup" -token $token -LogType COMMAND
        ...
        try{
            ...
            $log = Write-VPASTextRecorder -inputval "Add-VPASAccountGroup" -token $token -LogType DIVIDER
