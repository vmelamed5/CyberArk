...
function Get-VPASIdentityRoles{
    ...
    Process{
        $log = Write-VPASTextRecorder -inputval "Get-VPASIdentityRoles" -token $token -LogType COMMAND
        ...
        try{
            ...
            if(!$IdentityURL){
                ...
                $log = Write-VPASTextRecorder -inputval "Get-VPASIdentityRoles" -token $token -LogType DIVIDER
