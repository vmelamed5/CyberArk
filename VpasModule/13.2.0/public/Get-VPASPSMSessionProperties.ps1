...
function Get-VPASPSMSessionProperties{
    ...
    Process{
        $log = Write-VPASTextRecorder -inputval "Get-VPASPSMSessionProperties" -token $token -LogType COMMAND
        ...
        try{
            ...
            $log = Write-VPASTextRecorder -inputval "Get-VPASPSMSessionProperties" -token $token -LogType DIVIDER
