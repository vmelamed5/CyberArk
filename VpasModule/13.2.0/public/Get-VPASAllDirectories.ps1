...
function Get-VPASAllDirectories{
    ...
    Process{
        $log = Write-VPASTextRecorder -inputval "Get-VPASAllDirectories" -token $token -LogType COMMAND
        ...
        try{
            ...
            $log = Write-VPASTextRecorder -inputval "Get-VPASAllDirectories" -token $token -LogType DIVIDER
