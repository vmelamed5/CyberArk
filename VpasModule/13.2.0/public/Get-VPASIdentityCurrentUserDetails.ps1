...
function Get-VPASIdentityCurrentUserDetails{
    ...
    Process{
        $log = Write-VPASTextRecorder -inputval "Get-VPASIdentityCurrentUserDetails" -token $token -LogType COMMAND
        ...
        try{
            ...
            if(!$IdentityURL){
                ...
                $log = Write-VPASTextRecorder -inputval "Get-VPASIdentityCurrentUserDetails" -token $token -LogType DIVIDER
