...
function Get-VPASApplicationDetails{
    ...
    Process{
        $log = Write-VPASTextRecorder -inputval "Get-VPASApplicationDetails" -token $token -LogType COMMAND
        ...
        try{
            ...
            $log = Write-VPASTextRecorder -inputval "Get-VPASApplicationDetails" -token $token -LogType DIVIDER
