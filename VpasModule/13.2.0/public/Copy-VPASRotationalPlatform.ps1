...
function Copy-VPASRotationalPlatform{
    ...
    Process{
        $log = Write-VPASTextRecorder -inputval "Copy-VPASRotationalPlatform" -token $token -LogType COMMAND
        ...
        try{
            ...
            if($platID -eq -1){
                ...
                $log = Write-VPASTextRecorder -inputval "Copy-VPASRotationalPlatform" -token $token -LogType DIVIDER
