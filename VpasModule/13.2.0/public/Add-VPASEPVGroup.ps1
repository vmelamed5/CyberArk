...
function Add-VPASEPVGroup{
    ...
    Process{
        $log = Write-VPASTextRecorder -inputval "Add-VPASEPVGroup" -token $token -LogType COMMAND
        ...
        try{
            ...
            $log = Write-VPASTextRecorder -inputval "Add-VPASEPVGroup" -token $token -LogType DIVIDER
            return $response
        }catch{
