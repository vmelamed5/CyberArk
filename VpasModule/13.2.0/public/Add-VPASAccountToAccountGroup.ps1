...
function Add-VPASAccountToAccountGroup{
    ...
    Process{
        $log = Write-VPASTextRecorder -inputval "Add-VPASAccountToAccountGroup" -token $token -LogType COMMAND
        ...
        try{
            ...
            if(!$GroupID){
                ...
                $log = Write-VPASTextRecorder -inputval "Add-VPASAccountToAccountGroup" -token $token -LogType DIVIDER
