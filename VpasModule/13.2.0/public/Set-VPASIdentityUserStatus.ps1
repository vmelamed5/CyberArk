...
function Set-VPASIdentityUserStatus{
    ...
    process{
        $log = Write-VPASTextRecorder -inputval "Set-VPASIdentityUserStatus" -token $token -LogType COMMAND
        ...
        try{
            ...
            if(!$IdentityURL){
                ...
                $log = Write-VPASTextRecorder -inputval "Set-VPASIdentityUserStatus" -token $token -LogType DIVIDER
