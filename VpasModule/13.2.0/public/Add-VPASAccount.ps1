...
function Add-VPASAccount{
    ...
    Process{
        $log = Write-VPASTextRecorder -inputval "Add-VPASAccount" -token $token -LogType COMMAND
        ...
        try{
            ...
            $log = Write-VPASTextRecorder -inputval "Add-VPASAccount" -token $token -LogType DIVIDER
