...
function Remove-VPASSafeMember{
    ...
    process{
        $log = Write-VPASTextRecorder -inputval "Remove-VPASSafeMember" -token $token -LogType COMMAND
        ...
        try{
            ...
            if($WhatIf){
                ...
                if($NoSSL){
                    $WhatIfInfo = Get-VPASSafeMemberSearch -safe $safe -member $member -token $token -NoSSL
                }
                else{
                ...
                if(!$WhatIfInfo){
                    ...
                    $log = Write-VPASTextRecorder -inputval "Remove-VPASSafeMember" -token $token -LogType DIVIDER
                    return $false
                }
                else{
