...
function Get-VPASAccountGroups{
    ...
    Process{
        $log = Write-VPASTextRecorder -inputval "Get-VPASAccountGroups" -token $token -LogType COMMAND
        ...
        try{
            ...
            $log = Write-VPASTextRecorder -inputval "Get-VPASAccountGroups" -token $token -LogType DIVIDER
