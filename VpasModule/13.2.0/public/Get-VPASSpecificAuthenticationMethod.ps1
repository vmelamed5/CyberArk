...
function Get-VPASSpecificAuthenticationMethod{
    ...
    Process{
        $log = Write-VPASTextRecorder -inputval "Get-VPASSpecificAuthenticationMethod" -token $token -LogType COMMAND
        ...
        try{
            ...
            $log = Write-VPASTextRecorder -inputval "Get-VPASSpecificAuthenticationMethod" -token $token -LogType DIVIDER
