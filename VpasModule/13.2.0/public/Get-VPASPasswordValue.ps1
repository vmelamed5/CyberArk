...
function Get-VPASPasswordValue{
    ...
    Process{
        $log = Write-VPASTextRecorder -inputval "Get-VPASPasswordValue" -token $token -LogType COMMAND
        ...
        if([String]::IsNullOrEmpty($AcctID)){
            ...
            if($AcctID -eq -1){
                ...
                $log = Write-VPASTextRecorder -inputval "Get-VPASPasswordValue" -token $token -LogType DIVIDER
