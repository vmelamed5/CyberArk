...
function Remove-VPASLinkedAccount{
    ...
    Process{
        $log = Write-VPASTextRecorder -inputval "Remove-VPASLinkedAccount" -token $token -LogType COMMAND
        ...
        try{
            ...
            if($AcctID -eq -1){
                ...
                $log = Write-VPASTextRecorder -inputval "Remove-VPASLinkedAccount" -token $token -LogType DIVIDER
