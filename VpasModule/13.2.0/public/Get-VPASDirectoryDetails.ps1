...
function Get-VPASDirectoryDetails{
    ...
    Process{
        $log = Write-VPASTextRecorder -inputval "Get-VPASDirectoryDetails" -token $token -LogType COMMAND
        ...
        try{
            ...
            $log = Write-VPASTextRecorder -inputval "Get-VPASDirectoryDetails" -token $token -LogType DIVIDER
