...
function Remove-VPASRotationalPlatform{
    ...
    process{
        $log = Write-VPASTextRecorder -inputval "Remove-VPASRotationalPlatform" -token $token -LogType COMMAND
        ...
        try{
            ...
            if($platID -eq -1){
                ...
                $log = Write-VPASTextRecorder -inputval "Remove-VPASRotationalPlatform" -token $token -LogType DIVIDER
                ...
                if($WhatIf){
                    ...
                    if($NoSSL){
                        $WhatIfInfo = Get-VPASRotationalPlatformDetails -rotationalplatformID $DeleteRotationalPlatformID -token $token -NoSSL
                    }
                    else{
