...
function Enable-VPASRotationalPlatform{
    ...
    Process{
        $log = Write-VPASTextRecorder -inputval "Enable-VPASRotationalPlatform" -token $token -LogType COMMAND
        ...
        try{
            ...
            if($platID -eq -1){
                ...
                $log = Write-VPASTextRecorder -inputval "Enable-VPASRotationalPlatform" -token $token -LogType DIVIDER
