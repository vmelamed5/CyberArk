...
function Update-VPASPSMSettingsByPlatformID{
    ...
    Process{
        $log = Write-VPASTextRecorder -inputval "Update-VPASPSMSettingsByPlatformID" -token $token -LogType COMMAND
        ...
        try{
            ...
            if($platID -eq -1){
                ...
                $log = Write-VPASTextRecorder -inputval "Update-VPASPSMSettingsByPlatformID" -token $token -LogType DIVIDER
