...
function Get-VPASPSMSessionActivities{
    ...
    Process{
        $log = Write-VPASTextRecorder -inputval "Get-VPASPSMSessionActivities" -token $token -LogType COMMAND
        ...
        try{
            ...
            $log = Write-VPASTextRecorder -inputval "Get-VPASPSMSessionActivities" -token $token -LogType DIVIDER
