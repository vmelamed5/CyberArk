...
function Disable-VPASEPVUser{
    ...
    Process{
        $log = Write-VPASTextRecorder -inputval "Disable-VPASEPVUser" -token $token -LogType COMMAND
        ...
        try{
            ...
            $log = Write-VPASTextRecorder -inputval "Disable-VPASEPVUser" -token $token -LogType DIVIDER
